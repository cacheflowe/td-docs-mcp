...
**Note** : For global shortcuts to components in another part of your project, see [Global OP Shortcut](https://docs.derivative.ca/Global_OP_Shortcut "Global OP Shortcut").
...
If all [clones](https://docs.derivative.ca/Clone "Clone") of a master component have the same parent shortcut, using that name inside any of the clones will refer to the unique location of each clone, making paths in clones simpler and clones more portable.
...
See also: `parent()` in [Td_Module](https://docs.derivative.ca/Td_Module "Td Module"), [Global OP Shortcut](https://docs.derivative.ca/Global_OP_Shortcut "Global OP Shortcut")
...
Operator shortcuts are Python objects that return operators (or sometimes parameters). These include Parent Shortcuts for accessing a component from within that component, and [Global OP Shortcuts](https://docs.derivative.ca/Global_OP_Shortcut "Global OP Shortcut") that access a unique component from anywhere in TouchDesigner.
