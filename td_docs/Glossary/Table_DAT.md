...
**Filling cells externally with python** - If you are not auto-filling, you can put strings into table cells using something like `op('table1')[2,'select'] = 'yes'` in a python script elsewhere, or append rows using `.appendRow()` in python. See also the [Script DAT](../DATs/Script_DAT.md "Script DAT") and its Snippets.
...
See also [Script DAT](../DATs/Script_DAT.md "Script DAT"), [Text DAT](Text_DAT.md "Text DAT").

[tableDAT_Class](../DATs/Table_DAT_Class.md "TableDAT Class")
