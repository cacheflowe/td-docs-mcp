...
For a similar, less-abrupt effect, see the [Filter CHOP](Filter_CHOP.md "Filter CHOP").

[lagCHOP_Class](../CHOPs/Lag_CHOP_Class.md "LagCHOP Class")
...
Extra Information for the Lag CHOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
