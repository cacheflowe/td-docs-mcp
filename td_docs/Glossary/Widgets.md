...
The [Widget COMP](https://docs.derivative.ca/Widget_COMP "Widget COMP") is a super-set of the [Container COMP](https://docs.derivative.ca/Container_COMP "Container COMP") (though presently identical).
