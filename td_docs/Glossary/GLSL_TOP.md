...
The GLSL TOP renders a GLSL [shader](Shader.md "Shader") into a TOP image. Use the Info DAT to check for compile errors in your shaders.
...
[glslTOP_Class](../TOPs/GLSL_TOP_Class.md "GlslTOP Class")
...
- Vertex Shader `vertexdat` - Points to the [DAT](DAT.md "DAT") holding the Vertex Shader. Drag & Drop a DAT here, or manually enter the path to the DAT.
- Pixel Shader `pixeldat` - Points to the [DAT](DAT.md "DAT") holding the Pixel Shader. Drag & Drop a DAT here, or manually enter the path to the DAT.
- Compute Shader `computedat` - Points to the [DAT](DAT.md "DAT") holding the [Compute Shader](../Interoperability/Compute_Shader.md "Compute Shader"). Drag & Drop a DAT here, or manually enter the path to the DAT.
