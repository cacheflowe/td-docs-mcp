...
[resolutionTOP_Class](../TOPs/Resolution_TOP_Class.md "ResolutionTOP Class")
...
Extra Information for the Resolution TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
