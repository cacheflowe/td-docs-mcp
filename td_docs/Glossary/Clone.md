---
url: https://docs.derivative.ca/Clone
category: Glossary
title: Clone
---
...
[![a master \(button1\) and its three clones. each clone gets a different .jpg from a table](https://docs.derivative.ca/images/b/b9/MasterAndClones.jpg)](https://docs.derivative.ca/File:MasterAndClones.jpg "a master \(button1\) and its three clones. each clone gets a different .jpg from a table")
