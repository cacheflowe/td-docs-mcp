...
[annotateCOMP_Class](../COMPs/Annotate_COMP_Class.md "AnnotateCOMP Class")
...
Extra Information for the Annotate COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
