...
Parameters in TouchDesigner only exist in [Operators](../General/Operator.md "Operator") (OPs or "nodes"). Parameter types include:
...
Parameters can be driven by [Python](https://docs.derivative.ca/Category:Python "Category:Python") expressions when the [Parameter Mode](Parameter_Mode.md "Parameter Mode") is in Expression Mode.
...
**IMPORTANT** : `op('pattern1').par.phase` is the python [parameter object](../SOPs/Par_Class.md "Par Class") which usually gets converted to an evaluated value for you, like when you use it in a parameter expression. More safely, especially when using a parameter in scripts, use `op('pattern1').par.phase.eval()`, which always gives you the final evaluated value.
...
Custom Parameters are user created parameters which can be added to [Components](Component.md "Component"), [Custom Operators](../Interoperability/Custom_Operators.md "Custom Operators"), and Script Operators ([Script TOP](../TOPs/Script_TOP.md "Script TOP") / [Script CHOP](../CHOPs/Script_CHOP.md "Script CHOP") / [Script SOP](../SOPs/Script_SOP.md "Script SOP") / [Script DAT](../DATs/Script_DAT.md "Script DAT")). In the case of Components and Script Operators, you can create/edit/delete them in the [Component Editor](https://docs.derivative.ca/Component_Editor "Component Editor").
...
See also: [Parameter Python Class](../SOPs/Par_Class.md "Par Class"), [Parameter Dialog](Parameter_Dialog.md "Parameter Dialog"), [Parameter Mode](Parameter_Mode.md "Parameter Mode")
