...
The Palette is a collection of useful [Components](Component.md "Component") that you can drag-drop on to your [network](Network.md "Network"). It is opened/closed via the [![PaletteIcon.jpg](https://docs.derivative.ca/images/c/c0/PaletteIcon.jpg)](https://docs.derivative.ca/File:PaletteIcon.jpg) icon at the top-left of the UI.
