...
[replicatorCOMP_Class](../COMPs/Replicator_COMP_Class.md "ReplicatorCOMP Class")
...
- Callbacks DAT `callbacks` - Path to a DAT containing callbacks for each event received. See [replicatorCOMP_Class](../COMPs/Replicator_COMP_Class.md "ReplicatorCOMP Class") for usage.
