...
[TOP Class](../TOPs/TOP_Class.md "TOP Class")
...
---|---|---
[Movie File In](../TOPs/Movie_File_In_TOP.md "Movie File In TOP") | Read movies, still images, or a sequence of still images. |  [Video Device In](../TOPs/Video_Device_In_TOP.md "Video Device In TOP"), [Movie File Out](../TOPs/Movie_File_Out_TOP.md "Movie File Out TOP")
[Ramp](../TOPs/Ramp_TOP.md "Ramp TOP") | Create vertical, horizontal, radial, and circular ramps. |  [Constant](../TOPs/Constant_TOP.md "Constant TOP"), [Noise](../TOPs/Noise_TOP.md "Noise TOP")
[Level](../TOPs/Level_TOP.md "Level TOP") | Adjust contrast, brightness, gamma, black level, color range, opacity. |  [Luma Level](../TOPs/Luma_Level_TOP.md "Luma Level TOP")
[Transform](../TOPs/Transform_TOP.md "Transform TOP") | Translate, scale, rotate, multi-repeat tile, background fill. |  [Flip](../TOPs/Flip_TOP.md "Flip TOP")
[Over](../TOPs/Over_TOP.md "Over TOP") | Place and shift one image over another based on the alpha of one image. |  [Cross](../TOPs/Cross_TOP.md "Cross TOP"), [Multiply](../TOPs/Multiply_TOP.md "Multiply TOP")
[Text](../TOPs/Text_TOP.md "Text TOP") | Text generation with variety of fonts. |
[Blur](../TOPs/Blur_TOP.md "Blur TOP") | Blur. |  [Luma Blur](../TOPs/Luma_Blur_TOP.md "Luma Blur TOP")
[Composite](../TOPs/Composite_TOP.md "Composite TOP") | Combine multiple images with variety of operations like under, difference. |
[Render](../TOPs/Render_TOP.md "Render TOP") | Render 3D objects, lights and camera into an image. |
[CHOP to](../TOPs/CHOP_to_TOP.md "CHOP to TOP") | Convert CHOP channels into scanlines of an image. |
[Resolution](../TOPs/Resolution_TOP.md "Resolution TOP") | Change the resolution of an image and smooth-filter down. | all TOPs alter resolution
[Crop](../TOPs/Crop_TOP.md "Crop TOP") | Crop image to smaller resolution. |  [Corner Pin](../TOPs/Corner_Pin_TOP.md "Corner Pin TOP"), [Fit](../TOPs/Fit_TOP.md "Fit TOP")
[Select](../TOPs/Select_TOP.md "Select TOP") | Selects an image from the same network or a different network. |  [Switch](../TOPs/Switch_TOP.md "Switch TOP")
[Reorder](../TOPs/Reorder_TOP.md "Reorder TOP") | Re-order the channels of an image. |  [Channel Mix](../TOPs/Channel_Mix_TOP.md "Channel Mix TOP")
[Cache](../TOPs/Cache_TOP.md "Cache TOP") | Hold a static or dynamic sequence of images and output one of them. |  [Feedback](../TOPs/Feedback_TOP.md "Feedback TOP")
[Displace](../TOPs/Displace_TOP.md "Displace TOP") | Use red-blue of one image to warp another image. |  [Time Machine](../TOPs/Time_Machine_TOP.md "Time Machine TOP")
All TOPs are documented in the [Category:TOPs](https://docs.derivative.ca/Category:TOPs "Category:TOPs").

##  TOP Flags

The lower right corner contains only 2 flags, the TOP’s [Display Flag](Display_Flag.md "Display Flag") and [Viewer Active Flag](https://docs.derivative.ca/Viewer_Active_Flag "Viewer Active Flag"). Turning on the display flag displays the TOP as a background in the current [Network Pane](Network_Editor.md "Network Editor"). Turning on multiple TOP Display Flags will display a tiled sequence of multiple TOP outputs as the background of the network pane.
...
All TOP operators have interactive [Node Viewers](Node_Viewer.md "Node Viewer"). To interact with it, turn on the TOP's [Viewer Active Flag](https://docs.derivative.ca/Viewer_Active_Flag "Viewer Active Flag") to make the viewer active.
...
[TOP viewer options](../TOPs/TOP_Viewer.md "TOP Viewer")
...
[TOP Generator Common Page](TOP_Generator_Common_Page.md "TOP Generator Common Page") and [TOP Filter Common Page](https://docs.derivative.ca/TOP_Filter_Common_Page "TOP Filter Common Page")
