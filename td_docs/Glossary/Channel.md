...
##  See Also
  ...
  * [Channel Class](../Python/Channel_Class.md "Channel Class")
  * [CHOP](CHOP.md "CHOP")
  * [Export](Export.md "Export")
  * [Clip CHOP](../CHOPs/Clip_CHOP.md "Clip CHOP")

An [Operator Family](Operator_Family.md "Operator Family") which operate on Channels (a sequence of numbers ([Samples](Sample.md "Sample"))) which are used for animation, audio, mathematics, simulation, logic, UI construction, and data streamed from/to devices and protocols.
