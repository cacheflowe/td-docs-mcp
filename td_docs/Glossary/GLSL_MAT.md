...
The GLSL MAT allows you to write or import custom materials into TouchDesigner. When there are compile errors in a GLSL [shader](Shader.md "Shader"), a blue/red checkerboard _error_ shader will be displayed.
...
[glslMAT_Class](../MATs/GLSL_MAT_Class.md "GlslMAT Class")
