...
In contrast, a TouchDesigner "[Path](https://docs.derivative.ca/Network_Path "Network Path")" is the hierarchy of Components internal to TouchDesigner. A Path is a location of a node, which may be a component containing other nodes.

Folders and filesystem paths are found in the operators that read files, such as the [Folder DAT](https://docs.derivative.ca/Folder_DAT "Folder DAT"), [Movie File In TOP](https://docs.derivative.ca/Movie_File_In_TOP "Movie File In TOP"), [File In CHOP](https://docs.derivative.ca/File_In_CHOP "File In CHOP"), [File In DAT](https://docs.derivative.ca/File_In_DAT "File In DAT"), [Audio File In CHOP](https://docs.derivative.ca/Audio_File_In_CHOP "Audio File In CHOP").
...
The location of an operator within the TouchDesigner environment, for example, `/geo1/circle1`, a node called `circle1` in a component called `geo1`. The path `/` is called [Root](https://docs.derivative.ca/Root "Root"). This path is displayed at the top of every [Pane](https://docs.derivative.ca/Pane "Pane"), showing which Component's network you are currently in. To refer instead to a filesystem folder, directory, disk file or `http:` address, see Folder.
