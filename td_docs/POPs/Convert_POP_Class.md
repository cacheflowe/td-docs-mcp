---
url: https://docs.derivative.ca/ConvertPOP_Class
category: POPs
title: ConvertPOP_Class
---

# convertPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Convert POP](Convert_POP.md "Convert POP").
