...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Field POP](https://docs.derivative.ca/Field_POP "Field POP").
