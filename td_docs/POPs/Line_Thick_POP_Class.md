---
url: https://docs.derivative.ca/LinethickPOP_Class
category: POPs
title: LinethickPOP_Class
---

# linethickPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Line Thick POP](https://docs.derivative.ca/Line_Thick_POP "Line Thick POP").
