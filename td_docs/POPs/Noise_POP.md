...
By default the Noise POP moves every point's `P` attribute a distance in X, Y and Z based on the point's position in the noise space. You can visualize the field by sending a [Grid POP](Grid_POP.md "Grid POP") into a Noise POP. Turn on the toggle parameter Compute Point Normals to see proper shading.
...
See also [Random POP](Random_POP.md "Random POP").

[noisePOP_Class](Noise_POP_Class.md "NoisePOP Class")
...
Extra Information for the Noise POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
