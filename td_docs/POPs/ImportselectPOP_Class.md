...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Import Select POP](https://docs.derivative.ca/Import_Select_POP "Import Select POP").
