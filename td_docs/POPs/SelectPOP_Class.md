...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Select POP](https://docs.derivative.ca/Select_POP "Select POP").
