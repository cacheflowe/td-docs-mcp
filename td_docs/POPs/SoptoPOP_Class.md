...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [SOP to POP](https://docs.derivative.ca/SOP_to_POP "SOP to POP").
