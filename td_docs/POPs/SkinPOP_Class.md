...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Skin POP](https://docs.derivative.ca/Skin_POP "Skin POP").
