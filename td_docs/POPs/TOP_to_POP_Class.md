---
url: https://docs.derivative.ca/ToptoPOP_Class
category: POPs
title: ToptoPOP_Class
---

# toptoPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [TOP to POP](TOP_to_POP.md "TOP to POP").
