...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Out POP](https://docs.derivative.ca/Out_POP "Out POP").
