---
url: https://docs.derivative.ca/PointPOP_Class
category: POPs
title: PointPOP_Class
---

# pointPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Point POP](Point_POP.md "Point POP").
