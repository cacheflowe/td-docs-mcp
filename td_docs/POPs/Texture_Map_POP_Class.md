---
url: https://docs.derivative.ca/TexturemapPOP_Class
category: POPs
title: TexturemapPOP_Class
---

# texturemapPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Texture Map POP](Texture_Map_POP.md "Texture Map POP").
