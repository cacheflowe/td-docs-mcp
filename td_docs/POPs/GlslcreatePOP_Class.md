...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [GLSL Create POP](https://docs.derivative.ca/GLSL_Create_POP "GLSL Create POP").
