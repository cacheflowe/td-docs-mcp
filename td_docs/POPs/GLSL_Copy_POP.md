...
[glslcopyPOP_Class](GLSL_Copy_POP_Class.md "GlslcopyPOP Class")
...
Extra Information for the GLSL Copy POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
