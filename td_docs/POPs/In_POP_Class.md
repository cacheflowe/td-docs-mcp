---
url: https://docs.derivative.ca/InPOP_Class
category: POPs
title: InPOP_Class
---
...
This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [In POP](In_POP.md "In POP").
