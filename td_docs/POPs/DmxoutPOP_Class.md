...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [DMX Out POP](https://docs.derivative.ca/DMX_Out_POP "DMX Out POP").
