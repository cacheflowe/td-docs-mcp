---
url: https://docs.derivative.ca/ForceradialPOP_Class
category: POPs
title: ForceradialPOP_Class
---

# forceradialPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Force Radial POP](Force_Radial_POP.md "Force Radial POP").
