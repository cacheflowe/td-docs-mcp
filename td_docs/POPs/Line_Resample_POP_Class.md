---
url: https://docs.derivative.ca/LineresamplePOP_Class
category: POPs
title: LineresamplePOP_Class
---

# lineresamplePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Line Resample POP](Line_Resample_POP.md "Line Resample POP").
