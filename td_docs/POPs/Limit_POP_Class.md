---
url: https://docs.derivative.ca/LimitPOP_Class
category: POPs
title: LimitPOP_Class
---

# limitPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Limit POP](Limit_POP.md "Limit POP").
