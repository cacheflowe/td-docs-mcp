...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Primitive POP](https://docs.derivative.ca/Primitive_POP "Primitive POP").
