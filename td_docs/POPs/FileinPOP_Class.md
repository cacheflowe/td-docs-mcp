...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [File In POP](https://docs.derivative.ca/File_In_POP "File In POP").
