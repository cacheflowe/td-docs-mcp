---
url: https://docs.derivative.ca/ConnectivityPOP_Class
category: POPs
title: ConnectivityPOP_Class
---

# connectivityPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Connectivity POP](Connectivity_POP.md "Connectivity POP").
