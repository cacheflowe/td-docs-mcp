---
url: https://docs.derivative.ca/SpherePOP_Class
category: POPs
title: SpherePOP_Class
---

# spherePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Sphere POP](Sphere_POP.md "Sphere POP").
