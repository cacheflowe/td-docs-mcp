---
url: https://docs.derivative.ca/AnalyzePOP_Class
category: POPs
title: AnalyzePOP_Class
---

# analyzePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Analyze POP](Analyze_POP.md "Analyze POP").
