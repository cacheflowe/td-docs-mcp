...
The Dimension POP can alter the dimensions of a POP. See [Dimension](../Glossary/Dimension.md "Dimension").
...
[dimensionPOP_Class](Dimension_POP_Class.md "DimensionPOP Class")
...
Extra Information for the Dimension POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
