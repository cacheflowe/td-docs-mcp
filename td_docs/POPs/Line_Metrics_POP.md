...
See also [POP Rotations](https://docs.derivative.ca/POP_Rotations "POP Rotations")

[linemetricsPOP_Class](Line_Metrics_POP_Class.md "LinemetricsPOP Class")
...
## Parameters - Orientation Page
- Normal `normal` - ⊞ - Whether to output an attribute containing the normal.
  * Normal `normal` -
  * Normal Attrib Name `normalname` - Attribute Name for Normal
- Binormal `binormal` - ⊞ - Whether to output an attribute containing the binormal.
  * Binormal `binormal` -
  * Binormal Attrib Name `binormalname` - Attribute Name for Binormal
- Quaternion `quaternion` - ⊞ - Whether to output an attribute containing the tangent-normal-binormal frame orientation as a quaternion.
  * Quaternion `quaternion` -
  * Quaternion Attrib Name `quaternionname` - Attribute Name for Quaternion
- Rotation Matrix `rotmat` - ⊞ - Whether to output an attribute containing the tangent-normal-binormal frame orientation as a rotation matrix.
  * Rotation Matrix `rotmat` -
  * Rotation Matrix Attrib Name `rotmatname` - Attribute Name for Rotation Matrix
- Transform Matrix `transformmat` - ⊞ - Whether to output an attribute containing the tangent-normal-binormal frame orientation as a transform matrix.
  * Transform Matrix `transformmat` -
  * Transform Matrix Attrib Name `transformmatname` - Attribute Name for Transform Matrix
- Input Seed Orientation `useinputorient` - ⊞ - Enables using an input attribute to define the initial orientation at each line‑strip starting point, using either quaternions or transform matrices.
  * Input Seed Orientation `useinputorient` -
  * Input Seed Orientation Attrib Name `inputorientattr` - Attribute Name for Input Seed Orientation
...
Extra Information for the Line Metrics POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
