---
url: https://docs.derivative.ca/CurvePOP_Class
category: POPs
title: CurvePOP_Class
---

# curvePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Curve POP](Curve_POP.md "Curve POP").
