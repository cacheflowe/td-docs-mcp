...
The Cache Blend POP takes a reference to a [Cache POP](Cache_POP.md "Cache POP") and outputs a blend of its cached data sets based on a Cache Index parameter and the Cache Weight parameter of the each of the sequential blocks.
...
See also: [Cache POP](Cache_POP.md "Cache POP"), [Cache Select POP](Cache_Select_POP.md "Cache Select POP"), [Blend POP](Blend_POP.md "Blend POP")

[cacheblendPOP_Class](Cache_Blend_POP_Class.md "CacheblendPOP Class")
...
Extra Information for the Cache Blend POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
