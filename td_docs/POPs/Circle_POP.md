...
See also [Rectangle POP](Rectangle_POP.md "Rectangle POP"), [Sphere POP](Sphere_POP.md "Sphere POP"), [Primitive POP](Primitive_POP.md "Primitive POP"), [Line POP](Line_POP.md "Line POP").

[circlePOP_Class](Circle_POP_Class.md "CirclePOP Class")
...
Extra Information for the Circle POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
