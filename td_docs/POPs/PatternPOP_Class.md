...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Pattern POP](https://docs.derivative.ca/Pattern_POP "Pattern POP").
