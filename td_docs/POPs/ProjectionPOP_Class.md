...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Projection POP](https://docs.derivative.ca/Projection_POP "Projection POP").
