---
url: https://docs.derivative.ca/LookuptexturePOP_Class
category: POPs
title: LookuptexturePOP_Class
---

# lookuptexturePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Lookup Texture POP](Lookup_Texture_POP.md "Lookup Texture POP").
