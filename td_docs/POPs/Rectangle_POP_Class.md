---
url: https://docs.derivative.ca/RectanglePOP_Class
category: POPs
title: RectanglePOP_Class
---

# rectanglePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Rectangle POP](Rectangle_POP.md "Rectangle POP").
