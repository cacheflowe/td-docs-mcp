---
url: https://docs.derivative.ca/TopologyPOP_Class
category: POPs
title: TopologyPOP_Class
---

# topologyPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Topology POP](Topology_POP.md "Topology POP").
