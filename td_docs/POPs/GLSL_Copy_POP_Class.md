---
url: https://docs.derivative.ca/GlslcopyPOP_Class
category: POPs
title: GlslcopyPOP_Class
---

# glslcopyPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [GLSL Copy POP](GLSL_Copy_POP.md "GLSL Copy POP").
