...
[patternPOP_Class](Pattern_POP_Class.md "PatternPOP Class")
...
Extra Information for the Pattern POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
