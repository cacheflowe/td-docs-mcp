...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Tube POP](https://docs.derivative.ca/Tube_POP "Tube POP").
