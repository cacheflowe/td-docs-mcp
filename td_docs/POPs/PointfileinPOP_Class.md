...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Point File In POP](https://docs.derivative.ca/Point_File_In_POP "Point File In POP").
