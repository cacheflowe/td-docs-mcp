...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Sort POP](https://docs.derivative.ca/Sort_POP "Sort POP").
