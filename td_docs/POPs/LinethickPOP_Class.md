...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Line Thick POP](https://docs.derivative.ca/Line_Thick_POP "Line Thick POP").
