---
url: https://docs.derivative.ca/LinemetricsPOP_Class
category: POPs
title: LinemetricsPOP_Class
---

# linemetricsPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Line Metrics POP](Line_Metrics_POP.md "Line Metrics POP").
