---
url: https://docs.derivative.ca/SelectPOP_Class
category: POPs
title: SelectPOP_Class
---

# selectPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Select POP](Select_POP.md "Select POP").
