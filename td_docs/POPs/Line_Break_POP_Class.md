---
url: https://docs.derivative.ca/LinebreakPOP_Class
category: POPs
title: LinebreakPOP_Class
---

# linebreakPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Line Break POP](Line_Break_POP.md "Line Break POP").
