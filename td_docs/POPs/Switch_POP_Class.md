---
url: https://docs.derivative.ca/SwitchPOP_Class
category: POPs
title: SwitchPOP_Class
---

# switchPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Switch POP](Switch_POP.md "Switch POP").
