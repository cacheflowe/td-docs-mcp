---
url: https://docs.derivative.ca/ProximityPOP_Class
category: POPs
title: ProximityPOP_Class
---

# proximityPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Proximity POP](Proximity_POP.md "Proximity POP").
