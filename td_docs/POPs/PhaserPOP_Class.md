...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Phaser POP](https://docs.derivative.ca/Phaser_POP "Phaser POP").
