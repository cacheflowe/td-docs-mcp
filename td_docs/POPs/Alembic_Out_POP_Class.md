---
url: https://docs.derivative.ca/AlembicoutPOP_Class
category: POPs
title: AlembicoutPOP_Class
---

# alembicoutPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Alembic Out POP](https://docs.derivative.ca/Alembic_Out_POP "Alembic Out POP").
