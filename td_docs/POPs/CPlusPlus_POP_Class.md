---
url: https://docs.derivative.ca/CplusplusPOP_Class
category: POPs
title: CplusplusPOP_Class
---

# cplusplusPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [CPlusPlus POP](CPlusPlus_POP.md "CPlusPlus POP").
