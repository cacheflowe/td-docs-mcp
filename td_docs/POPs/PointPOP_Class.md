...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Point POP](https://docs.derivative.ca/Point_POP "Point POP").
