---
url: https://docs.derivative.ca/LinesmoothPOP_Class
category: POPs
title: LinesmoothPOP_Class
---

# linesmoothPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Line Smooth POP](Line_Smooth_POP.md "Line Smooth POP").
