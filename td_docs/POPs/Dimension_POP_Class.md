---
url: https://docs.derivative.ca/DimensionPOP_Class
category: POPs
title: DimensionPOP_Class
---

# dimensionPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Dimension POP](Dimension_POP.md "Dimension POP").
