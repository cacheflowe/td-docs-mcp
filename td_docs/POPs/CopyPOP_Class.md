...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Copy POP](https://docs.derivative.ca/Copy_POP "Copy POP").
