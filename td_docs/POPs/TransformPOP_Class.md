...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Transform POP](https://docs.derivative.ca/Transform_POP "Transform POP").
