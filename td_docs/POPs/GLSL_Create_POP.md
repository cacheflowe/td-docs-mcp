...
[glslcreatePOP_Class](GLSL_Create_POP_Class.md "GlslcreatePOP Class")
...
Extra Information for the GLSL Create POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
