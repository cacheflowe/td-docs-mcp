...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Sphere POP](https://docs.derivative.ca/Sphere_POP "Sphere POP").
