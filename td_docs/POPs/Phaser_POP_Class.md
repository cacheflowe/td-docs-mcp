---
url: https://docs.derivative.ca/PhaserPOP_Class
category: POPs
title: PhaserPOP_Class
---

# phaserPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Phaser POP](https://docs.derivative.ca/Phaser_POP "Phaser POP").
...
True if the operators is a [POP](POP.md "POP").
