...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Line Break POP](https://docs.derivative.ca/Line_Break_POP "Line Break POP").
