---
url: https://docs.derivative.ca/DmxfixturePOP_Class
category: POPs
title: DmxfixturePOP_Class
---

# dmxfixturePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [DMX Fixture POP](DMX_Fixture_POP.md "DMX Fixture POP").
