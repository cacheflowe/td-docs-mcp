...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [DMX Fixture POP](https://docs.derivative.ca/DMX_Fixture_POP "DMX Fixture POP").
