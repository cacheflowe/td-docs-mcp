...
The Switch POP's architecture for handling multiple inputs is similar to the [Attribute Combine POP](Attribute_Combine_POP.md "Attribute Combine POP").

[switchPOP_Class](Switch_POP_Class.md "SwitchPOP Class")
...
Extra Information for the Switch POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
