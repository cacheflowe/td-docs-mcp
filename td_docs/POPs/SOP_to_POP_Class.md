---
url: https://docs.derivative.ca/SoptoPOP_Class
category: POPs
title: SoptoPOP_Class
---

# soptoPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [SOP to POP](SOP_to_POP.md "SOP to POP").
