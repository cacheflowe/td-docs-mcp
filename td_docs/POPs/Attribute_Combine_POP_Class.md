---
url: https://docs.derivative.ca/AttributecombinePOP_Class
category: POPs
title: AttributecombinePOP_Class
---

# attributecombinePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Attribute Combine POP](Attribute_Combine_POP.md "Attribute Combine POP").
