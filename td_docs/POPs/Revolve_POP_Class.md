---
url: https://docs.derivative.ca/RevolvePOP_Class
category: POPs
title: RevolvePOP_Class
---

# revolvePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Revolve POP](Revolve_POP.md "Revolve POP").
