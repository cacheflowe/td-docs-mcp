---
url: https://docs.derivative.ca/FeedbackPOP_Class
category: POPs
title: FeedbackPOP_Class
---

# feedbackPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Feedback POP](Feedback_POP.md "Feedback POP").
