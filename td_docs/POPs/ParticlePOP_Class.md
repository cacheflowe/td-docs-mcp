...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Particle POP](https://docs.derivative.ca/Particle_POP "Particle POP").
