...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Feedback POP](https://docs.derivative.ca/Feedback_POP "Feedback POP").
