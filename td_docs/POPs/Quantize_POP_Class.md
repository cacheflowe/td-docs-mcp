---
url: https://docs.derivative.ca/QuantizePOP_Class
category: POPs
title: QuantizePOP_Class
---

# quantizePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Quantize POP](Quantize_POP.md "Quantize POP").
