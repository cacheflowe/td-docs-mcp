...
You can check it all with a [POP to DAT](../DATs/POP_to_DAT.md "POP to DAT").

See also: [Analyze POP](Analyze_POP.md "Analyze POP"), [Histogram POP](Histogram_POP.md "Histogram POP")

[accumulatePOP_Class](Accumulate_POP_Class.md "AccumulatePOP Class")
...
Extra Information for the Accumulate POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
