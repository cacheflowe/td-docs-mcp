...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Neighbor POP](https://docs.derivative.ca/Neighbor_POP "Neighbor POP").
