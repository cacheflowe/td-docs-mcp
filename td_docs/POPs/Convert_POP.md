...
See also [Primitive POP](Primitive_POP.md "Primitive POP").

[convertPOP_Class](Convert_POP_Class.md "ConvertPOP Class")
...
Extra Information for the Convert POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
