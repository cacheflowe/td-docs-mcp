...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Line Divide POP](https://docs.derivative.ca/Line_Divide_POP "Line Divide POP").
