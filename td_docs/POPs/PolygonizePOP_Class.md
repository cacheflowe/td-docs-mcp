...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Polygonize POP](https://docs.derivative.ca/Polygonize_POP "Polygonize POP").
