...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Analyze POP](https://docs.derivative.ca/Analyze_POP "Analyze POP").
