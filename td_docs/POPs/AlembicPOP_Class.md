---
url: https://docs.derivative.ca/AlembicPOP_Class
category: POPs
title: AlembicPOP_Class
---

# alembicPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Alembic In POP](Alembic_In_POP.md "Alembic In POP").
