---
url: https://docs.derivative.ca/SubdividePOP_Class
category: POPs
title: SubdividePOP_Class
---

# subdividePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Subdivide POP](Subdivide_POP.md "Subdivide POP").
