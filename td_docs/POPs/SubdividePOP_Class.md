...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Subdivide POP](https://docs.derivative.ca/Subdivide_POP "Subdivide POP").
