---
url: https://docs.derivative.ca/TransformPOP_Class
category: POPs
title: TransformPOP_Class
---

# transformPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Transform POP](Transform_POP.md "Transform POP").
