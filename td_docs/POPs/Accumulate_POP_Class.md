---
url: https://docs.derivative.ca/AccumulatePOP_Class
category: POPs
title: AccumulatePOP_Class
---

# accumulatePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Accumulate POP](Accumulate_POP.md "Accumulate POP").
