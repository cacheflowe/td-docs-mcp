...
See also [Point POP](Point_POP.md "Point POP") which is basically the Points page of the Primitive POP.
...
[primitivePOP_Class](Primitive_POP_Class.md "PrimitivePOP Class")
...
Extra Information for the Create POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
