---
url: https://docs.derivative.ca/PointgeneratorPOP_Class
category: POPs
title: PointgeneratorPOP_Class
---

# pointgeneratorPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Point Generator POP](Point_Generator_POP.md "Point Generator POP").
