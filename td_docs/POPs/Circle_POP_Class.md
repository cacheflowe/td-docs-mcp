---
url: https://docs.derivative.ca/CirclePOP_Class
category: POPs
title: CirclePOP_Class
---

# circlePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Circle POP](Circle_POP.md "Circle POP").
