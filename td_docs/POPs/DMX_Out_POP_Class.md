---
url: https://docs.derivative.ca/DmxoutPOP_Class
category: POPs
title: DmxoutPOP_Class
---

# dmxoutPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [DMX Out POP](DMX_Out_POP.md "DMX Out POP").
