...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Normal POP](https://docs.derivative.ca/Normal_POP "Normal POP").
