---
url: https://docs.derivative.ca/NoisePOP_Class
category: POPs
title: NoisePOP_Class
---

# noisePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Noise POP](Noise_POP.md "Noise POP").
