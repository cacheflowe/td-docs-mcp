...
See also [Neighbor POP](Neighbor_POP.md "Neighbor POP"), [Line Metrics POP](Line_Metrics_POP.md "Line Metrics POP")

[proximityPOP_Class](Proximity_POP_Class.md "ProximityPOP Class")
...
Extra Information for the Proximity POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
