---
url: https://docs.derivative.ca/OakselectPOP_Class
category: POPs
title: OakselectPOP_Class
---

# oakselectPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [OAK Select POP](OAK_Select_POP.md "OAK Select POP").
