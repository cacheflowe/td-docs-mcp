...
The lookup curve (second input) can be the output of a [Curve POP](Curve_POP.md "Curve POP"), for example.
...
When interpolation is enabled, values are blended using linear interpolation. The operator also supports interpolating both transform matrices and quaternions.

See also [Lookup Texture POP](Lookup_Texture_POP.md "Lookup Texture POP"), [Lookup Channel POP](Lookup_Channel_POP.md "Lookup Channel POP"), [Curve POP](Curve_POP.md "Curve POP") (Lookup page).

[lookupattributePOP_Class](Lookup_Attribute_POP_Class.md "LookupattributePOP Class")
...
Extra Information for the Lookup Attribute POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
