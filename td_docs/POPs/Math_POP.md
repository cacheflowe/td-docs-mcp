...
The result can then be re-ranged (see the standalone [ReRange POP](ReRange_POP.md "ReRange POP") and quantized (see the standalone [Quantize POP](Quantize_POP.md "Quantize POP")).
...
See also [Math Mix POP](Math_Mix_POP.md "Math Mix POP"), [Math Combine POP](Math_Combine_POP.md "Math Combine POP"), [ReRange POP](ReRange_POP.md "ReRange POP"), [Quantize POP](Quantize_POP.md "Quantize POP")

See also [Math Mix Combine Functions](https://docs.derivative.ca/Math_Mix_Combine_Functions "Math Mix Combine Functions"), [POP Rotations](https://docs.derivative.ca/index.php?title=POP_Rotations&action=edit&redlink=1 "POP Rotations \(page does not exist\)")

[mathPOP_Class](Math_POP_Class.md "MathPOP Class")
...
Extra Information for the Math POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
