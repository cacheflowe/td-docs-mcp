...
See also [Point Generator POP](Point_Generator_POP.md "Point Generator POP"), [Random POP](Random_POP.md "Random POP")

[sprinklePOP_Class](Sprinkle_POP_Class.md "SprinklePOP Class")
...
Extra Information for the Sprinkle POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
