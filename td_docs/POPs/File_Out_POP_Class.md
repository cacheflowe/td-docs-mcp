---
url: https://docs.derivative.ca/FileoutPOP_Class
category: POPs
title: FileoutPOP_Class
---

# fileoutPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [File Out POP](File_Out_POP.md "File Out POP").
