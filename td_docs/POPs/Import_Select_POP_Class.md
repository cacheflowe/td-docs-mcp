---
url: https://docs.derivative.ca/ImportselectPOP_Class
category: POPs
title: ImportselectPOP_Class
---

# importselectPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Import Select POP](Import_Select_POP.md "Import Select POP").
