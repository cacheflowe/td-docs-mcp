---
url: https://docs.derivative.ca/ProjectionPOP_Class
category: POPs
title: ProjectionPOP_Class
---

# projectionPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Projection POP](Projection_POP.md "Projection POP").
