...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Line Resample POP](https://docs.derivative.ca/Line_Resample_POP "Line Resample POP").
