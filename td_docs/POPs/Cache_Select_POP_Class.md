---
url: https://docs.derivative.ca/CacheselectPOP_Class
category: POPs
title: CacheselectPOP_Class
---

# cacheselectPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Cache Select POP](Cache_Select_POP.md "Cache Select POP").
