---
url: https://docs.derivative.ca/AttributePOP_Class
category: POPs
title: AttributePOP_Class
---

# attributePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Attribute POP](Attribute_POP.md "Attribute POP").
