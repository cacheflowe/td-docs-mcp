...
The Merge POP's architecture for handling multiple inputs is similar to the [Attribute Combine POP](Attribute_Combine_POP.md "Attribute Combine POP").

[mergePOP_Class](Merge_POP_Class.md "MergePOP Class")
...
Extra Information for the Merge POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
