...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Plane POP](https://docs.derivative.ca/Plane_POP "Plane POP").
