...
The ReRange POP takes any attribute of its input, re-ranges its values, and outputs them to the same attribute, any other existing attribute or a new attribute. It operates on either point, vertex or primitive [attributes](../Glossary/Attribute.md "Attribute").
...
[rerangePOP_Class](ReRange_POP_Class.md "RerangePOP Class")
...
Extra Information for the ReRange POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
