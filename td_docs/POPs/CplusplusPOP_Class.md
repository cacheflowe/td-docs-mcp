...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [CPlusPlus POP](https://docs.derivative.ca/CPlusPlus_POP "CPlusPlus POP").
