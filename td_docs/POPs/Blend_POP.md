...
The Blend POP's architecture for handling multiple inputs is similar to the [Attribute Combine POP](Attribute_Combine_POP.md "Attribute Combine POP").
...
[blendPOP_Class](Blend_POP_Class.md "BlendPOP Class")
...
Extra Information for the Blend POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
