---
url: https://docs.derivative.ca/GlslselectPOP_Class
category: POPs
title: GlslselectPOP_Class
---

# glslselectPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [GLSL Select POP](GLSL_Select_POP.md "GLSL Select POP").
