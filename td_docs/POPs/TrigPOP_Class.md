...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Trig POP](https://docs.derivative.ca/Trig_POP "Trig POP").
