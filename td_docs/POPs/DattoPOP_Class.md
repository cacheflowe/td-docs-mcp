...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [DAT to POP](https://docs.derivative.ca/DAT_to_POP "DAT to POP").
