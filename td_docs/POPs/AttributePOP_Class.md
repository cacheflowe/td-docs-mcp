...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Attribute POP](https://docs.derivative.ca/Attribute_POP "Attribute POP").
