---
url: https://docs.derivative.ca/ParticlePOP_Class
category: POPs
title: ParticlePOP_Class
---

# particlePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Particle POP](Particle_POP.md "Particle POP").
