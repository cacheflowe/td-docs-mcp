...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Facet POP](https://docs.derivative.ca/Facet_POP "Facet POP").
