---
url: https://docs.derivative.ca/ChoptoPOP_Class
category: POPs
title: ChoptoPOP_Class
---

# choptoPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [CHOP to POP](CHOP_to_POP.md "CHOP to POP").
