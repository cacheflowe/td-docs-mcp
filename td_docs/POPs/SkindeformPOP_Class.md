...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Skin Deform POP](https://docs.derivative.ca/Skin_Deform_POP "Skin Deform POP").
