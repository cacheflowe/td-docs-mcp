...
[cplusplusPOP_Class](CPlusPlus_POP_Class.md "CplusplusPOP Class")
...
Extra Information for the CPlusPlus POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
