...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [TOP to POP](https://docs.derivative.ca/TOP_to_POP "TOP to POP").
