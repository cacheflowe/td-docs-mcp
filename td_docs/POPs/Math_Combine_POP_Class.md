---
url: https://docs.derivative.ca/MathcombinePOP_Class
category: POPs
title: MathcombinePOP_Class
---

# mathcombinePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Math Combine POP](Math_Combine_POP.md "Math Combine POP").
