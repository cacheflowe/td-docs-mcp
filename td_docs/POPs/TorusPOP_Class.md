...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Torus POP](https://docs.derivative.ca/Torus_POP "Torus POP").
