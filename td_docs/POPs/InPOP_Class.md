...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [In POP](https://docs.derivative.ca/In_POP "In POP").
