...
[neighborPOP_Class](Neighbor_POP_Class.md "NeighborPOP Class")
...
Extra Information for the Neighbor POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
