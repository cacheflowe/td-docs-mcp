---
url: https://docs.derivative.ca/LookupchannelPOP_Class
category: POPs
title: LookupchannelPOP_Class
---

# lookupchannelPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Lookup Channel POP](Lookup_Channel_POP.md "Lookup Channel POP").
