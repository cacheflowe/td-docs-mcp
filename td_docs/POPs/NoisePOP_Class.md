...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Noise POP](https://docs.derivative.ca/Noise_POP "Noise POP").
