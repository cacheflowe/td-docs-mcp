---
url: https://docs.derivative.ca/TextPOP_Class
category: POPs
title: TextPOP_Class
---
...
This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Text POP](https://docs.derivative.ca/Text_POP "Text POP").
