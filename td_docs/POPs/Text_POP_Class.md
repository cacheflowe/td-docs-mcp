...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Text POP](https://docs.derivative.ca/Text_POP "Text POP").
