---
url: https://docs.derivative.ca/MathmixPOP_Class
category: POPs
title: MathmixPOP_Class
---

# mathmixPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Math Mix POP](Math_Mix_POP.md "Math Mix POP").
