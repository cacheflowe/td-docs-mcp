...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Triangulate POP](https://docs.derivative.ca/Triangulate_POP "Triangulate POP").
