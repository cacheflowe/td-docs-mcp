---
url: https://docs.derivative.ca/TriangulatePOP_Class
category: POPs
title: TriangulatePOP_Class
---

# triangulatePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Triangulate POP](https://docs.derivative.ca/Triangulate_POP "Triangulate POP").
