...
See also [Primitive POP](Primitive_POP.md "Primitive POP"), [Convert POP](Convert_POP.md "Convert POP")

[linebreakPOP_Class](Line_Break_POP_Class.md "LinebreakPOP Class")
...
Extra Information for the Line Break POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
