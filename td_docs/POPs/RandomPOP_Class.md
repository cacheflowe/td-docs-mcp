...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Random POP](https://docs.derivative.ca/Random_POP "Random POP").
