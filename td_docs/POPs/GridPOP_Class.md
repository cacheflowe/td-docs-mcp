...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Grid POP](https://docs.derivative.ca/Grid_POP "Grid POP").
