...
The `Tex` attribute is a float3 3-component attribute. It can appear as a point attribute or a vertex attribute. It is created by all the generator POPs like the [Plane POP](Plane_POP.md "Plane POP"), [Grid POP](Grid_POP.md "Grid POP"), [Sphere POP](Sphere_POP.md "Sphere POP"), [Rectangle POP](Rectangle_POP.md "Rectangle POP"), [Box POP](Box_POP.md "Box POP") etc., but `Tex` can also created with the Texture Map POP.
...
There is nothing special about the `Tex` attribute - any attribute can be used by a Material. The [Normalize POP](Normalize_POP.md "Normalize POP") and the [Projection POP](Projection_POP.md "Projection POP") produce attributes that can be used with a material, like doing orhtographic scaled projections, or spherical/cylindrical projections.
...
See also [PBR MAT](../MATs/PBR_MAT.md "PBR MAT"), [Phong MAT](../MATs/Phong_MAT.md "Phong MAT"), [Normalize POP](Normalize_POP.md "Normalize POP") and the [Projection POP](Projection_POP.md "Projection POP")

[texturemapPOP_Class](Texture_Map_POP_Class.md "TexturemapPOP Class")
...
Extra Information for the Texture Map POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
