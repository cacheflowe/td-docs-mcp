...
additional to this, an unsigned integer attribute `DMXFixtureGap` can be used to overwrite the Channel Gap parameter per primitive in a DMX Fixture POP.
...
See also: [DMX Out POP](DMX_Out_POP.md "DMX Out POP"), [DMX Map DAT](https://docs.derivative.ca/DMX_Map_DAT "DMX Map DAT"), [DMX](../Interoperability/DMX.md "DMX")

[dmxfixturePOP_Class](DMX_Fixture_POP_Class.md "DmxfixturePOP Class")
...
Extra Information for the DMX Fixture POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
