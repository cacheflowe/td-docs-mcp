...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Force Radial POP](https://docs.derivative.ca/Force_Radial_POP "Force Radial POP").
