---
url: https://docs.derivative.ca/TracePOP_Class
category: POPs
title: TracePOP_Class
---

# tracePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Trace POP](https://docs.derivative.ca/Trace_POP "Trace POP").
