...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Trace POP](https://docs.derivative.ca/Trace_POP "Trace POP").
