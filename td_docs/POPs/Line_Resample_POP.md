...
Line Resample POP doe not change the shape of the lines, unlike [Line Smooth POP](Line_Smooth_POP.md "Line Smooth POP").

See also [Line Divide POP](Line_Divide_POP.md "Line Divide POP"), [Line Smooth POP](Line_Smooth_POP.md "Line Smooth POP").

[lineresamplePOP_Class](Line_Resample_POP_Class.md "LineresamplePOP Class")
...
Extra Information for the Line Resample POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
