---
url: https://docs.derivative.ca/FileinPOP_Class
category: POPs
title: FileinPOP_Class
---

# fileinPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [File In POP](File_In_POP.md "File In POP").
