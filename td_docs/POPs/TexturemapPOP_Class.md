...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Texture Map POP](https://docs.derivative.ca/Texture_Map_POP "Texture Map POP").
