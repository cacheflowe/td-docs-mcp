---
url: https://docs.derivative.ca/PrimitivePOP_Class
category: POPs
title: PrimitivePOP_Class
---

# primitivePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Primitive POP](Primitive_POP.md "Primitive POP").
