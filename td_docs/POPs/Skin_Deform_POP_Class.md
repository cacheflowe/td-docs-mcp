---
url: https://docs.derivative.ca/SkindeformPOP_Class
category: POPs
title: SkindeformPOP_Class
---

# skindeformPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Skin Deform POP](Skin_Deform_POP.md "Skin Deform POP").
