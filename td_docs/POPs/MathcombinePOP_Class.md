...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Math Combine POP](https://docs.derivative.ca/Math_Combine_POP "Math Combine POP").
