---
url: https://docs.derivative.ca/LookupattributePOP_Class
category: POPs
title: LookupattributePOP_Class
---

# lookupattributePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Lookup Attribute POP](Lookup_Attribute_POP.md "Lookup Attribute POP").
