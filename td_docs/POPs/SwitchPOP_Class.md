...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Switch POP](https://docs.derivative.ca/Switch_POP "Switch POP").
