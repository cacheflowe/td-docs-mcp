---
url: https://docs.derivative.ca/GlslcreatePOP_Class
category: POPs
title: GlslcreatePOP_Class
---

# glslcreatePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [GLSL Create POP](GLSL_Create_POP.md "GLSL Create POP").
