...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Rectangle POP](https://docs.derivative.ca/Rectangle_POP "Rectangle POP").
