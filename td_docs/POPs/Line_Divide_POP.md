...
[linedividePOP_Class](Line_Divide_POP_Class.md "LinedividePOP Class")
...
Extra Information for the Line Divide POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
