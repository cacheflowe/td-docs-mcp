...
See also [GLSL Advanced POP](GLSL_Advanced_POP.md "GLSL Advanced POP")

[glslPOP_Class](GLSL_POP_Class.md "GlslPOP Class")
...
Extra Information for the GLSL POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
