...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Limit POP](https://docs.derivative.ca/Limit_POP "Limit POP").
