---
url: https://docs.derivative.ca/PolygonizePOP_Class
category: POPs
title: PolygonizePOP_Class
---

# polygonizePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Polygonize POP](Polygonize_POP.md "Polygonize POP").
