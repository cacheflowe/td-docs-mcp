...
See also tbe [Sphere POP](Sphere_POP.md "Sphere POP"), [Tube POP](Tube_POP.md "Tube POP"), [Normalize POP](Normalize_POP.md "Normalize POP") and the [Texture Map POP](Texture_Map_POP.md "Texture Map POP").

[projectionPOP_Class](Projection_POP_Class.md "ProjectionPOP Class")
...
Extra Information for the Projection POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
