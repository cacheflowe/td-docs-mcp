...
[importselectPOP_Class](Import_Select_POP_Class.md "ImportselectPOP Class")
...
Extra Information for the Import Select POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
