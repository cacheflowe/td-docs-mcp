---
url: https://docs.derivative.ca/AttributeconvertPOP_Class
category: POPs
title: AttributeconvertPOP_Class
---

# attributeconvertPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Attribute Convert POP](Attribute_Convert_POP.md "Attribute Convert POP").
