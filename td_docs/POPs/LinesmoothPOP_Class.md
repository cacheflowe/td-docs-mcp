...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Line Smooth POP](https://docs.derivative.ca/Line_Smooth_POP "Line Smooth POP").
