...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Connectivity POP](https://docs.derivative.ca/Connectivity_POP "Connectivity POP").
