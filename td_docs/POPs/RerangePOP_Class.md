...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [ReRange POP](https://docs.derivative.ca/ReRange_POP "ReRange POP").
