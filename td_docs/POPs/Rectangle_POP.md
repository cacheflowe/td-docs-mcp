...
[rectanglePOP_Class](Rectangle_POP_Class.md "RectanglePOP Class")
...
Extra Information for the Rectangle POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
