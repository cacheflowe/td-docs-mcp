---
url: https://docs.derivative.ca/PointfileinPOP_Class
category: POPs
title: PointfileinPOP_Class
---

# pointfileinPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Point File In POP](Point_File_In_POP.md "Point File In POP").
