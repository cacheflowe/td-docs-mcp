---
url: https://docs.derivative.ca/PatternPOP_Class
category: POPs
title: PatternPOP_Class
---

# patternPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Pattern POP](Pattern_POP.md "Pattern POP").
