---
url: https://docs.derivative.ca/NormalizePOP_Class
category: POPs
title: NormalizePOP_Class
---

# normalizePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Normalize POP](Normalize_POP.md "Normalize POP").
