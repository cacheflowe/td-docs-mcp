---
url: https://docs.derivative.ca/NeighborPOP_Class
category: POPs
title: NeighborPOP_Class
---

# neighborPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Neighbor POP](Neighbor_POP.md "Neighbor POP").
