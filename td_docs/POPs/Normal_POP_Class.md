---
url: https://docs.derivative.ca/NormalPOP_Class
category: POPs
title: NormalPOP_Class
---

# normalPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Normal POP](Normal_POP.md "Normal POP").
