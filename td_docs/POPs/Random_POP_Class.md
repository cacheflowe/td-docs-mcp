---
url: https://docs.derivative.ca/RandomPOP_Class
category: POPs
title: RandomPOP_Class
---

# randomPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Random POP](Random_POP.md "Random POP").
