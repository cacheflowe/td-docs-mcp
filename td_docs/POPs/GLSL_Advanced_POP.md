...
[glsladvancedPOP_Class](GLSL_Advanced_POP_Class.md "GlsladvancedPOP Class")
...
Extra Information for the GLSL Advanced POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
