---
url: https://docs.derivative.ca/HistogramPOP_Class
category: POPs
title: HistogramPOP_Class
---

# histogramPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Histogram POP](Histogram_POP.md "Histogram POP").
