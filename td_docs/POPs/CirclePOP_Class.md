...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Circle POP](https://docs.derivative.ca/Circle_POP "Circle POP").
