...
This **architecture for handling multiple inputs** to POPs in the Attribute Combine POP is also part of numerous other POPs, such as the [Math Combine POP](Math_Combine_POP.md "Math Combine POP"), [Math Mix POP](Math_Mix_POP.md "Math Mix POP"), [Blend POP](Blend_POP.md "Blend POP"), [Merge POP](Merge_POP.md "Merge POP") and [Switch POP](Switch_POP.md "Switch POP").

[attributecombinePOP_Class](Attribute_Combine_POP_Class.md "AttributecombinePOP Class")
...
Extra Information for the Attribute POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
