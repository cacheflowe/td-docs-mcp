...
This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Extrude POP](https://docs.derivative.ca/Extrude_POP "Extrude POP").
