---
url: https://docs.derivative.ca/DeletePOP_Class
category: POPs
title: DeletePOP_Class
---

# deletePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Delete POP](Delete_POP.md "Delete POP").
