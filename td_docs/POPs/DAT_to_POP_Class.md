---
url: https://docs.derivative.ca/DattoPOP_Class
category: POPs
title: DattoPOP_Class
---

# dattoPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [DAT to POP](DAT_to_POP.md "DAT to POP").
