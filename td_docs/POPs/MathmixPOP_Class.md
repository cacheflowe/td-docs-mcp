...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Math Mix POP](https://docs.derivative.ca/Math_Mix_POP "Math Mix POP").
