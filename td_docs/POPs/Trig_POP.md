...
See also [Math Mix POP](Math_Mix_POP.md "Math Mix POP"), [LFO CHOP](../CHOPs/LFO_CHOP.md "LFO CHOP")

[trigPOP_Class](Trig_POP_Class.md "TrigPOP Class")
...
Extra Information for the Trig POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
