...
This class inherits from the [ POP class](https://docs.derivative.ca/POP_Class "POP Class"). It references a specific [Box POP](https://docs.derivative.ca/Box_POP "Box POP").
