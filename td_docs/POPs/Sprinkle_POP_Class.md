---
url: https://docs.derivative.ca/SprinklePOP_Class
category: POPs
title: SprinklePOP_Class
---

# sprinklePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Sprinkle POP](Sprinkle_POP.md "Sprinkle POP").
