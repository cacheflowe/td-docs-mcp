---
url: https://docs.derivative.ca/GlsladvancedPOP_Class
category: POPs
title: GlsladvancedPOP_Class
---

# glsladvancedPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [GLSL Advanced POP](GLSL_Advanced_POP.md "GLSL Advanced POP").
