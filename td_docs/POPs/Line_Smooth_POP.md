...
In the Pre-Divide stage, it optionally adds more points by subdividing, similar to how the [Line Divide POP](Line_Divide_POP.md "Line Divide POP") adds new points, and it can add points based on the curvature of adjacent points.
...
See also [Line Divide POP](Line_Divide_POP.md "Line Divide POP"), [Line Resample POP](Line_Resample_POP.md "Line Resample POP")

[linesmoothPOP_Class](Line_Smooth_POP_Class.md "LinesmoothPOP Class")
...
Extra Information for the Line Smooth POP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
