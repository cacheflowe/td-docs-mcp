---
url: https://docs.derivative.ca/CacheblendPOP_Class
category: POPs
title: CacheblendPOP_Class
---

# cacheblendPOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [Cache Blend POP](Cache_Blend_POP.md "Cache Blend POP").
