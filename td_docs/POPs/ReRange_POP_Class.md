---
url: https://docs.derivative.ca/RerangePOP_Class
category: POPs
title: RerangePOP_Class
---

# rerangePOP Class

This class inherits from the [ POP class](../Python/POP_Class.md "POP Class"). It references a specific [ReRange POP](ReRange_POP.md "ReRange POP").
