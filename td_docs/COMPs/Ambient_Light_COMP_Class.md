---
url: https://docs.derivative.ca/AmbientlightCOMP_Class
category: COMPs
title: AmbientlightCOMP_Class
---

# ambientlightCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Ambient Light COMP](Ambient_Light_COMP.md "Ambient Light COMP").
