---
url: https://docs.derivative.ca/ButtonCOMP_Class
category: COMPs
title: ButtonCOMP_Class
---

# buttonCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Button COMP](Button_COMP.md "Button COMP").
