---
url: https://docs.derivative.ca/EngineCOMP_Class
category: COMPs
title: EngineCOMP_Class
---

# engineCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Engine COMP](Engine_COMP.md "Engine COMP").
...
Go to Done. Equivalent to pulsing the Go to Done parameter on the Engine Page.
