...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Impulse Force COMP](https://docs.derivative.ca/Impulse_Force_COMP "Impulse Force COMP").
