...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Shared Mem Out COMP](https://docs.derivative.ca/Shared_Mem_Out_COMP "Shared Mem Out COMP").
