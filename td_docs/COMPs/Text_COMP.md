---
url: https://docs.derivative.ca/Text_COMP
category: COMPs
title: Text_COMP
---
...
The Text COMP is a [panel](../Glossary/Panel.md "Panel") used to display text for building user interfaces. The text can be view-only, view-only but copy/pasteable, or be fully editable directly in the panel.
...
**Resolution -independent text** is drawn directly to the screen at the resolution required for the panel size, resulting in perfectly crisp text at all zoom levels. It is GPU-based using the [Slug Library](../Interoperability/Slug_Library.md "Slug Library").
...
See [Operator Snippets](../Learn/OP_Snippets.md "OP Snippets") for examples of the Text COMP.
...
[textCOMP_Class](Text_COMP_Class.md "TextCOMP Class")
