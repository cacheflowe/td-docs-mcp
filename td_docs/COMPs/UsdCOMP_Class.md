...
# usdCOMP Class
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [USD COMP](https://docs.derivative.ca/USD_COMP "USD COMP").
