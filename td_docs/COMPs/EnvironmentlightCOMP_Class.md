...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Environment Light COMP](https://docs.derivative.ca/Environment_Light_COMP "Environment Light COMP").
