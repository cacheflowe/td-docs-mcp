...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Window COMP](https://docs.derivative.ca/Window_COMP "Window COMP").
