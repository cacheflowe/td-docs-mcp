...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Widget COMP](https://docs.derivative.ca/Widget_COMP "Widget COMP").
...
Simulate a mouse click on the panel at a specific location.
  ...
  * group - (Keyword, Optional) Specifies an optional panel group name. See the [Button COMP](https://docs.derivative.ca/Button_COMP "Button COMP") for a description of group labels.
