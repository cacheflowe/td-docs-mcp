---
url: https://docs.derivative.ca/Container_COMP
category: COMPs
title: Container_COMP
---
...
The Container Component groups together any number of button, slider, field, container and other [Panel Components](../Glossary/Panel_Component.md "Panel Component") to build an interface. For example, the Container Component would be used to start creating your control panel, inside it you would place all the sliders, buttons, and viewer panels. It could also be used to group multiple sliders and buttons together into one panel that can be moved and scaled together, such as 3 RGB sliders for a color picker in your control panel.

[containerCOMP_Class](Container_COMP_Class.md "ContainerCOMP Class")
...
Extra Information for the Container COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
