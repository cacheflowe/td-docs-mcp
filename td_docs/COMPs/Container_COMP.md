...
[containerCOMP_Class](https://docs.derivative.ca/ContainerCOMP_Class "ContainerCOMP Class")
...
## Info CHOP Channels
Extra Information for the Container COMP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
