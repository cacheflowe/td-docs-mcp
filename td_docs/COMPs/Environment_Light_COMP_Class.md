---
url: https://docs.derivative.ca/EnvironmentlightCOMP_Class
category: COMPs
title: EnvironmentlightCOMP_Class
---

# environmentlightCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Environment Light COMP](Environment_Light_COMP.md "Environment Light COMP").
