---
url: https://docs.derivative.ca/Handle_COMP
category: COMPs
title: Handle_COMP
---
...
Extra Information for the Handle COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
