...
- Input Editor `inputeditor` - Include the multi-input editor UI. This appears at the end of multi-input parameter dialogs such as the one used in the [Math CHOP](https://docs.derivative.ca/Math_CHOP "Math CHOP") or [Merge SOP](https://docs.derivative.ca/Merge_SOP "Merge SOP").
[![InputEditor.png](https://docs.derivative.ca/images/c/c3/InputEditor.png)](https://docs.derivative.ca/File:InputEditor.png)
- Allow Expansion `allowexpand` - Turn On/Off the ability for parameters to be expanded showing the [parameter mode](https://docs.derivative.ca/Parameter#Parameter_Modes_and_Evaluation "Parameter") and expression editing field.
...
- Page Scope `pagescope` - ⊞ - Selects with pages of parameters to include. Use * for [Pattern Matching](https://docs.derivative.ca/Pattern_Matching "Pattern Matching") all.
  * * `*` -
  * Base `Base` -
...
- Parameter Scope `parscope` - ⊞ - Selects which parameters to include. Use * for [Pattern Matching](https://docs.derivative.ca/Pattern_Matching "Pattern Matching") all.
  * * `*` -
