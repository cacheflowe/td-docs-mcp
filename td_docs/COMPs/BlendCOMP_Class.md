...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Blend COMP](https://docs.derivative.ca/Blend_COMP "Blend COMP").
