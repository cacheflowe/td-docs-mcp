---
url: https://docs.derivative.ca/BaseCOMP_Class
category: COMPs
title: BaseCOMP_Class
---

# baseCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Base COMP](Base_COMP.md "Base COMP").
