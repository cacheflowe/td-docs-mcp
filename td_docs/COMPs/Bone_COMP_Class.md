---
url: https://docs.derivative.ca/BoneCOMP_Class
category: COMPs
title: BoneCOMP_Class
---

# boneCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Bone COMP](Bone_COMP.md "Bone COMP").
