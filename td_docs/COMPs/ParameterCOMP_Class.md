...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Parameter COMP](https://docs.derivative.ca/Parameter_COMP "Parameter COMP").
