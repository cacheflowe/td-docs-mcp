---
url: https://docs.derivative.ca/GltfinCOMP_Class
category: COMPs
title: GltfinCOMP_Class
---

# gltfinCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [glTF In COMP](GlTF_In_COMP.md "GlTF In COMP").
