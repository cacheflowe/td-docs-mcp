---
url: https://docs.derivative.ca/GLSL_COMP
category: COMPs
title: GLSL_COMP
---
...
[glslCOMP_Class](GLSL_COMP_Class.md "GlslCOMP Class")
...
Refer to the [Texture Sampling Parameters](../TOPs/Texture_Sampling_Parameters.md "Texture Sampling Parameters") article for more information on the parameters exposed by pressing the + button. The _parameter_ prefix for each of the parameters is _sampler[digit]_.
...
Extra Information for the GLSL COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
