...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Slider COMP](https://docs.derivative.ca/Slider_COMP "Slider COMP").
