...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Constraint COMP](https://docs.derivative.ca/Constraint_COMP "Constraint COMP").
