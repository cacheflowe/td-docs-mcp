---
url: https://docs.derivative.ca/SelectCOMP_Class
category: COMPs
title: SelectCOMP_Class
---

# selectCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Select COMP](Select_COMP.md "Select COMP").
