---
url: https://docs.derivative.ca/ForceCOMP_Class
category: COMPs
title: ForceCOMP_Class
---

# forceCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Force COMP](Force_COMP.md "Force COMP").
