---
url: https://docs.derivative.ca/ImpulseforceCOMP_Class
category: COMPs
title: ImpulseforceCOMP_Class
---

# impulseforceCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Impulse Force COMP](Impulse_Force_COMP.md "Impulse Force COMP").
