...
The Select component selects a [Panel Component](https://docs.derivative.ca/Panel_Component "Panel Component") from any other location. This allows a panel to appear in multiple other panels. Note that the Select component does not support child panels ie. through its output connector or embedded panels.
...
[selectCOMP_Class](https://docs.derivative.ca/SelectCOMP_Class "SelectCOMP Class")

## Parameters - Select Page
- Select Panel `selectpanel` - The [Panel](https://docs.derivative.ca/Panel "Panel") Component which is being selected.
...
## Info CHOP Channels
Extra Information for the Select COMP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
