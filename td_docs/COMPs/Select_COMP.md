---
url: https://docs.derivative.ca/Select_COMP
category: COMPs
title: Select_COMP
---
...
The Select component selects a [Panel Component](../Glossary/Panel_Component.md "Panel Component") from any other location. This allows a panel to appear in multiple other panels. Note that the Select component does not support child panels ie. through its output connector or embedded panels.

Can be used to select components recursively. If _select1_ points to _select2_ , it will display whatever _select2_ points to (recursively) using _select2'_ s parameters.

The Select component can re-size the component it refers to by setting its Width and Height parameters.

[selectCOMP_Class](Select_COMP_Class.md "SelectCOMP Class")

## Parameters - Select Page
- Select Panel `selectpanel` - The [Panel](../Glossary/Panel.md "Panel") Component which is being selected.
...
Extra Information for the Select COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
