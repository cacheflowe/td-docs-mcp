---
url: https://docs.derivative.ca/BlendCOMP_Class
category: COMPs
title: BlendCOMP_Class
---

# blendCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Blend COMP](Blend_COMP.md "Blend COMP").
