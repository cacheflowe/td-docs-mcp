...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Shared Mem In COMP](https://docs.derivative.ca/Shared_Mem_In_COMP "Shared Mem In COMP").
