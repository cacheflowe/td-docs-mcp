...
# engineCOMP Class
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Engine COMP](https://docs.derivative.ca/Engine_COMP "Engine COMP").
