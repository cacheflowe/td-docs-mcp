---
url: https://docs.derivative.ca/Slider_COMP
category: COMPs
title: Slider_COMP
---
...
The Slider Component lets you build sliders in X, Y and XY, and outputs 1 or 2 channels from a [Panel CHOP](../CHOPs/Panel_CHOP.md "Panel CHOP") placed in the Slider component.
...
See [Panel Value](../Glossary/Panel_Value.md "Panel Value").

[sliderCOMP_Class](Slider_COMP_Class.md "SliderCOMP Class")

## Parameters - Slider Page
- Label `label` - The label that appears on the slider
- Slider Type `slidertype` - ⊞ - Sets the type of slider.
  * Slider U `slideru` - A horizontal slider that tracks movement only in the **u** [Panel Value](../Glossary/Panel_Value.md "Panel Value").
  * Slider V `sliderv` - A vertical slider that tracks movement only in the **v** [Panel Value](../Glossary/Panel_Value.md "Panel Value").
  * Slider UV `slideruv` - A slider that tracks movement in both **u** and **v** [Panel Values](../Glossary/Panel_Value.md "Panel Value").
...
Extra Information for the Slider COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
