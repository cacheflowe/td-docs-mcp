...
The Slider Component lets you build sliders in X, Y and XY, and outputs 1 or 2 channels from a [Panel CHOP](https://docs.derivative.ca/Panel_CHOP "Panel CHOP") placed in the Slider component.
...
See [Panel Value](https://docs.derivative.ca/Panel_Value "Panel Value").
[sliderCOMP_Class](https://docs.derivative.ca/SliderCOMP_Class "SliderCOMP Class")

## Parameters - Slider Page
- Label `label` - The label that appears on the slider
- Slider Type `slidertype` - ⊞ - Sets the type of slider.
  * Slider U `slideru` - A horizontal slider that tracks movement only in the **u** [Panel Value](https://docs.derivative.ca/Panel_Value "Panel Value").
  * Slider V `sliderv` - A vertical slider that tracks movement only in the **v** [Panel Value](https://docs.derivative.ca/Panel_Value "Panel Value").
  * Slider UV `slideruv` - A slider that tracks movement in both **u** and **v** [Panel Values](https://docs.derivative.ca/Panel_Value "Panel Value").
...
## Info CHOP Channels
Extra Information for the Slider COMP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
