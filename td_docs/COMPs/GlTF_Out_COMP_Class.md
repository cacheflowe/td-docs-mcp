---
url: https://docs.derivative.ca/GltfoutCOMP_Class
category: COMPs
title: GltfoutCOMP_Class
---

# gltfoutCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [glTF Out COMP](https://docs.derivative.ca/GlTF_Out_COMP "GlTF Out COMP").
