---
url: https://docs.derivative.ca/Bone_COMP
category: COMPs
title: Bone_COMP
---
...
The Bone Component is the foundation of all of the [Character Tools](https://docs.derivative.ca/Character_Tools "Character Tools"). It is a Component with most of the properties of a [Geometry Component](../Glossary/Geometry_COMP.md "Geometry COMP"). It also has some extra features such as length, two types of geometry, end-to-end linking, and kinematic parameters.
...
[boneCOMP_Class](Bone_COMP_Class.md "BoneCOMP Class")
...
The Capture page is used to automatically create a capture region used by either the Capture or Deform sops (see [Capture SOP](../SOPs/Capture_SOP.md "Capture SOP") and [Deform SOP](../SOPs/Deform_SOP.md "Deform SOP") of the SOPs section). The capture region consists of at least two ellipses, and they may be translated along the bone's length.
...
Extra Information for the Bone COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
