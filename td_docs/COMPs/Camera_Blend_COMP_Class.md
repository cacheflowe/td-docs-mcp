---
url: https://docs.derivative.ca/CamerablendCOMP_Class
category: COMPs
title: CamerablendCOMP_Class
---

# camerablendCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Camera Blend COMP](Camera_Blend_COMP.md "Camera Blend COMP").
