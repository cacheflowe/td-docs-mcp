---
url: https://docs.derivative.ca/SharedmemoutCOMP_Class
category: COMPs
title: SharedmemoutCOMP_Class
---

# sharedmemoutCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Shared Mem Out COMP](Shared_Mem_Out_COMP.md "Shared Mem Out COMP").
