---
url: https://docs.derivative.ca/AnimationCOMP_Class
category: COMPs
title: AnimationCOMP_Class
---

# animationCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Animation COMP](../Glossary/Animation_COMP.md "Animation COMP").
...
`setKeyframe(position, channel='*', value=None, function=None)`→ `None`:
...
`deleteKeyframe(position, channel='*', value=None, function=None)`→ `None`:
