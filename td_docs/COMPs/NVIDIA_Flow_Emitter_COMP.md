---
url: https://docs.derivative.ca/NVIDIA_Flow_Emitter_COMP
category: COMPs
title: NVIDIA_Flow_Emitter_COMP
---
...
See also [Nvidia Flow TOP](../Interoperability/Nvidia_Flow_TOP.md "Nvidia Flow TOP"), [Nvidia Flow](https://docs.derivative.ca/Nvidia_Flow "Nvidia Flow").

[flowEmitterCOMP_Class](FlowEmitterCOMP_Class.md "FlowEmitterCOMP Class")
...
- Type `type` - ⊞ - Select the shape type used for the emitter.
  ...
  * Shape SOP `sop` - Uses the SOP specified in the Shape OP parameter below to create an emitter with the shape of the SOP's geometry.
...
The effect of this parameter can be visualized by turning 'Show Blocks' parameter On in the [Nvidia Flow TOP](../Interoperability/Nvidia_Flow_TOP.md "Nvidia Flow TOP").
...
Extra Information for the Nvidia Flow Emitter COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
