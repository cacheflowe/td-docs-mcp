...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Bone COMP](https://docs.derivative.ca/Bone_COMP "Bone COMP").
