...
The PanelCOMP describes an instance of a [Panel Component](https://docs.derivative.ca/Panel_Component "Panel Component"). The state is represented by [Panel Values](https://docs.derivative.ca/Panel_Value "Panel Value"). This class inherits from the COMP Class.
...
An intermediate [sequence collection](https://docs.derivative.ca/SequenceCollection_Class "SequenceCollection Class") object, from which a specific [sequence](https://docs.derivative.ca/Sequence_Class "Sequence Class") can be found.
