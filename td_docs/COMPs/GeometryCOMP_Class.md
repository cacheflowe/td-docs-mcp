...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Geometry COMP](https://docs.derivative.ca/Geometry_COMP "Geometry COMP").
...
Returns a named tuple consisting of (min, max, center, size). Each component in turn is another named tuple with (x, y, z).
  * display - (Keyword, Optional) If set to True, only [SOP](https://docs.derivative.ca/SOP_Class "SOP Class") and [POP](https://docs.derivative.ca/POP_Class "POP Class") operators whose[ display flag](https://docs.derivative.ca/Display_Flag "Display Flag") are turned on are included in the calculation. Furthermore, if the SOP or POP is contained within a child Geometry Component, that operator must have its display flag turned on as well.
  * render - (Keyword, Optional) If set to True, only [SOP](https://docs.derivative.ca/SOP_Class "SOP Class") and [POP](https://docs.derivative.ca/POP_Class "POP Class") operators whose[ render flag](https://docs.derivative.ca/Render_Flag "Render Flag") set are included in the calculation. Furthermore, if the SOP or POP is contained within a child Geometry Component, that operator must have its render flag set as well.
  * selected - (Keyword, Optional) If set to True, only child [components](https://docs.derivative.ca/COMP_Class "COMP Class") that are currently selected are included in the calculation.
...
Sets the Translate, Rotate, Scale and Pivot parameters on the Xform page from the given [matrix](https://docs.derivative.ca/Matrix_Class "Matrix Class").
...
Sets the Translate, Rotate, Scale and Pivot parameters on the Pre-Xform page from the given [matrix](https://docs.derivative.ca/Matrix_Class "Matrix Class").
  * matrix - A matrix of values.
...
Returns a matrix that is the transform from the called object to the target object. This is, if you transform the called objects current transformation by the returned matrix, it will now be positioned at the target objects positions.
  * target - The target [ObjectCOMP](https://docs.derivative.ca/ObjectCOMP_Class "ObjectCOMP Class"). See also [Matrix Class](https://docs.derivative.ca/Matrix_Class "Matrix Class"), [Position Class](https://docs.derivative.ca/Position_Class "Position Class") and [Vector Class](https://docs.derivative.ca/Vector_Class "Vector Class").
