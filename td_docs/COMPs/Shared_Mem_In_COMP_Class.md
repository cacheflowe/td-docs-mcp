---
url: https://docs.derivative.ca/SharedmeminCOMP_Class
category: COMPs
title: SharedmeminCOMP_Class
---

# sharedmeminCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Shared Mem In COMP](Shared_Mem_In_COMP.md "Shared Mem In COMP").
