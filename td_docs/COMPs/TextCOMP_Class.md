...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Text COMP](https://docs.derivative.ca/Text_COMP "Text COMP").
