---
url: https://docs.derivative.ca/ConstraintCOMP_Class
category: COMPs
title: ConstraintCOMP_Class
---

# constraintCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Constraint COMP](Constraint_COMP.md "Constraint COMP").
