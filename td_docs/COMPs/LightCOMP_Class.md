...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Light COMP](https://docs.derivative.ca/Light_COMP "Light COMP").
...
Returns the projection [matrix](https://docs.derivative.ca/Matrix_Class "Matrix Class") for the light's view, given the X and Y aspect. In general these would be set to the width and height of your render.
  * x - The horizontal aspect ratio.
  * y - The vertical aspect ratio.
