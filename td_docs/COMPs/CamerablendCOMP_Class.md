...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Camera Blend COMP](https://docs.derivative.ca/Camera_Blend_COMP "Camera Blend COMP").
