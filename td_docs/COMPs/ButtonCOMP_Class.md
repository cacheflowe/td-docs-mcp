...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Button COMP](https://docs.derivative.ca/Button_COMP "Button COMP").
