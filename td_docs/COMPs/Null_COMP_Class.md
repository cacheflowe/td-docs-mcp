---
url: https://docs.derivative.ca/NullCOMP_Class
category: COMPs
title: NullCOMP_Class
---

# nullCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Null COMP](Null_COMP.md "Null COMP").
