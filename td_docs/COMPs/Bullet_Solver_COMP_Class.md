...
This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Bullet Solver COMP](Bullet_Solver_COMP.md "Bullet Solver COMP").

## Members

`actors` → `list` **(Read Only)** :

Returns a list of all the [Actor COMPs](Actor_COMP.md "Actor COMP") in the Bullet Solver simulation.
