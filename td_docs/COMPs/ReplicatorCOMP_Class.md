...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Replicator COMP](https://docs.derivative.ca/Replicator_COMP "Replicator COMP").


## Members
`curItem` → `OP` **(Read Only)** :
Reference to the current [operator](https://docs.derivative.ca/Operator "Operator") replicant.
## Methods
