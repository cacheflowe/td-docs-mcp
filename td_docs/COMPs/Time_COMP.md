---
url: https://docs.derivative.ca/Time_COMP
category: COMPs
title: Time_COMP
---
...
The Time Component allows each component to have its own timeline (clock). The Time Component contains a network of operators that can drive a [Timeline](../Glossary/Timeline.md "Timeline"), drive animations in [Animation COMPs](../Glossary/Animation_COMP.md "Animation COMP"), or be used to drive any custom time-based system. The Time Component's parameters define the speed, range, various options for the time system.

The Time Component is often used in TouchDesigner to allow a component to have its own timeline / clock, this is called [Component Time](https://docs.derivative.ca/Component_Time "Component Time"). It is useful for holding some parts of your system stationary while others are allowed to play forward. A Time Component's location must be in the `/local` network of a [Component](../Glossary/Component.md "Component") for the Time Component to create a **Component Time**.
...
The Time Component's predefined network is [Cloned](../Glossary/Clone.md "Clone") from Master Component `/sys/local/time`. The Time Component's network can be modified if the path in the Clone parameter is removed.

[timeCOMP_Class](Time_COMP_Class.md "TimeCOMP Class")
...
Extra Information for the Time COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
