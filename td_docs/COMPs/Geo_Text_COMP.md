---
url: https://docs.derivative.ca/Geo_Text_COMP
category: COMPs
title: Geo_Text_COMP
---
...
The Geo Text COMP renders text in 3D. It does not read or generate a SOP as it does direct rendering using the [Slug Library](../Interoperability/Slug_Library.md "Slug Library") and can be lit and textured with any [MAT](../MATs/MAT.md "MAT") material.
...
See also the 2D equivalent [Text COMP](Text_COMP.md "Text COMP"). See [Text Formatting Codes](https://docs.derivative.ca/Text_Formatting_Codes "Text Formatting Codes") for ways to override settings per-character.
...
The Geo Text COMP is similar to the [Text COMP](Text_COMP.md "Text COMP") which is a 2D [Panel](../Glossary/Panel.md "Panel").

[geotextCOMP_Class](Geo_Text_COMP_Class.md "GeotextCOMP Class")
