...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Table COMP](https://docs.derivative.ca/Table_COMP "Table COMP").
...
Return the table row value, given a cell ID.
  * id - The cell id. Usually taken from [panel values](https://docs.derivative.ca/PanelValue_Class "PanelValue Class"): celloverid, cellfocusid, etc.
