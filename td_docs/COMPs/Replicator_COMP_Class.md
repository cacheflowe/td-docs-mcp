---
url: https://docs.derivative.ca/ReplicatorCOMP_Class
category: COMPs
title: ReplicatorCOMP_Class
---

# replicatorCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Replicator COMP](../Glossary/Replicator_COMP.md "Replicator COMP").

## Members

`curItem` → `OP` **(Read Only)** :

Reference to the current [operator](../General/Operator.md "Operator") replicant.
