...
Note that the effect of the Blend COMP is only visible through a [Camera COMP](../Glossary/Camera_COMP.md "Camera COMP") or the [Render TOP](../TOPs/Render_TOP.md "Render TOP") that is rendering that camera's view.

See also [Camera Blend COMP](Camera_Blend_COMP.md "Camera Blend COMP").

[blendCOMP_Class](Blend_COMP_Class.md "BlendCOMP Class")
...
Extra Information for the Blend COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
