...
The Geometry Component is a 3D surface or [3D Object](../Glossary/Object.md "Object") that you render in TouchDesigner with a [Render TOP](../TOPs/Render_TOP.md "Render TOP"). [Lights](../Glossary/Light_COMP.md "Light COMP"), [Cameras](../Glossary/Camera_COMP.md "Camera COMP") and other Components affect the scene, but are not visible surfaces.

Each Geometry Component contains a [Network](../Glossary/Network.md "Network") containing [POPs](../POPs/POP.md "POP") (and any other node types), where POPs are the operators that define its 3D shape. The 3D surfaces can be [polygons](../Glossary/Polygon.md "Polygon") (triangles and quadrelaterals), Point primitives used for point clouds and [particles](../POPs/Particle_POP.md "Particle POP"), Line Strips and 2-point Lines. Polygons can be shaded as solid-shaded surfaces or as wireframes.

In the Geometry COMP's network
  * the [POPs](../POPs/POP.md "POP") (Point Operators) whose [Render Flag](../Glossary/Render_Flag.md "Render Flag") is On are rendered by a [Render TOP](../TOPs/Render_TOP.md "Render TOP"). More than one POP can be turned on for rendering in a Geometry component.
  * The POPs whose [Display Flag](../Glossary/Display_Flag.md "Display Flag") is on are seen in the [Geometry Viewer](../Interoperability/Geometry_Viewer.md "Geometry Viewer") of the Geometry COMP and Camera COMPs in the same network.
...
See [Geometry Viewer](../Interoperability/Geometry_Viewer.md "Geometry Viewer"), [Render Flag](../Glossary/Render_Flag.md "Render Flag") and [Display Flag](../Glossary/Display_Flag.md "Display Flag")
...
[geometryCOMP_Class](Geometry_COMP_Class.md "GeometryCOMP Class")
...
- Color Mode `instancecolormode` - ⊞ - Controls how the instance color values interact with the SOPs ['Cd' (diffuse color)](../Glossary/Attribute.md "Attribute") attribute. If the SOP doesn't have a 'Cd' attribute, then it will behave as if its 'Cd' is (1, 1, 1, 1).
  * Replace `replace` -
  * Multiply `multiply` -
  * Add `add` -
  * Subtract `subtract` -
