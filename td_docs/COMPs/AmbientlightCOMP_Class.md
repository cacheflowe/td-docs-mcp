...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Ambient Light COMP](https://docs.derivative.ca/Ambient_Light_COMP "Ambient Light COMP").
