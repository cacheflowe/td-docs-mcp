---
url: https://docs.derivative.ca/GlslCOMP_Class
category: COMPs
title: GlslCOMP_Class
---

# glslCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [GLSL COMP](GLSL_COMP.md "GLSL COMP").
