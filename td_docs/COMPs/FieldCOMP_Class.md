...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Field COMP](https://docs.derivative.ca/Field_COMP "Field COMP").
