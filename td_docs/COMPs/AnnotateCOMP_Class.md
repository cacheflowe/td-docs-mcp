...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Annotate COMP](https://docs.derivative.ca/Annotate_COMP "Annotate COMP").
...
Can be overridden by `COMP.op(includeUtility=False)`, `COMP.ops(includeUtility=False)`, `COMP.findChildren(includeUtilty=False)` as well as the [OP Find DAT](https://docs.derivative.ca/OP_Find_DAT "OP Find DAT") filter: "Include Utility".
