...
[sharedmemoutCOMP_Class](Shared_Mem_Out_COMP_Class.md "SharedmemoutCOMP Class")
...
Extra Information for the Shared Mem Out COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
