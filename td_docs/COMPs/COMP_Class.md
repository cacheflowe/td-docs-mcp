...
A list of [operators](../Python/OP_Class.md "OP Class") contained within this operator. Only component operators have children, otherwise an empty list is returned.
