---
url: https://docs.derivative.ca/TableCOMP_Class
category: COMPs
title: TableCOMP_Class
---

# tableCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Table COMP](Table_COMP.md "Table COMP").
...
Return the table row value, given a cell ID.
  * id - The cell id. Usually taken from [panel values](../Python/PanelValue_Class.md "PanelValue Class"): celloverid, cellfocusid, etc.

`click(row, col, clickCount=1, force=False, left=False, middle=False, right=False)`→ `None`:
...
`clickID(id, clickCount=1, force=False, left=False, middle=False, right=False)`→ `None`:
