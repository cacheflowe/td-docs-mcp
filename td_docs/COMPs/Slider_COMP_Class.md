---
url: https://docs.derivative.ca/SliderCOMP_Class
category: COMPs
title: SliderCOMP_Class
---

# sliderCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Slider COMP](Slider_COMP.md "Slider COMP").
...
`click(uOrV, v, clickCount=1, force=False, left=False, middle=False, right=False, vOnly=False)`→ `None`:
