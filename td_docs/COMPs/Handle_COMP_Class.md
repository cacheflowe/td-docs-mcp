---
url: https://docs.derivative.ca/HandleCOMP_Class
category: COMPs
title: HandleCOMP_Class
---

# handleCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Handle COMP](Handle_COMP.md "Handle COMP").
