...
The Shared Mem In COMP will read transform data from a shared memory block. This memory block can be created by another Touch process using the [Shared Mem Out COMP](Shared_Mem_Out_COMP.md "Shared Mem Out COMP").

[sharedmeminCOMP_Class](Shared_Mem_In_COMP_Class.md "SharedmeminCOMP Class")
...
Extra Information for the Shared Mem In COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
