---
url: https://docs.derivative.ca/ParameterCOMP_Class
category: COMPs
title: ParameterCOMP_Class
---

# parameterCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Parameter COMP](Parameter_COMP.md "Parameter COMP").
