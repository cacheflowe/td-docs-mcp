---
url: https://docs.derivative.ca/Button_COMP
category: COMPs
title: Button_COMP
---
...
[buttonCOMP_Class](Button_COMP_Class.md "ButtonCOMP Class")
...
- Font Size `fontsize` - Set the size of the font. The font size is defined in resolution-independent panel units that will be rendered to a variable number of pixels depending on DPI settings of the output window (e.g. monitor scaling).
...
Extra Information for the Button COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
