...
[opviewerCOMP_Class](https://docs.derivative.ca/OpviewerCOMP_Class "OpviewerCOMP Class")
...
- Draw TOP Directly `topdirect` - When this is On for TOPs, you always see the RGBA image, as if this was simply a [Select TOP](https://docs.derivative.ca/Select_TOP "Select TOP"). Normally you see what the viewer is currently displaying, which for TOPs may have overlays and not be displaying RGB.
...
## Info CHOP Channels
Extra Information for the OP Viewer COMP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
