...
The Light Components are objects which cast light into a 3D scene. With the light parameters you can control the color, brightness, and atmosphere of geometry lit by the light. A scene can also be viewed through a light's perspective, similar to a [Camera COMP](../Glossary/Camera_COMP.md "Camera COMP").
...
[lightCOMP_Class](Light_COMP_Class.md "LightCOMP Class")
...
- Shadow Casters `shadowcasters` - The [Geometry COMPs](../Glossary/Geometry_COMP.md "Geometry COMP") that will cast shadows from this light.
