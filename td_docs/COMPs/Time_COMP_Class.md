---
url: https://docs.derivative.ca/TimeCOMP_Class
category: COMPs
title: TimeCOMP_Class
---

# timeCOMP Class

This class inherits from the [ COMP class](../Python/COMP_Class.md "COMP Class"). It references a specific [Time COMP](../Glossary/Time_COMP.md "Time COMP").
...
Get or set the current frame output by this component (expressed as `frame / end`).
