---
url: https://docs.derivative.ca/Constraint_COMP
category: COMPs
title: Constraint_COMP
---
...
See also: [Bullet Dynamics](../Interoperability/Bullet_Dynamics.md "Bullet Dynamics"), [Bullet Solver COMP](Bullet_Solver_COMP.md "Bullet Solver COMP"), [Actor COMP](Actor_COMP.md "Actor COMP"), [Force COMP](Force_COMP.md "Force COMP"), [Impulse Force COMP](Impulse_Force_COMP.md "Impulse Force COMP"), [Bullet Solver CHOP](../CHOPs/Bullet_Solver_CHOP.md "Bullet Solver CHOP").

[constraintCOMP_Class](Constraint_COMP_Class.md "ConstraintCOMP Class")
...
- Actor Bodies `bodies1` - A list (regular expression) of the IDs of the bodies in actor1 to constrain. If an Actor COMP contains N bodies, then body IDs will go from 0 to N-1 for that Actor COMP. The number of bodies can be verified using the [Bullet Solver CHOP](../CHOPs/Bullet_Solver_CHOP.md "Bullet Solver CHOP").
...
Extra Information for the Constraint COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
