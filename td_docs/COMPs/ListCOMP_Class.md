...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [List COMP](https://docs.derivative.ca/List_COMP "List COMP").


## Members
`attribs` → `td.ListAttribute` **(Read Only)** :
The table [attributes](https://docs.derivative.ca/ListAttribute_Class "ListAttribute Class"). The members of these attributes can be directly written to / updated with new values. Any row/col or cell attributes defined will override these values. Define global per-table attributes here.
...
The set of row [attributes](https://docs.derivative.ca/ListAttributes_Class "ListAttributes Class"). Accessed by row index. The members of these attributes can be directly written to / updated with new values and take priority over any attribute members defined a the table level.
...
The set of cell [attributes](https://docs.derivative.ca/ListAttributes_Class "ListAttributes Class"). Accessed by row and column. The members of these attributes can be directly written to / updated with new values and take priority over any attribute members defined at the row/col or table level.
