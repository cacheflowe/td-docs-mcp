...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Container COMP](https://docs.derivative.ca/Container_COMP "Container COMP").
