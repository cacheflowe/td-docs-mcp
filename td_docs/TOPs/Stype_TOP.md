---
url: https://docs.derivative.ca/Stype_TOP
category: TOPs
title: Stype_TOP
---
...
The Stype TOP works with [Stype](../Interoperability/Stype.md "Stype") (**RedSpy**) camera trackers to perform simulated lens distortion using channels from a connected CHOP.

**NOTE:** This CHOP works with [Stype](https://www.stype.tv) hardware. See also [Stype](../Interoperability/Stype.md "Stype") and [Stype CHOP](https://docs.derivative.ca/Stype_CHOP "Stype CHOP").

[stypeTOP_Class](Stype_TOP_Class.md "StypeTOP Class")
...
Extra Information for the Stype TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
