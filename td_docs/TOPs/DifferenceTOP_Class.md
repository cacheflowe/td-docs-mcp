---
url: https://docs.derivative.ca/DifferenceTOP_Class
category: TOPs
title: DifferenceTOP_Class
---

# differenceTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Difference TOP](https://docs.derivative.ca/Difference_TOP "Difference TOP").
