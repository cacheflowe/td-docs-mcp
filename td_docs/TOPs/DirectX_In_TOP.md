---
url: https://docs.derivative.ca/DirectX_In_TOP
category: TOPs
title: DirectX_In_TOP
---
...
See also: [DirectX Out TOP](DirectX_Out_TOP.md "DirectX Out TOP")

[directxinTOP_Class](DirectX_In_TOP_Class.md "DirectxinTOP Class")

## Parameters - DirectX In Page
- Handle `handle` - Specify the handle pointing to the DirectX texture. You can get the handle of any [DirectX Out TOP](DirectX_Out_TOP.md "DirectX Out TOP") texture by attaching an [Info DAT](../DATs/Info_DAT.md "Info DAT") to it. The `handle` is one of the columns. Other applications that support sharing texture will have their own way of getting a texture handle, please consult the application's documentation.
...
Extra Information for the DirectX In TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
