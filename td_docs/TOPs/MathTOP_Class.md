---
url: https://docs.derivative.ca/MathTOP_Class
category: TOPs
title: MathTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Math TOP](https://docs.derivative.ca/Math_TOP "Math TOP").
