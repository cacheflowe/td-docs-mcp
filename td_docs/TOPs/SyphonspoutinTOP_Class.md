---
url: https://docs.derivative.ca/SyphonspoutinTOP_Class
category: TOPs
title: SyphonspoutinTOP_Class
---

# syphonspoutinTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Syphon Spout In TOP](https://docs.derivative.ca/Syphon_Spout_In_TOP "Syphon Spout In TOP").
