---
url: https://docs.derivative.ca/SyphonspoutoutTOP_Class
category: TOPs
title: SyphonspoutoutTOP_Class
---

# syphonspoutoutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Syphon Spout Out TOP](https://docs.derivative.ca/Syphon_Spout_Out_TOP "Syphon Spout Out TOP").
