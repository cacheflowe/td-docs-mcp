---
url: https://docs.derivative.ca/NullTOP_Class
category: TOPs
title: NullTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Null TOP](https://docs.derivative.ca/Null_TOP "Null TOP").
