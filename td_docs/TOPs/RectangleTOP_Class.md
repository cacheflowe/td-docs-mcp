---
url: https://docs.derivative.ca/RectangleTOP_Class
category: TOPs
title: RectangleTOP_Class
---

# rectangleTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Rectangle TOP](https://docs.derivative.ca/Rectangle_TOP "Rectangle TOP").
