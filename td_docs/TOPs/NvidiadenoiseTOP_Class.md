---
url: https://docs.derivative.ca/NvidiadenoiseTOP_Class
category: TOPs
title: NvidiadenoiseTOP_Class
---

# nvidiadenoiseTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Nvidia Denoise TOP](https://docs.derivative.ca/Nvidia_Denoise_TOP "Nvidia Denoise TOP").
