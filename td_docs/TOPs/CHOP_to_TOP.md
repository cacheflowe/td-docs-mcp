---
url: https://docs.derivative.ca/CHOP_to_TOP
category: TOPs
title: CHOP_to_TOP
---
...
[choptoTOP_Class](CHOP_to_TOP_Class.md "ChoptoTOP Class")
...
Extra Information for the CHOP to TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
