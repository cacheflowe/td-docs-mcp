---
url: https://docs.derivative.ca/MosysTOP_Class
category: TOPs
title: MosysTOP_Class
---

# mosysTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [MoSys TOP](https://docs.derivative.ca/MoSys_TOP "MoSys TOP").
