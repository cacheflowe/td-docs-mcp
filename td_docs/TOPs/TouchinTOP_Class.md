---
url: https://docs.derivative.ca/TouchinTOP_Class
category: TOPs
title: TouchinTOP_Class
---

# touchinTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Touch In TOP](https://docs.derivative.ca/Touch_In_TOP "Touch In TOP").
