---
url: https://docs.derivative.ca/VideostreaminTOP_Class
category: TOPs
title: VideostreaminTOP_Class
---

# videostreaminTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Video Stream In TOP](https://docs.derivative.ca/Video_Stream_In_TOP "Video Stream In TOP").


## Members
`connectionsFailed` → `int` **(Read Only)** :
The number of times this operator has failed to make a connection to any URL.

`connectionsLost` → `int` **(Read Only)** :
