---
url: https://docs.derivative.ca/ThresholdTOP_Class
category: TOPs
title: ThresholdTOP_Class
---

# thresholdTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Threshold TOP](https://docs.derivative.ca/Threshold_TOP "Threshold TOP").
