---
url: https://docs.derivative.ca/OverTOP_Class
category: TOPs
title: OverTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Over TOP](https://docs.derivative.ca/Over_TOP "Over TOP").
