---
url: https://docs.derivative.ca/CrossTOP_Class
category: TOPs
title: CrossTOP_Class
---

# crossTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Cross TOP](https://docs.derivative.ca/Cross_TOP "Cross TOP").
