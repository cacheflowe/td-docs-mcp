---
url: https://docs.derivative.ca/PointfileselectTOP_Class
category: TOPs
title: PointfileselectTOP_Class
---

# pointfileselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Point File Select TOP](https://docs.derivative.ca/Point_File_Select_TOP "Point File Select TOP").
