---
url: https://docs.derivative.ca/Shared_Mem_Out_TOP
category: TOPs
title: Shared_Mem_Out_TOP
---
...
See [Using Shared Memory in TouchDesigner](https://docs.derivative.ca/Using_Shared_Memory_in_TouchDesigner "Using Shared Memory in TouchDesigner") and [Shared Mem In TOP](Shared_Mem_In_TOP.md "Shared Mem In TOP").

[sharedmemoutTOP_Class](Shared_Mem_Out_TOP_Class.md "SharedmemoutTOP Class")
...
- Download Type `downloadtype` - ⊞ - Select between Immediate(Slow) and Next Frame(Fast) for better performance.
...
Extra Information for the Shared Mem Out TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
