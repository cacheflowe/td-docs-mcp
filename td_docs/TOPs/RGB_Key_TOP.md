---
url: https://docs.derivative.ca/RGB_Key_TOP
category: TOPs
title: RGB_Key_TOP
---
...
[rgbkeyTOP_Class](RGB_Key_TOP_Class.md "RgbkeyTOP Class")
...
- Alpha Output `alphaout` - ⊞ - Determines the output of the Alpha channel from the RGB Key TOP.
...
Extra Information for the RGB Key TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
