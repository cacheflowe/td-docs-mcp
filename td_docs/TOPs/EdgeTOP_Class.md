---
url: https://docs.derivative.ca/EdgeTOP_Class
category: TOPs
title: EdgeTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Edge TOP](https://docs.derivative.ca/Edge_TOP "Edge TOP").
