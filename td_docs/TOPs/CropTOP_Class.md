---
url: https://docs.derivative.ca/CropTOP_Class
category: TOPs
title: CropTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Crop TOP](https://docs.derivative.ca/Crop_TOP "Crop TOP").
