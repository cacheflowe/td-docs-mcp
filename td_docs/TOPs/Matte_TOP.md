---
url: https://docs.derivative.ca/Matte_TOP
category: TOPs
title: Matte_TOP
---
...
[matteTOP_Class](Matte_TOP_Class.md "MatteTOP Class")
...
Extra Information for the Matte TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
