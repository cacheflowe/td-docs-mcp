---
url: https://docs.derivative.ca/NotchTOP_Class
category: TOPs
title: NotchTOP_Class
---

# notchTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Notch TOP](https://docs.derivative.ca/Notch_TOP "Notch TOP").


## Members
`exposedProperties` → `dict` **(Read Only)** :
Return a dictionary of key/value pairs representing all the exposed properties imported from the Notch block. The key is the UUID and the value is the corresponding [ParGroup](https://docs.derivative.ca/ParGroup "ParGroup") representation of the property.
## Methods
