---
url: https://docs.derivative.ca/FeedbackTOP_Class
category: TOPs
title: FeedbackTOP_Class
---

# feedbackTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Feedback TOP](https://docs.derivative.ca/Feedback_TOP "Feedback TOP").
