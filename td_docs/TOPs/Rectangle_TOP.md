...
[rectangleTOP_Class](Rectangle_TOP_Class.md "RectangleTOP Class")
...
Extra Information for the Rectangle TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
