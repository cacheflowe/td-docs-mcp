---
url: https://docs.derivative.ca/LayermixTOP_Class
category: TOPs
title: LayermixTOP_Class
---

# layermixTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Layer Mix TOP](https://docs.derivative.ca/Layer_Mix_TOP "Layer Mix TOP").
