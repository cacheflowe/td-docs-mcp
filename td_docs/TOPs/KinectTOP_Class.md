---
url: https://docs.derivative.ca/KinectTOP_Class
category: TOPs
title: KinectTOP_Class
---

# kinectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Kinect TOP](https://docs.derivative.ca/Kinect_TOP "Kinect TOP").
