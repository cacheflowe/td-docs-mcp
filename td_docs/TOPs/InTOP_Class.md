---
url: https://docs.derivative.ca/InTOP_Class
category: TOPs
title: InTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [In TOP](https://docs.derivative.ca/In_TOP "In TOP").
