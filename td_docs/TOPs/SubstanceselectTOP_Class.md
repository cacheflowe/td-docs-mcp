---
url: https://docs.derivative.ca/SubstanceselectTOP_Class
category: TOPs
title: SubstanceselectTOP_Class
---

# substanceselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Substance Select TOP](https://docs.derivative.ca/Substance_Select_TOP "Substance Select TOP").
