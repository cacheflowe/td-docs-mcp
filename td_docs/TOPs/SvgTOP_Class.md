---
url: https://docs.derivative.ca/SvgTOP_Class
category: TOPs
title: SvgTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [SVG TOP](https://docs.derivative.ca/SVG_TOP "SVG TOP").
