---
url: https://docs.derivative.ca/RenderpassTOP_Class
category: TOPs
title: RenderpassTOP_Class
---

# renderpassTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Render Pass TOP](https://docs.derivative.ca/Render_Pass_TOP "Render Pass TOP").
