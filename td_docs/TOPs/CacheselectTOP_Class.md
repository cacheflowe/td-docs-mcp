---
url: https://docs.derivative.ca/CacheselectTOP_Class
category: TOPs
title: CacheselectTOP_Class
---

# cacheselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Cache Select TOP](https://docs.derivative.ca/Cache_Select_TOP "Cache Select TOP").
