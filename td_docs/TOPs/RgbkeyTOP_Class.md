---
url: https://docs.derivative.ca/RgbkeyTOP_Class
category: TOPs
title: RgbkeyTOP_Class
---

# rgbkeyTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [RGB Key TOP](https://docs.derivative.ca/RGB_Key_TOP "RGB Key TOP").
