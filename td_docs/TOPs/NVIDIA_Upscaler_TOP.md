---
url: https://docs.derivative.ca/NVIDIA_Upscaler_TOP
category: TOPs
title: NVIDIA_Upscaler_TOP
---
...
[nvidiaupscalerTOP_Class](NVIDIA_Upscaler_TOP_Class.md "NvidiaupscalerTOP Class")
...
- Mode `mode` - ⊞ - Choose the mode (Upscale or Super-Resolution) and factor by which the resolution will increase.
  ...
  * Upscale 2 `upscale2` - Any resolution size.
  * Upscale 3 `upscale3` - Any resolution size.
  * Upscale 4 `upscale4` - Any resolution size.
  * Super Res 4/3 `superres4_3` - The video width and height must be multiples of 3. Videos must also have a width from 90-3840 pixels and height from 90-2160 pixels.
  * Super Res 3/2 `superres3_2` - The video width and height must be multiples of 2. Videos must also have a width from 90-3840 pixels and height from 90-2160 pixels.
  * Super Res 2 `superres2` - Videos must have a width from 90-3840 pixels and height from 90-2160 pixels.
  * Super Res 3 `superres3` - Videos must have a width from 90-1280 pixels and height from 90-720 pixels.
  * Super Res 4 `superres4` - Videos must have a width from 90-960 pixels and height from 90-540 pixels.
- Strength `strength` - Choose how much to enhance the input. Strength 0 implies no enhacement, only upscaling. Strength 1 implies the maximum enhancement. The default is 0.4.
