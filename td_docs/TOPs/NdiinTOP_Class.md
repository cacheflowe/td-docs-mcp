---
url: https://docs.derivative.ca/NdiinTOP_Class
category: TOPs
title: NdiinTOP_Class
---

# ndiinTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [NDI In TOP](https://docs.derivative.ca/NDI_In_TOP "NDI In TOP").
