...
See also the page on Movie File In TOP optimizations [Movie Playback](https://docs.derivative.ca/Movie_Playback "Movie Playback"), plus [Hap](../Interoperability/Hap.md "Hap"), [Movie File Out TOP](Movie_File_Out_TOP.md "Movie File Out TOP"), [Cineform](../Interoperability/GoPro_Cineform.md "GoPro Cineform") and [Video Stream In TOP](Video_Stream_In_TOP.md "Video Stream In TOP").

[moviefileinTOP_Class](Movie_File_In_TOP_Class.md "MoviefileinTOP Class")
