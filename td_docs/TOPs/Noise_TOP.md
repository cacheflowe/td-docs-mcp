...
**Note:** This TOP supports 3D Textures and 2D Texture Arrays. For this TOP to generate a 3D texture output, it requires a 3D texture type as input. You can use a [Texture 3D TOP](Texture_3D_TOP.md "Texture 3D TOP") or [GLSL TOP](GLSL_TOP.md "GLSL TOP") to create 3D texture types.

[noiseTOP_Class](Noise_TOP_Class.md "NoiseTOP Class")
...
Extra Information for the Noise TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
