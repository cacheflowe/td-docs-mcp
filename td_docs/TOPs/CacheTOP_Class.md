---
url: https://docs.derivative.ca/CacheTOP_Class
category: TOPs
title: CacheTOP_Class
---

# cacheTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Cache TOP](https://docs.derivative.ca/Cache_TOP "Cache TOP").
