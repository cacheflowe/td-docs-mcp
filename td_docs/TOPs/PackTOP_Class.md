---
url: https://docs.derivative.ca/PackTOP_Class
category: TOPs
title: PackTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Pack TOP](https://docs.derivative.ca/Pack_TOP "Pack TOP").
