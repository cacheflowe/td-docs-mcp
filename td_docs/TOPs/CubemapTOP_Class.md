---
url: https://docs.derivative.ca/CubemapTOP_Class
category: TOPs
title: CubemapTOP_Class
---

# cubemapTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Cube Map TOP](https://docs.derivative.ca/Cube_Map_TOP "Cube Map TOP").
