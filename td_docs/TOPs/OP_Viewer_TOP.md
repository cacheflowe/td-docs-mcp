---
url: https://docs.derivative.ca/OP_Viewer_TOP
category: TOPs
title: OP_Viewer_TOP
---
...
The OP Viewer TOP can display the [Node Viewer](../Glossary/Node_Viewer.md "Node Viewer") for any other operator as a TOP image. If the operator source is a [Panel Component](../Glossary/Panel_Component.md "Panel Component"), panel interaction through the TOP image is also supported.

[opviewerTOP_Class](OP_Viewer_TOP_Class.md "OpviewerTOP Class")
...
- Allow Panel Interaction `allowpanel` - This option is being deprecated. Please see [OP Viewer COMP](../COMPs/OP_Viewer_COMP.md "OP Viewer COMP") for its replacement.
...
Extra Information for the OP Viewer TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
