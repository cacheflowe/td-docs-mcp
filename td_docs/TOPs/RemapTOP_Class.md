---
url: https://docs.derivative.ca/RemapTOP_Class
category: TOPs
title: RemapTOP_Class
---

# remapTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Remap TOP](https://docs.derivative.ca/Remap_TOP "Remap TOP").
