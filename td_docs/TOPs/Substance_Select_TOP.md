---
url: https://docs.derivative.ca/Substance_Select_TOP
category: TOPs
title: Substance_Select_TOP
---
...
The Substance Select TOP allows you to select a single texture out of the [Substance TOP](Substance_TOP.md "Substance TOP") for further filtering and manipulation in TOPs.

[substanceselectTOP_Class](Substance_Select_TOP_Class.md "SubstanceselectTOP Class")

## Parameters - Setup Page
- Substance TOP `substance` - Reference a specific [Substance TOP](Substance_TOP.md "Substance TOP") from which to select a texture.
- Output Channel `output` - Choose which texture is being grabbed from the [Substance TOP](Substance_TOP.md "Substance TOP").
...
Extra Information for the Substance Select TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
