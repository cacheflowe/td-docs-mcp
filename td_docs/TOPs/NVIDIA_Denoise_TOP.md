---
url: https://docs.derivative.ca/NVIDIA_Denoise_TOP
category: TOPs
title: NVIDIA_Denoise_TOP
---
...
[nvidiadenoiseTOP_Class](NVIDIA_Denoise_TOP_Class.md "NvidiadenoiseTOP Class")
...
- Strength `strength` - ⊞ - Choose how much noise to remove from the image. Removing more noise may also remove original details from the source.
  * Low `low` -
  * High `high` -
...
Extra Information for the Nvidia Denoise TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
