---
url: https://docs.derivative.ca/AddTOP_Class
category: TOPs
title: AddTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Add TOP](https://docs.derivative.ca/Add_TOP "Add TOP").
