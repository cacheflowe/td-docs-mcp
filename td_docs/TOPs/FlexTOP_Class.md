---
url: https://docs.derivative.ca/FlexTOP_Class
category: TOPs
title: FlexTOP_Class
---

# nvidiaflexTOP Class
(Redirected from [FlexTOP Class](https://docs.derivative.ca/index.php?title=FlexTOP_Class&redirect=no "FlexTOP Class"))

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Nvidia Flex TOP](https://docs.derivative.ca/Nvidia_Flex_TOP "Nvidia Flex TOP").
