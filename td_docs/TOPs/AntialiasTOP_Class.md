---
url: https://docs.derivative.ca/AntialiasTOP_Class
category: TOPs
title: AntialiasTOP_Class
---

# antialiasTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Anti Alias TOP](https://docs.derivative.ca/Anti_Alias_TOP "Anti Alias TOP").
