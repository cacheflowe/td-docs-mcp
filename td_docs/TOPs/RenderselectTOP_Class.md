---
url: https://docs.derivative.ca/RenderselectTOP_Class
category: TOPs
title: RenderselectTOP_Class
---

# renderselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Render Select TOP](https://docs.derivative.ca/Render_Select_TOP "Render Select TOP").
