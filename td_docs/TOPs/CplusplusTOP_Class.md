---
url: https://docs.derivative.ca/CplusplusTOP_Class
category: TOPs
title: CplusplusTOP_Class
---

# cplusplusTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [CPlusPlus TOP](https://docs.derivative.ca/CPlusPlus_TOP "CPlusPlus TOP").
