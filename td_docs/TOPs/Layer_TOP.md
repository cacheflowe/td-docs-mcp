---
url: https://docs.derivative.ca/Layer_TOP
category: TOPs
title: Layer_TOP
---
...
[layerTOP_Class](https://docs.derivative.ca/LayerTOP_Class "LayerTOP Class")
...
- Layer Resolution `layerres` - ⊞ -
  * Layer Resolution `layerresw` -
  * Layer Resolution `layerresh` -

- Layer Color `layercolor` - ⊞ -
  * Layer Color `layercolorr` -
  * Layer Color `layercolorg` -
  * Layer Color `layercolorb` -

- Layer Alpha `layeralpha` -
- Enable Crop `enblcrop` -
...
## Info CHOP Channels
Extra Information for the Layer TOP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
