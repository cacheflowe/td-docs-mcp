---
url: https://docs.derivative.ca/OrbbecselectTOP_Class
category: TOPs
title: OrbbecselectTOP_Class
---

# orbbecselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Orbbec Select TOP](https://docs.derivative.ca/Orbbec_Select_TOP "Orbbec Select TOP").
