---
url: https://docs.derivative.ca/EmbossTOP_Class
category: TOPs
title: EmbossTOP_Class
---

# embossTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Emboss TOP](https://docs.derivative.ca/Emboss_TOP "Emboss TOP").
