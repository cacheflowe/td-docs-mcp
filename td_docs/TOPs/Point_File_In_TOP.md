---
url: https://docs.derivative.ca/Point_File_In_TOP
category: TOPs
title: Point_File_In_TOP
---
...
[pointfileinTOP_Class](Point_File_In_TOP_Class.md "PointfileinTOP Class")
...
- File `file` - The path and name of the point file to load. Point file formats are those found in [File Types](../Interoperability/File_Types.md "File Types"). You can specify files on the internet using `http://` ...
...
Extra Information for the Point File In TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
