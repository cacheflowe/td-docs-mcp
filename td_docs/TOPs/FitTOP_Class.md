---
url: https://docs.derivative.ca/FitTOP_Class
category: TOPs
title: FitTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Fit TOP](https://docs.derivative.ca/Fit_TOP "Fit TOP").
