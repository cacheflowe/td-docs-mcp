---
url: https://docs.derivative.ca/DepthTOP_Class
category: TOPs
title: DepthTOP_Class
---

# depthTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Depth TOP](https://docs.derivative.ca/Depth_TOP "Depth TOP").
