---
url: https://docs.derivative.ca/NormalmapTOP_Class
category: TOPs
title: NormalmapTOP_Class
---

# normalmapTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Normal Map TOP](https://docs.derivative.ca/Normal_Map_TOP "Normal Map TOP").
