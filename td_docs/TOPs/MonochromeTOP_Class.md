---
url: https://docs.derivative.ca/MonochromeTOP_Class
category: TOPs
title: MonochromeTOP_Class
---

# monochromeTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Monochrome TOP](https://docs.derivative.ca/Monochrome_TOP "Monochrome TOP").
