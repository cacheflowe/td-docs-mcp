...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Ramp TOP](https://docs.derivative.ca/Ramp_TOP "Ramp TOP").
