---
url: https://docs.derivative.ca/OpencolorioTOP_Class
category: TOPs
title: OpencolorioTOP_Class
---

# opencolorioTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [OpenColorIO TOP](https://docs.derivative.ca/OpenColorIO_TOP "OpenColorIO TOP").
