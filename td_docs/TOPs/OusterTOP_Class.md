---
url: https://docs.derivative.ca/OusterTOP_Class
category: TOPs
title: OusterTOP_Class
---

# ousterTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Ouster TOP](https://docs.derivative.ca/Ouster_TOP "Ouster TOP").
