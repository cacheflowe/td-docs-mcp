---
url: https://docs.derivative.ca/LayerTOP_Class
category: TOPs
title: LayerTOP_Class
---

# layerTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Layer TOP](https://docs.derivative.ca/Layer_TOP "Layer TOP").
