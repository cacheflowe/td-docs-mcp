---
url: https://docs.derivative.ca/MirrorTOP_Class
category: TOPs
title: MirrorTOP_Class
---

# mirrorTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Mirror TOP](https://docs.derivative.ca/Mirror_TOP "Mirror TOP").
