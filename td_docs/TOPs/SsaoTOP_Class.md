---
url: https://docs.derivative.ca/SsaoTOP_Class
category: TOPs
title: SsaoTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [SSAO TOP](https://docs.derivative.ca/SSAO_TOP "SSAO TOP").
