---
url: https://docs.derivative.ca/Crop_TOP
category: TOPs
title: Crop_TOP
---
...
[cropTOP_Class](Crop_TOP_Class.md "CropTOP Class")
...
Extra Information for the Crop TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
