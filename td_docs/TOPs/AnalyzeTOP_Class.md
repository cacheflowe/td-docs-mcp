---
url: https://docs.derivative.ca/AnalyzeTOP_Class
category: TOPs
title: AnalyzeTOP_Class
---

# analyzeTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Analyze TOP](https://docs.derivative.ca/Analyze_TOP "Analyze TOP").
