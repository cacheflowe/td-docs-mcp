---
url: https://docs.derivative.ca/MatteTOP_Class
category: TOPs
title: MatteTOP_Class
---

# matteTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Matte TOP](https://docs.derivative.ca/Matte_TOP "Matte TOP").
