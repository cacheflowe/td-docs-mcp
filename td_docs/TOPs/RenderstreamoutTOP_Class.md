---
url: https://docs.derivative.ca/RenderstreamoutTOP_Class
category: TOPs
title: RenderstreamoutTOP_Class
---

# renderstreamoutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [RenderStream Out TOP](https://docs.derivative.ca/RenderStream_Out_TOP "RenderStream Out TOP").
...
## Methods
`sendLog(str)`→ `None`:
Sends a Log message to D3.

`sendStatusMessage(str)`→ `None`:
Sends a Status message to D3.
#  TOP Class
## Members
`width` → `int` **(Read Only)** :
