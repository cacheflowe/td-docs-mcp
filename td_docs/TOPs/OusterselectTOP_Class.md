---
url: https://docs.derivative.ca/OusterselectTOP_Class
category: TOPs
title: OusterselectTOP_Class
---

# ousterselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Ouster Select TOP](https://docs.derivative.ca/Ouster_Select_TOP "Ouster Select TOP").
