---
url: https://docs.derivative.ca/POP_to_TOP
category: TOPs
title: POP_to_TOP
---
...
**Tip** : Pixel Layout menu set to Use POP Dimension: Much more automated and streamlined however, if the input POP has points arranged as rows and columns, and you change the Layout menu to be POP Dimension, then it uses its POP [Dimension](../Glossary/Dimension.md "Dimension") to set the width and height of the image. If there are three or more dimensions, it will create a 3D texture type of TOP.

See also [TOP to POP](../POPs/TOP_to_POP.md "TOP to POP"), [Dimension](../Glossary/Dimension.md "Dimension"), [POP to CHOP](../CHOPs/POP_to_CHOP.md "POP to CHOP"), [CHOP to POP](../POPs/CHOP_to_POP.md "CHOP to POP"), [POP to DAT](../DATs/POP_to_DAT.md "POP to DAT")

[poptoTOP_Class](POP_to_TOP_Class.md "PoptoTOP Class")
...
- Extra Pixel Values (RGBA) `rgba` - ⊞ -
  * Extra Pixel Values (RGBA) `rgba1` -
  * Extra Pixel Values (RGBA) `rgba2` -
  * Extra Pixel Values (RGBA) `rgba3` -
...
Extra Information for the POP to TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
