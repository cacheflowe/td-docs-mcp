---
url: https://docs.derivative.ca/Luma_Level_TOP
category: TOPs
title: Luma_Level_TOP
---
...
The Luma Level TOP adjusts image brightness, gamma, black level, quantization, opacity and more. It has similar parameters to the [Level TOP](Level_TOP.md "Level TOP"), but it maintains the hue and saturation more accurately when you use Gamma and Black Level.
...
[lumalevelTOP_Class](Luma_Level_TOP_Class.md "LumalevelTOP Class")
...
Lookup is the lookup table build by the parameter settings in the TOP.
  * Luminance `luminance` - Adjusts the luminance values of the image.
  * Red `red` - Adjusts the red channel of the image.
  * Green `green` - Adjusts the green channel of the image.
  * Blue `blue` - Adjusts the blue channel of the image.
  * Alpha `alpha` - Adjusts the alpha channel of the image.
  * RGB Average `rgbaverage` - Adjusts the combined RGB average of the image.
  * RGBA Average `average` - Adjusts the combined RGBA average of the image.
...
## Info CHOP Channels
Extra Information for the Luma Level TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
###
