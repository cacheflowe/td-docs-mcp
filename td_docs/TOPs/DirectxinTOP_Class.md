---
url: https://docs.derivative.ca/DirectxinTOP_Class
category: TOPs
title: DirectxinTOP_Class
---

# directxinTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [DirectX In TOP](https://docs.derivative.ca/DirectX_In_TOP "DirectX In TOP").
