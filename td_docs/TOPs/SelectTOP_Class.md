---
url: https://docs.derivative.ca/SelectTOP_Class
category: TOPs
title: SelectTOP_Class
---

# selectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Select TOP](https://docs.derivative.ca/Select_TOP "Select TOP").
