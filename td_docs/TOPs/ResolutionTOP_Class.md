---
url: https://docs.derivative.ca/ResolutionTOP_Class
category: TOPs
title: ResolutionTOP_Class
---

# resolutionTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Resolution TOP](https://docs.derivative.ca/Resolution_TOP "Resolution TOP").
