---
url: https://docs.derivative.ca/MpcdiTOP_Class
category: TOPs
title: MpcdiTOP_Class
---

# mpcdiTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [MPCDI TOP](https://docs.derivative.ca/MPCDI_TOP "MPCDI TOP").
