...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Kinect Azure Select TOP](Kinect_Azure_Select_TOP.md "Kinect Azure Select TOP").
