---
url: https://docs.derivative.ca/FlowTOP_Class
category: TOPs
title: FlowTOP_Class
---

# nvidiaflowTOP Class
(Redirected from [FlowTOP Class](https://docs.derivative.ca/index.php?title=FlowTOP_Class&redirect=no "FlowTOP Class"))

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Nvidia Flow TOP](https://docs.derivative.ca/Nvidia_Flow_TOP "Nvidia Flow TOP").
