---
url: https://docs.derivative.ca/RenderStream_In_TOP
category: TOPs
title: RenderStream_In_TOP
---
...
This node brings in image data sent over the [RenderStream](https://docs.derivative.ca/RenderStream "RenderStream") protocol from [Disguise](https://www.disguise.one/en/products/renderstream/). The actual setup and sync of the RenderStream connection is done with the [RenderStream In CHOP](../CHOPs/RenderStream_In_CHOP.md "RenderStream In CHOP").

See also [RenderStream In CHOP](../CHOPs/RenderStream_In_CHOP.md "RenderStream In CHOP"), [RenderStream Out TOP](RenderStream_Out_TOP.md "RenderStream Out TOP"), [RenderStream](https://docs.derivative.ca/RenderStream "RenderStream").

[renderstreaminTOP_Class](RenderStream_In_TOP_Class.md "RenderstreaminTOP Class")
...
Extra Information for the RenderStream In TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
