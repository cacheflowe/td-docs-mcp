---
url: https://docs.derivative.ca/DirectdisplayoutTOP_Class
category: TOPs
title: DirectdisplayoutTOP_Class
---

# directdisplayoutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Direct Display Out TOP](https://docs.derivative.ca/Direct_Display_Out_TOP "Direct Display Out TOP").
