---
url: https://docs.derivative.ca/SharedmemoutTOP_Class
category: TOPs
title: SharedmemoutTOP_Class
---

# sharedmemoutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Shared Mem Out TOP](https://docs.derivative.ca/Shared_Mem_Out_TOP "Shared Mem Out TOP").
