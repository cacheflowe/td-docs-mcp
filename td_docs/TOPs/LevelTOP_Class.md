---
url: https://docs.derivative.ca/LevelTOP_Class
category: TOPs
title: LevelTOP_Class
---

# levelTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Level TOP](https://docs.derivative.ca/Level_TOP "Level TOP").
