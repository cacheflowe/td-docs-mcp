---
url: https://docs.derivative.ca/RenderTOP_Class
category: TOPs
title: RenderTOP_Class
---

# renderTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Render TOP](https://docs.derivative.ca/Render_TOP "Render TOP").
