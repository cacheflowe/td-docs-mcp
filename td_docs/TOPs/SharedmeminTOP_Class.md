---
url: https://docs.derivative.ca/SharedmeminTOP_Class
category: TOPs
title: SharedmeminTOP_Class
---

# sharedmeminTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Shared Mem In TOP](https://docs.derivative.ca/Shared_Mem_In_TOP "Shared Mem In TOP").
