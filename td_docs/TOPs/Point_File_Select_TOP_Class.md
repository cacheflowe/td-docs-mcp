...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Point File Select TOP](Point_File_Select_TOP.md "Point File Select TOP").
