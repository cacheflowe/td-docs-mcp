---
url: https://docs.derivative.ca/CircleTOP_Class
category: TOPs
title: CircleTOP_Class
---

# circleTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Circle TOP](https://docs.derivative.ca/Circle_TOP "Circle TOP").
