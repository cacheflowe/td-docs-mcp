---
url: https://docs.derivative.ca/OutTOP_Class
category: TOPs
title: OutTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Out TOP](https://docs.derivative.ca/Out_TOP "Out TOP").
