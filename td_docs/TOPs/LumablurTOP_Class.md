---
url: https://docs.derivative.ca/LumablurTOP_Class
category: TOPs
title: LumablurTOP_Class
---

# lumablurTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Luma Blur TOP](https://docs.derivative.ca/Luma_Blur_TOP "Luma Blur TOP").
