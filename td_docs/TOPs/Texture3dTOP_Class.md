---
url: https://docs.derivative.ca/Texture3dTOP_Class
category: TOPs
title: Texture3dTOP_Class
---

# texture3dTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Texture 3D TOP](https://docs.derivative.ca/Texture_3D_TOP "Texture 3D TOP").
