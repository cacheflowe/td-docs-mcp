---
url: https://docs.derivative.ca/NoiseTOP_Class
category: TOPs
title: NoiseTOP_Class
---

# noiseTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Noise TOP](https://docs.derivative.ca/Noise_TOP "Noise TOP").
