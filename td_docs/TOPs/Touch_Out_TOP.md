---
url: https://docs.derivative.ca/Touch_Out_TOP
category: TOPs
title: Touch_Out_TOP
---
...
It can output [Hap Q](../Interoperability/Hap.md "Hap"), Hap Q Alpha, and Uncompressed video.

Make sure Windows Firewall settings are set to UNBLOCK for TouchDesigner, otherwise the data will be blocked.

See also [Touch In TOP](Touch_In_TOP.md "Touch In TOP").
...
[touchoutTOP_Class](Touch_Out_TOP_Class.md "TouchoutTOP Class")
...
- Video Codec `videocodec` - ⊞ - Choose between Uncompressed and HAP Q codecs to transmit the image stream.
...
Extra Information for the Touch Out TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
