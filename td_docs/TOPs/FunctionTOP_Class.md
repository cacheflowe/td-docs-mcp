---
url: https://docs.derivative.ca/FunctionTOP_Class
category: TOPs
title: FunctionTOP_Class
---

# functionTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Function TOP](https://docs.derivative.ca/Function_TOP "Function TOP").
