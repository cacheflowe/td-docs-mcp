---
url: https://docs.derivative.ca/SubtractTOP_Class
category: TOPs
title: SubtractTOP_Class
---

# subtractTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Subtract TOP](https://docs.derivative.ca/Subtract_TOP "Subtract TOP").
