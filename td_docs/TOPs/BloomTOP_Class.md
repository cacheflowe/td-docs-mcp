---
url: https://docs.derivative.ca/BloomTOP_Class
category: TOPs
title: BloomTOP_Class
---

# bloomTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Bloom TOP](https://docs.derivative.ca/Bloom_TOP "Bloom TOP").
