---
url: https://docs.derivative.ca/Multiply_TOP
category: TOPs
title: Multiply_TOP
---
...
The Multiply TOP performs a multiply operation on Input1 and Input2.
**Note:** This TOP supports 3D Textures and 2D Texture Arrays.
[multiplyTOP_Class](https://docs.derivative.ca/MultiplyTOP_Class "MultiplyTOP Class")
...
## Info CHOP Channels
Extra Information for the Multiply TOP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
