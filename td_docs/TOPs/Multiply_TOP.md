...
[multiplyTOP_Class](Multiply_TOP_Class.md "MultiplyTOP Class")
...
Extra Information for the Multiply TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
