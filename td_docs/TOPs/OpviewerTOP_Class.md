---
url: https://docs.derivative.ca/OpviewerTOP_Class
category: TOPs
title: OpviewerTOP_Class
---

# opviewerTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [OP Viewer TOP](https://docs.derivative.ca/OP_Viewer_TOP "OP Viewer TOP").
