---
url: https://docs.derivative.ca/MultiplyTOP_Class
category: TOPs
title: MultiplyTOP_Class
---

# multiplyTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Multiply TOP](https://docs.derivative.ca/Multiply_TOP "Multiply TOP").
