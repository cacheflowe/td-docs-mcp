---
url: https://docs.derivative.ca/Script_TOP
category: TOPs
title: Script_TOP
---
...
The [Script CHOP](../CHOPs/Script_CHOP.md "Script CHOP") enables numPy arrays to be converted into the CHOP's channels. Also any CHOP can get its channels converted into numPy arrays. (May 2021)

See `numPyArray()` in [TOP Class](TOP_Class.md "TOP Class")., [Script DAT](../DATs/Script_DAT.md "Script DAT").

See also [Script CHOP](../CHOPs/Script_CHOP.md "Script CHOP"), [Script SOP](../SOPs/Script_SOP.md "Script SOP")

**Note:** This TOP supports 3D Textures and 2D Texture Arrays.

[scriptTOP_Class](Script_TOP_Class.md "ScriptTOP Class")
...
Extra Information for the Script TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
