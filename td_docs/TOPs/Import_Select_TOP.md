...
The Import Select TOP loads the texture map images such as Color Map, Normal Map, Metallic Map and so forth that are defined in [FBX COMP](../COMPs/FBX_COMP.md "FBX COMP") or [USD COMP](../COMPs/USD_COMP.md "USD COMP"). The image binaries can be encoded within the importing file (e.g. .usdz format) or specified as an external asset with an valid path.

See also: [FBX COMP](../COMPs/FBX_COMP.md "FBX COMP"), [USD COMP](../COMPs/USD_COMP.md "USD COMP")

[importselectTOP_Class](Import_Select_TOP_Class.md "ImportselectTOP Class")
...
Extra Information for the Import Select TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
