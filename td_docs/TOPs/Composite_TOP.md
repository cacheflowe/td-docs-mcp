...
**Note:** See also the [blendModes component](https://docs.derivative.ca/Palette:blendModes "Palette:blendModes") in the Palette. Refer also to [OP Snippets](../Learn/OP_Snippets.md "OP Snippets").

**Note:** This TOP supports 3D Textures and 2D Texture Arrays.

[compositeTOP_Class](Composite_TOP_Class.md "CompositeTOP Class")
...
Extra Information for the Composite TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
