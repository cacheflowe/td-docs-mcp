---
url: https://docs.derivative.ca/Ouster_Select_TOP
category: TOPs
title: Ouster_Select_TOP
---
...
The Ouster Select TOP can be used to create additional output images from sensor data collected by an [Ouster TOP](Ouster_TOP.md "Ouster TOP"). Each output image contains 4 channels of 32bit floating point data encoded into the red, green, blue and alpha channels of the image. Available sensor data channels include: Range, Signal, Reflectivity, Near IR, and Flags as well as 3D XYZ position values. Raw range data is measured in millimeters, while XYZ positions are calculated using a table of beam azimuth and altitude angles and then converted to meters.

See also: [Ouster TOP](Ouster_TOP.md "Ouster TOP")

[ousterselectTOP_Class](Ouster_Select_TOP_Class.md "OusterselectTOP Class")

## Parameters - Ouster Page
- Ouster TOP `oustertop` - A link to the [Ouster TOP](Ouster_TOP.md "Ouster TOP") that is receiving data from the sensor.
...
Extra Information for the Ouster Select TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
