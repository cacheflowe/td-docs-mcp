...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Text TOP](Text_TOP.md "Text TOP").
...
Returns a list of [TextLine Class](../Python/TextLine_Class.md "TextLine Class") objects. This list of lines is formed after operations such as word-wrap have been applied.
