...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Stype TOP](Stype_TOP.md "Stype TOP").

## Members

`timecode` → `tdu.Timecode` **(Read Only)** :

Get a Timecode object for the timecode data representation of the last timestamped Stype packet. See [Timecode Class](Timecode_Class.md "Timecode Class")
