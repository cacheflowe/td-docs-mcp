...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Nvidia Background TOP](https://docs.derivative.ca/Nvidia_Background_TOP "Nvidia Background TOP").
