---
url: https://docs.derivative.ca/LumalevelTOP_Class
category: TOPs
title: LumalevelTOP_Class
---

# lumalevelTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Luma Level TOP](https://docs.derivative.ca/Luma_Level_TOP "Luma Level TOP").
