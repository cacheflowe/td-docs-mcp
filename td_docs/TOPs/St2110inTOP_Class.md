---
url: https://docs.derivative.ca/St2110inTOP_Class
category: TOPs
title: St2110inTOP_Class
---

# st2110inTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [ST2110 In TOP](https://docs.derivative.ca/ST2110_In_TOP "ST2110 In TOP").


## Members
`inputSignalFormat` → `str | None` **(Read Only)** :
