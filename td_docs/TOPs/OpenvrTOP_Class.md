---
url: https://docs.derivative.ca/OpenvrTOP_Class
category: TOPs
title: OpenvrTOP_Class
---

# openvrTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [OpenVR TOP](https://docs.derivative.ca/OpenVR_TOP "OpenVR TOP").
