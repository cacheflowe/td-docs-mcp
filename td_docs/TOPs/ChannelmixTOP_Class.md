---
url: https://docs.derivative.ca/ChannelmixTOP_Class
category: TOPs
title: ChannelmixTOP_Class
---

# channelmixTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Channel Mix TOP](https://docs.derivative.ca/Channel_Mix_TOP "Channel Mix TOP").
