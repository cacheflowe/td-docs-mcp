---
url: https://docs.derivative.ca/ConstantTOP_Class
category: TOPs
title: ConstantTOP_Class
---

# constantTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Constant TOP](https://docs.derivative.ca/Constant_TOP "Constant TOP").
