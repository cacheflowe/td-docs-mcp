---
url: https://docs.derivative.ca/NcamTOP_Class
category: TOPs
title: NcamTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Ncam TOP](https://docs.derivative.ca/Ncam_TOP "Ncam TOP").
