...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Nvidia Upscaler TOP](https://docs.derivative.ca/Nvidia_Upscaler_TOP "Nvidia Upscaler TOP").
