---
url: https://docs.derivative.ca/SlopeTOP_Class
category: TOPs
title: SlopeTOP_Class
---

# slopeTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Slope TOP](https://docs.derivative.ca/Slope_TOP "Slope TOP").
