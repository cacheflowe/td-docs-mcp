---
url: https://docs.derivative.ca/NvidiabackgroundTOP_Class
category: TOPs
title: NvidiabackgroundTOP_Class
---

# nvidiabackgroundTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Nvidia Background TOP](https://docs.derivative.ca/Nvidia_Background_TOP "Nvidia Background TOP").
