---
url: https://docs.derivative.ca/SpectrumTOP_Class
category: TOPs
title: SpectrumTOP_Class
---

# spectrumTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Spectrum TOP](https://docs.derivative.ca/Spectrum_TOP "Spectrum TOP").
