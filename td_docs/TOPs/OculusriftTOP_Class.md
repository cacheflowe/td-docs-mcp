---
url: https://docs.derivative.ca/OculusriftTOP_Class
category: TOPs
title: OculusriftTOP_Class
---

# oculusriftTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Oculus Rift TOP](https://docs.derivative.ca/Oculus_Rift_TOP "Oculus Rift TOP").
