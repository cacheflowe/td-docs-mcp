---
url: https://docs.derivative.ca/OakselectTOP_Class
category: TOPs
title: OakselectTOP_Class
---

# oakselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [OAK Select TOP](https://docs.derivative.ca/OAK_Select_TOP "OAK Select TOP").
