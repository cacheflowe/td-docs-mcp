---
url: https://docs.derivative.ca/LensdistortTOP_Class
category: TOPs
title: LensdistortTOP_Class
---

# lensdistortTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Lens Distort TOP](https://docs.derivative.ca/Lens_Distort_TOP "Lens Distort TOP").
