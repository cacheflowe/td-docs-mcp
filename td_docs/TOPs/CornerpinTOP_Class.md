---
url: https://docs.derivative.ca/CornerpinTOP_Class
category: TOPs
title: CornerpinTOP_Class
---

# cornerpinTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Corner Pin TOP](https://docs.derivative.ca/Corner_Pin_TOP "Corner Pin TOP").
