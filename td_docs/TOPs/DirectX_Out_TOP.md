...
See also: [DirectX In TOP](DirectX_In_TOP.md "DirectX In TOP")

[directxoutTOP_Class](DirectX_Out_TOP_Class.md "DirectxoutTOP Class")

## Parameters - DirectX Out Page
- Active `active` - Enable or disable DirectX output.
- Queue Size `queuesize` - Number of DirectX textures created. These textures are updated in a cycle, 1 per frame. Use an [Info DAT](../DATs/Info_DAT.md "Info DAT") to inspect the list of textures.
...
Extra Information for the DirectX Out TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
