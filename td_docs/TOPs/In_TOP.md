---
url: https://docs.derivative.ca/In_TOP
category: TOPs
title: In_TOP
---
...
[inTOP_Class](In_TOP_Class.md "InTOP Class")
...
Extra Information for the In TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
