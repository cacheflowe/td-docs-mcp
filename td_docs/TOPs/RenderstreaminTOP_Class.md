---
url: https://docs.derivative.ca/RenderstreaminTOP_Class
category: TOPs
title: RenderstreaminTOP_Class
---

# renderstreaminTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [RenderStream In TOP](https://docs.derivative.ca/RenderStream_In_TOP "RenderStream In TOP").
