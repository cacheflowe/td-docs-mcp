---
url: https://docs.derivative.ca/ImportselectTOP_Class
category: TOPs
title: ImportselectTOP_Class
---

# importselectTOP Class
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Import Select TOP](https://docs.derivative.ca/Import_Select_TOP "Import Select TOP").
