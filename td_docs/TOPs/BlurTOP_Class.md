---
url: https://docs.derivative.ca/BlurTOP_Class
category: TOPs
title: BlurTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Blur TOP](https://docs.derivative.ca/Blur_TOP "Blur TOP").
