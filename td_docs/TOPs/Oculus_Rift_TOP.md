---
url: https://docs.derivative.ca/Oculus_Rift_TOP
category: TOPs
title: Oculus_Rift_TOP
---
...
[oculusriftTOP_Class](Oculus_Rift_TOP_Class.md "OculusriftTOP Class")
...
- Debug HUD `debugperfhud` - ⊞ - Select what will be displayed in the debug HUD in the headset.
  ...
  * Latency Timing `latency` - The debug HUD will display latency timing info.
...
Extra Information for the Oculus Rift TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
