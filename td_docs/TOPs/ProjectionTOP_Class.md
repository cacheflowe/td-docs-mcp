---
url: https://docs.derivative.ca/ProjectionTOP_Class
category: TOPs
title: ProjectionTOP_Class
---

# projectionTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Projection TOP](https://docs.derivative.ca/Projection_TOP "Projection TOP").
