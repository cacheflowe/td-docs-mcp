---
url: https://docs.derivative.ca/ZedselectTOP_Class
category: TOPs
title: ZedselectTOP_Class
---

# zedselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [ZED Select TOP](https://docs.derivative.ca/ZED_Select_TOP "ZED Select TOP").
