...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Web Render TOP](Web_Render_TOP.md "Web Render TOP").
...
Send key characters to the webpage.
  * key - ASCII value or name of a character or key. Key name matches the names from the [Keyboard In DAT](../DATs/Keyboard_In_DAT.md "Keyboard In DAT").
