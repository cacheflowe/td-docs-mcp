---
url: https://docs.derivative.ca/RealsenseTOP_Class
category: TOPs
title: RealsenseTOP_Class
---

# realsenseTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [RealSense TOP](https://docs.derivative.ca/RealSense_TOP "RealSense TOP").
