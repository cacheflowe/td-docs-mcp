---
url: https://docs.derivative.ca/OpticalflowTOP_Class
category: TOPs
title: OpticalflowTOP_Class
---

# opticalflowTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Optical Flow TOP](https://docs.derivative.ca/Optical_Flow_TOP "Optical Flow TOP").
