---
url: https://docs.derivative.ca/TransformTOP_Class
category: TOPs
title: TransformTOP_Class
---

# transformTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Transform TOP](https://docs.derivative.ca/Transform_TOP "Transform TOP").
