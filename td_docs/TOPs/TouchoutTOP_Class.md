---
url: https://docs.derivative.ca/TouchoutTOP_Class
category: TOPs
title: TouchoutTOP_Class
---

# touchoutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Touch Out TOP](https://docs.derivative.ca/Touch_Out_TOP "Touch Out TOP").
