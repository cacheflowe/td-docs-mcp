---
url: https://docs.derivative.ca/ChoptoTOP_Class
category: TOPs
title: ChoptoTOP_Class
---

# choptoTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [CHOP to TOP](https://docs.derivative.ca/CHOP_to_TOP "CHOP to TOP").
