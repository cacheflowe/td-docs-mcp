---
url: https://docs.derivative.ca/GlslTOP_Class
category: TOPs
title: GlslTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [GLSL TOP](https://docs.derivative.ca/GLSL_TOP "GLSL TOP").
