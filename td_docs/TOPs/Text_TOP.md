...
- Display Method `dispmethod` - ⊞ - The display method used.
  ...
  * Scalable `scalable` - Uses [Slug Library](https://docs.derivative.ca/Slug_Library "Slug Library") to render high-quality, scalable, resolution independent text.
...
## Info CHOP Channels
Extra Information for the Text TOP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
