...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Nvidia Denoise TOP](https://docs.derivative.ca/Nvidia_Denoise_TOP "Nvidia Denoise TOP").
