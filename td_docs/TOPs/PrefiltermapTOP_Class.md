---
url: https://docs.derivative.ca/PrefiltermapTOP_Class
category: TOPs
title: PrefiltermapTOP_Class
---

# prefiltermapTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [PreFilter Map TOP](https://docs.derivative.ca/PreFilter_Map_TOP "PreFilter Map TOP").
