---
url: https://docs.derivative.ca/ScreengrabTOP_Class
category: TOPs
title: ScreengrabTOP_Class
---

# screengrabTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Screen Grab TOP](https://docs.derivative.ca/Screen_Grab_TOP "Screen Grab TOP").
