---
url: https://docs.derivative.ca/LayoutTOP_Class
category: TOPs
title: LayoutTOP_Class
---

# layoutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Layout TOP](https://docs.derivative.ca/Layout_TOP "Layout TOP").
