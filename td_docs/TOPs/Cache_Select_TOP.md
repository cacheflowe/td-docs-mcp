---
url: https://docs.derivative.ca/Cache_Select_TOP
category: TOPs
title: Cache_Select_TOP
---
...
The Cache Select TOP grabs an image from a [Cache TOP](Cache_TOP.md "Cache TOP") based on the index parameter. This gives direct, random access to any image stored in a Cache TOP.The Cache Select TOP grabs an image from a [Cache TOP](Cache_TOP.md "Cache TOP") based on the index parameter. This gives direct, random access to any image stored in a Cache TOP.

[cacheselectTOP_Class](Cache_Select_TOP_Class.md "CacheselectTOP Class")
...
Extra Information for the Cache Select TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
