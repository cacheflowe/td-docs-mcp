---
url: https://docs.derivative.ca/Point_Transform_TOP
category: TOPs
title: Point_Transform_TOP
---
...
Transformations can be defined directly on the Transform page, taken from an input CHOP (see [Transform CHOP](../CHOPs/Transform_CHOP.md "Transform CHOP")), using the Look At parameter, or as a combination of any of those methods.
...
[pointtransformTOP_Class](Point_Transform_TOP_Class.md "PointtransformTOP Class")
...
- Forward Direction `forwarddir` - ⊞ - Sets which axis and direction is considered the forward direction.
  ...
  * +Z `posz` -
  * -Z `negz` -
- Transform CHOP `chopinput` - Path to a CHOP node with channels describing a 3D transformation. These channels may come from a [Transform CHOP](../CHOPs/Transform_CHOP.md "Transform CHOP") or another CHOP with the correct channels defined.
...
Extra Information for the Point Transform TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
