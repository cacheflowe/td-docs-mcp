---
url: https://docs.derivative.ca/SubstanceTOP_Class
category: TOPs
title: SubstanceTOP_Class
---

# substanceTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Substance TOP](https://docs.derivative.ca/Substance_TOP "Substance TOP").
