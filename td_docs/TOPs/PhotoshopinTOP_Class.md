---
url: https://docs.derivative.ca/PhotoshopinTOP_Class
category: TOPs
title: PhotoshopinTOP_Class
---

# photoshopinTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Photoshop In TOP](https://docs.derivative.ca/Photoshop_In_TOP "Photoshop In TOP").
...
`isReceivingUpdates` → `bool` **(Read Only)** :
