---
url: https://docs.derivative.ca/SickTOP_Class
category: TOPs
title: SickTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [SICK TOP](https://docs.derivative.ca/SICK_TOP "SICK TOP").
