---
url: https://docs.derivative.ca/TileTOP_Class
category: TOPs
title: TileTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Tile TOP](https://docs.derivative.ca/Tile_TOP "Tile TOP").
