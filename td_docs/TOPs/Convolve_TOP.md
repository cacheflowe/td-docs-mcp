---
url: https://docs.derivative.ca/Convolve_TOP
category: TOPs
title: Convolve_TOP
---
...
[convolveTOP_Class](Convolve_TOP_Class.md "ConvolveTOP Class")
...
- Offset `offset` - After the convolution, this value will be added to the R, G and B of the pixel (and A if enabled).
- Scale `scale` - After the convolution, this value will be multiplied to the sum of the RGB(A) of the pixel and the offset.
...
Extra Information for the Convolve TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
