---
url: https://docs.derivative.ca/ScreenTOP_Class
category: TOPs
title: ScreenTOP_Class
---

# screenTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Screen TOP](https://docs.derivative.ca/Screen_TOP "Screen TOP").
