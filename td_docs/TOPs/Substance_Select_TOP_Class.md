...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Substance Select TOP](Substance_Select_TOP.md "Substance Select TOP").
