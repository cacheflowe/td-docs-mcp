---
url: https://docs.derivative.ca/PreFilter_Map_TOP
category: TOPs
title: PreFilter_Map_TOP
---
...
The PreFilter TOP uses spherical harmonics to calculate a Pre-Filtered Diffuse Map or Pre-Filtered Specular Map for use in the [Environment Light COMP](../COMPs/Environment_Light_COMP.md "Environment Light COMP"). The output of the PreFilter Map TOP can not have further processing done to them before being used by the Environment Light.

[prefiltermapTOP_Class](PreFilter_Map_TOP_Class.md "PrefiltermapTOP Class")
...
Extra Information for the PreFilter Map TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
