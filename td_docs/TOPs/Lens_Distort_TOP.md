...
Distortion values for a camera lens can be determined using [OpenCV calibration routines](https://docs.opencv.org/master/dc/dbb/tutorial_py_calibration.html) or through functions for a particular camera (see [kinectazureTOP class](Kinect_Azure_TOP_Class.md "KinectazureTOP Class")).
...
[lensdistortTOP_Class](Lens_Distort_TOP_Class.md "LensdistortTOP Class")
