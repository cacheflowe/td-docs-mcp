---
url: https://docs.derivative.ca/VideodeviceoutTOP_Class
category: TOPs
title: VideodeviceoutTOP_Class
---

# videodeviceoutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Video Device Out TOP](https://docs.derivative.ca/Video_Device_Out_TOP "Video Device Out TOP").
