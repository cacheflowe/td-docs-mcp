---
url: https://docs.derivative.ca/UnderTOP_Class
category: TOPs
title: UnderTOP_Class
---

# underTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Under TOP](https://docs.derivative.ca/Under_TOP "Under TOP").
