...
[renderpassTOP_Class](Render_Pass_TOP_Class.md "RenderpassTOP Class")
...
- Camera `camera` - Specifies which [Cameras](../Glossary/Camera_COMP.md "Camera COMP") to look through when rendering the scene.
