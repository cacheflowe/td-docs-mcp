---
url: https://docs.derivative.ca/OutsideTOP_Class
category: TOPs
title: OutsideTOP_Class
---

# outsideTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Outside TOP](https://docs.derivative.ca/Outside_TOP "Outside TOP").
