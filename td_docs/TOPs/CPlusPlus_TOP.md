---
url: https://docs.derivative.ca/CPlusPlus_TOP
category: TOPs
title: CPlusPlus_TOP
---
...
See also: [CPlusPlus CHOP](../CHOPs/CPlusPlus_CHOP.md "CPlusPlus CHOP"), [CUDA](../Interoperability/CUDA.md "CUDA")

[cplusplusTOP_Class](CPlusPlus_TOP_Class.md "CplusplusTOP Class")
...
- Anti-Alias `antialias` - ⊞ - The level of anti-aliasing you want the framebuffer that will be created for you to have.
  ...
  * 16x `aa16` -
  * 32x `aa32` -
- Depth Buffer `depthbuffer` - ⊞ - Specifies the pixel format of the depth buffer you want, if any.
  * None `none` -
...
Extra Information for the CPlusPlus TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
