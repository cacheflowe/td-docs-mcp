---
url: https://docs.derivative.ca/ReorderTOP_Class
category: TOPs
title: ReorderTOP_Class
---

# reorderTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Reorder TOP](https://docs.derivative.ca/Reorder_TOP "Reorder TOP").
