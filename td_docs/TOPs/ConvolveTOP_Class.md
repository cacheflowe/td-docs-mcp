---
url: https://docs.derivative.ca/ConvolveTOP_Class
category: TOPs
title: ConvolveTOP_Class
---

# convolveTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Convolve TOP](https://docs.derivative.ca/Convolve_TOP "Convolve TOP").
