---
url: https://docs.derivative.ca/Render_Select_TOP
category: TOPs
title: Render_Select_TOP
---
...
The Render Select TOP allows you to select one of the color buffers from any [Render TOP](Render_TOP.md "Render TOP").

[renderselectTOP_Class](Render_Select_TOP_Class.md "RenderselectTOP Class")

## Parameters - Render Select Page
- TOP `top` - Specify the TOP to use as a source. Currently [Render TOP](Render_TOP.md "Render TOP"), [GLSL TOP](GLSL_TOP.md "GLSL TOP") and [CPlusPlus TOPs](CPlusPlus_TOP.md "CPlusPlus TOP") are valid TOPs to select from.
...
- Image Output `imageoutput` - Accesses the Image Output of the [Render TOP](Render_TOP.md "Render TOP"). Image Output must be enabled on the GLSL page of the Render TOP.
...
Extra Information for the Render Select TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
