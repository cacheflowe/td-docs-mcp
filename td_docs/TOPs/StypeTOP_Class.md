---
url: https://docs.derivative.ca/StypeTOP_Class
category: TOPs
title: StypeTOP_Class
---

# stypeTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Stype TOP](https://docs.derivative.ca/Stype_TOP "Stype TOP").
