---
url: https://docs.derivative.ca/VideostreamoutTOP_Class
category: TOPs
title: VideostreamoutTOP_Class
---

# videostreamoutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Video Stream Out TOP](https://docs.derivative.ca/Video_Stream_Out_TOP "Video Stream Out TOP").


## Members
`streamURL` → `str` **(Read Only)** :
