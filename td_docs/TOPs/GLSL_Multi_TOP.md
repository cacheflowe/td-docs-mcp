---
url: https://docs.derivative.ca/GLSL_Multi_TOP
category: TOPs
title: GLSL_Multi_TOP
---
...
The GLSL Multi TOP renders a GLSL shader into a TOP image. Its parameters and functionality are identical to the [GLSL TOP](GLSL_TOP.md "GLSL TOP"), except it allows for more than 3 inputs.

Refer to the [GLSL TOP](GLSL_TOP.md "GLSL TOP") help page for more information.

[glslmultiTOP_Class](GLSL_Multi_TOP_Class.md "GlslmultiTOP Class")
...
- Atomic Counter `ac` - Sequence of atomic counter uniforms. See [Atomic Counters](https://docs.derivative.ca/Write_a_GLSL_TOP#Atomic_Counters "Write a GLSL TOP").
...
Extra Information for the GLSL Multi TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
