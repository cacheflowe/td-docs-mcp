---
url: https://docs.derivative.ca/ChromakeyTOP_Class
category: TOPs
title: ChromakeyTOP_Class
---

# chromakeyTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Chroma Key TOP](https://docs.derivative.ca/Chroma_Key_TOP "Chroma Key TOP").
