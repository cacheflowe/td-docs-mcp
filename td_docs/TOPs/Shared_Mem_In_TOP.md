...
See [Using Shared Memory in TouchDesigner](https://docs.derivative.ca/Using_Shared_Memory_in_TouchDesigner "Using Shared Memory in TouchDesigner") and [Shared Mem Out TOP](Shared_Mem_Out_TOP.md "Shared Mem Out TOP").

[sharedmeminTOP_Class](Shared_Mem_In_TOP_Class.md "SharedmeminTOP Class")
...
Extra Information for the Shared Mem In TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
