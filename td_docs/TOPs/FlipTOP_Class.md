---
url: https://docs.derivative.ca/FlipTOP_Class
category: TOPs
title: FlipTOP_Class
---
...
This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Flip TOP](https://docs.derivative.ca/Flip_TOP "Flip TOP").
