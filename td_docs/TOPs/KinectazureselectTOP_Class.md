---
url: https://docs.derivative.ca/KinectazureselectTOP_Class
category: TOPs
title: KinectazureselectTOP_Class
---

# kinectazureselectTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Kinect Azure Select TOP](https://docs.derivative.ca/Kinect_Azure_Select_TOP "Kinect Azure Select TOP").
