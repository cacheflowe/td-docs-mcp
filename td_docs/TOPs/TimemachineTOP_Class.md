---
url: https://docs.derivative.ca/TimemachineTOP_Class
category: TOPs
title: TimemachineTOP_Class
---

# timemachineTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Time Machine TOP](https://docs.derivative.ca/Time_Machine_TOP "Time Machine TOP").
