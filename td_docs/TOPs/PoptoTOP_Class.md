---
url: https://docs.derivative.ca/PoptoTOP_Class
category: TOPs
title: PoptoTOP_Class
---

# poptoTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [POP to TOP](https://docs.derivative.ca/POP_to_TOP "POP to TOP").
