---
url: https://docs.derivative.ca/ZED_Select_TOP
category: TOPs
title: ZED_Select_TOP
---
...
This TOP is used to select extra images from the device configured in the [ZED TOP](ZED_TOP.md "ZED TOP"). Such as the depth, color image, disparity map etc.

[zedselectTOP_Class](ZED_Select_TOP_Class.md "ZedselectTOP Class")

## Parameters - ZED Select Page
- Active `active` - Controls whether this TOP is retrieving image data from the device. The primary [ZED TOP](ZED_TOP.md "ZED TOP") must also be active to receive data.
- ZED TOP `zedtop` - The name of the primary [ZED TOP](ZED_TOP.md "ZED TOP") that is configuring the camera. The primary TOP controls which camera the select TOP receives data from.
