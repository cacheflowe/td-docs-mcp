...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Video Stream Out TOP](Video_Stream_Out_TOP.md "Video Stream Out TOP").
