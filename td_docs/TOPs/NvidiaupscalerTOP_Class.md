---
url: https://docs.derivative.ca/NvidiaupscalerTOP_Class
category: TOPs
title: NvidiaupscalerTOP_Class
---

# nvidiaupscalerTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Nvidia Upscaler TOP](https://docs.derivative.ca/Nvidia_Upscaler_TOP "Nvidia Upscaler TOP").
