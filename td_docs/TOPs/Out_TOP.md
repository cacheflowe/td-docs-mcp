---
url: https://docs.derivative.ca/Out_TOP
category: TOPs
title: Out_TOP
---
...
[outTOP_Class](Out_TOP_Class.md "OutTOP Class")
...
Extra Information for the Out TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
