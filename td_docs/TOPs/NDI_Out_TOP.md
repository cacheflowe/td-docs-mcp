...
The NDI Out TOP will send image and audio data over IP to other [Newtek NDI® (Network Data Interface)](../Interoperability/NDI.md "NDI") enabled applications. The [NDI®](../Interoperability/NDI.md "NDI") protocol is created by [Newtek](http://www.newtek.com/ndi/applications/).

See also [NDI](../Interoperability/NDI.md "NDI"), [NDI In TOP](NDI_In_TOP.md "NDI In TOP") and [NDI DAT](../DATs/NDI_DAT.md "NDI DAT").

**NOTE for Windows OS - If experiencing connection issues make sure Windows Firewall is disabled.**

[ndioutTOP_Class](NDI_Out_TOP_Class.md "NdioutTOP Class")
...
- Audio CHOP `audiochop` - Specify the [CHOP](../Glossary/CHOP.md "CHOP") (containing audio data) to send out on the NDI stream.
- Metadata DAT `metadata` - Specify the [DAT](../Glossary/DAT.md "DAT") (containing the metadata in table format **or** valid XML format) to send out on the NDI stream. The metadata can be read in by the [NDI In TOP](NDI_In_TOP.md "NDI In TOP") using an Info DAT.
...
Extra Information for the NDI Out TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
