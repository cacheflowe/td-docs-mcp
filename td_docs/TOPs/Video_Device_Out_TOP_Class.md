...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [Video Device Out TOP](Video_Device_Out_TOP.md "Video Device Out TOP").
