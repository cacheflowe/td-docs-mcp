---
url: https://docs.derivative.ca/LeapmotionTOP_Class
category: TOPs
title: LeapmotionTOP_Class
---

# leapmotionTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Leap Motion TOP](https://docs.derivative.ca/Leap_Motion_TOP "Leap Motion TOP").
