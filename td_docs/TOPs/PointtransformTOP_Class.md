---
url: https://docs.derivative.ca/PointtransformTOP_Class
category: TOPs
title: PointtransformTOP_Class
---

# pointtransformTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Point Transform TOP](https://docs.derivative.ca/Point_Transform_TOP "Point Transform TOP").
