---
url: https://docs.derivative.ca/CompositeTOP_Class
category: TOPs
title: CompositeTOP_Class
---

# compositeTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Composite TOP](https://docs.derivative.ca/Composite_TOP "Composite TOP").
