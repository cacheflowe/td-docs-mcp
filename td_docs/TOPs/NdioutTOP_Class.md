---
url: https://docs.derivative.ca/NdioutTOP_Class
category: TOPs
title: NdioutTOP_Class
---

# ndioutTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [NDI Out TOP](https://docs.derivative.ca/NDI_Out_TOP "NDI Out TOP").
