---
url: https://docs.derivative.ca/Point_File_Select_TOP
category: TOPs
title: Point_File_Select_TOP
---
...
The Point File Select TOP allows you to create additional output images from a point file loaded into a [Point File In TOP](Point_File_In_TOP.md "Point File In TOP"). This TOP is useful if your point data file has more than 4 channels e.g. XYZ position and RGB colors. It is more efficient to use a Point File Select TOP rather than a second [Point File In TOP](Point_File_In_TOP.md "Point File In TOP") since the file will only be loaded once.

[pointfileselectTOP_Class](Point_File_Select_TOP_Class.md "PointfileselectTOP Class")

## Parameters - Point File Select Page
- Point File In TOP `pointfileintop` - A link to the [Point File In TOP](Point_File_In_TOP.md "Point File In TOP") that contains the original point file data.
...
Extra Information for the Point File Select TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
