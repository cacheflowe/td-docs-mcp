---
url: https://docs.derivative.ca/RendersimpleTOP_Class
category: TOPs
title: RendersimpleTOP_Class
---

# rendersimpleTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Render Simple TOP](https://docs.derivative.ca/Render_Simple_TOP "Render Simple TOP").
