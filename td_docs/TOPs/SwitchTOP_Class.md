---
url: https://docs.derivative.ca/SwitchTOP_Class
category: TOPs
title: SwitchTOP_Class
---

# switchTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Switch TOP](https://docs.derivative.ca/Switch_TOP "Switch TOP").
