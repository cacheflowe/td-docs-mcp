---
url: https://docs.derivative.ca/GlslmultiTOP_Class
category: TOPs
title: GlslmultiTOP_Class
---

# glslmultiTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [GLSL Multi TOP](https://docs.derivative.ca/GLSL_Multi_TOP "GLSL Multi TOP").
