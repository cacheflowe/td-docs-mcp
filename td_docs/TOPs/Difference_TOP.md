...
[differenceTOP_Class](Difference_TOP_Class.md "DifferenceTOP Class")
...
Extra Information for the Difference TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
