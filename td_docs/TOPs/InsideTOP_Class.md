---
url: https://docs.derivative.ca/InsideTOP_Class
category: TOPs
title: InsideTOP_Class
---

# insideTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Inside TOP](https://docs.derivative.ca/Inside_TOP "Inside TOP").
