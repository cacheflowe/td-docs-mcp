...
This class inherits from the [ TOP class](TOP_Class.md "TOP Class"). It references a specific [RenderStream Out TOP](RenderStream_Out_TOP.md "RenderStream Out TOP").
