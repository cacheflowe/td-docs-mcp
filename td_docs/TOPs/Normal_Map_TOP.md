---
url: https://docs.derivative.ca/Normal_Map_TOP
category: TOPs
title: Normal_Map_TOP
---
...
The Normal Map TOP takes an input image and creates a normal map by finding edges in the image. This can then be used for bump mapping (See [Phong MAT](../MATs/Phong_MAT.md "Phong MAT") and [PBR MAT](../MATs/PBR_MAT.md "PBR MAT")).

See also [Normal Mapping](https://docs.derivative.ca/Normal_Mapping "Normal Mapping").

[normalmapTOP_Class](Normal_Map_TOP_Class.md "NormalmapTOP Class")
...
Extra Information for the Normal Map TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
