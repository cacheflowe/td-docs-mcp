---
url: https://docs.derivative.ca/LimitTOP_Class
category: TOPs
title: LimitTOP_Class
---

# limitTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Limit TOP](https://docs.derivative.ca/Limit_TOP "Limit TOP").
