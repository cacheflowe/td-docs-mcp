---
url: https://docs.derivative.ca/TonemapTOP_Class
category: TOPs
title: TonemapTOP_Class
---

# tonemapTOP Class

This class inherits from the [ TOP class](https://docs.derivative.ca/TOP_Class "TOP Class"). It references a specific [Tone Map TOP](https://docs.derivative.ca/Tone_Map_TOP "Tone Map TOP").
