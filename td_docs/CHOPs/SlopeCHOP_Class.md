...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Slope CHOP](https://docs.derivative.ca/Slope_CHOP "Slope CHOP").
