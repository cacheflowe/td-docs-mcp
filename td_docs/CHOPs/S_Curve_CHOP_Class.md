---
url: https://docs.derivative.ca/ScurveCHOP_Class
category: CHOPs
title: ScurveCHOP_Class
---

# scurveCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [S Curve CHOP](S_Curve_CHOP.md "S Curve CHOP").
