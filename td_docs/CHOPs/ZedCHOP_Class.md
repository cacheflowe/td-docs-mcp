...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [ZED CHOP](https://docs.derivative.ca/ZED_CHOP "ZED CHOP").
