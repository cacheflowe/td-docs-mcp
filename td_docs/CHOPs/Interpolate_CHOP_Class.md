---
url: https://docs.derivative.ca/InterpolateCHOP_Class
category: CHOPs
title: InterpolateCHOP_Class
---

# interpolateCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Interpolate CHOP](Interpolate_CHOP.md "Interpolate CHOP").
