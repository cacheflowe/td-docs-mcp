...
CHOPs are an [Operator Family](../Glossary/Operator_Family.md "Operator Family") which operate on [Channels](../Glossary/Channel.md "Channel") (a sequence of numbers ([Samples](../Glossary/Sample.md "Sample"))).
...
A CHOP creates or modifies the [Channel](../Glossary/Channel.md "Channel"), and then passes the channels on to the next CHOP in a network. CHOPs are then connected to object motion or any other animated part of TouchDesigner via "[exporting](../Glossary/Export.md "Export")" and "channel references".

See also [Category:CHOPs](https://docs.derivative.ca/Category:CHOPs "Category:CHOPs") for a full list of articles related to CHOPs, especially [Anatomy of a CHOP](https://docs.derivative.ca/Anatomy_of_a_CHOP "Anatomy of a CHOP") and [Time Slicing](../Glossary/Time_Slicing.md "Time Slicing").
...
[Select](../Glossary/Select_CHOP.md "Select CHOP") | Grab a channel from any other CHOP. |  [Switch](Switch_CHOP.md "Switch CHOP"), [Cross](Cross_CHOP.md "Cross CHOP")
...
[Lag](../Glossary/Lag_CHOP.md "Lag CHOP") | Smooth and delay a channel. |  [Filter](../Glossary/Filter_CHOP.md "Filter CHOP")
[Speed](../Glossary/Speed_CHOP.md "Speed CHOP") | Use speed to calculate distance. |  [Count](Count_CHOP.md "Count CHOP"), [Slope](Slope_CHOP.md "Slope CHOP")
...
[OSC In](../Interoperability/OSC_In_CHOP.md "OSC In CHOP") | Open Sound Control, MIDI. |  [MIDI In Map](MIDI_In_Map_CHOP.md "MIDI In Map CHOP")
...
Each CHOP has **flags** :
  * The Display flag marks the CHOP to be displayed in a [CHOP Viewer](../Glossary/CHOP_Viewer.md "CHOP Viewer").
  * The Export flag causes the CHOP channel [exports](../Glossary/Export.md "Export") to toggle on and off.
  * The Lock flag causes the CHOP to be locked and then can be hand-edited.
  * The [Bypass Flag](../Glossary/Bypass_Flag.md "Bypass Flag") is a convenient way for a CHOP's effect to be disabled.
...
Each CHOP receives channels at its inputs. When the CHOP [cooks](../Glossary/Cook.md "Cook"), the channels of the inputs are combined. The CHOP outputs the resulting channels to other CHOPs.
...
##  Referencing and Exporting CHOP Channels     _Main article:[Export](../Glossary/Export.md "Export")_
...
Introduction to CHOPs | [Uses of CHOPs](https://docs.derivative.ca/Uses_of_CHOPs "Uses of CHOPs") |  [Exporting from CHOPs to Parameters](../Glossary/Export.md "Export")
---|---|---
...
[The Idea of Time Slicing](../Glossary/Time_Slicing.md "Time Slicing") | [Exporting Channels](../Glossary/Export.md "Export") |  [CHOP Operator Variables](https://docs.derivative.ca/Variables "Variables")
[CHOP File Formats](../Interoperability/File_Types.md "File Types") | [Tscript Expressions](../Glossary/Expression.md "Expression") |  [Category:MIDI](https://docs.derivative.ca/index.php?title=Category:MIDI&action=edit&redlink=1 "Category:MIDI \(page does not exist\)") and [OSC](https://docs.derivative.ca/OSC "OSC")
