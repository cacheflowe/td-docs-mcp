---
url: https://docs.derivative.ca/KinectCHOP_Class
category: CHOPs
title: KinectCHOP_Class
---

# kinectCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Kinect CHOP](Kinect_CHOP.md "Kinect CHOP").
