...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Filter CHOP](https://docs.derivative.ca/Filter_CHOP "Filter CHOP").
