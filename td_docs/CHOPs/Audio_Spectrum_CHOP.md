---
url: https://docs.derivative.ca/Audio_Spectrum_CHOP
category: CHOPs
title: Audio_Spectrum_CHOP
---
...
See [Audio Filter CHOP](Audio_Filter_CHOP.md "Audio Filter CHOP"), [Audio Para EQ CHOP](Audio_Para_EQ_CHOP.md "Audio Para EQ CHOP"), [Audio Band EQ CHOP](Audio_Band_EQ_CHOP.md "Audio Band EQ CHOP"), [Audio Oscillator CHOP](Audio_Oscillator_CHOP.md "Audio Oscillator CHOP") set to White Noise.

[audiospectrumCHOP_Class](Audio_Spectrum_CHOP_Class.md "AudiospectrumCHOP Class")
...
An [Info CHOP](Info_CHOP.md "Info CHOP") can be attached and the channel `hz_per_sample` can be viewed. Applicable only of the Frequency axis is set to Linear. With it set to output to normal FFT, to determine the frequency that a given sample represents, use the formula:
...
Extra Information for the Audio Spectrum CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
