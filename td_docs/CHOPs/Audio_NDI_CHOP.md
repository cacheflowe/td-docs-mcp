---
url: https://docs.derivative.ca/Audio_NDI_CHOP
category: CHOPs
title: Audio_NDI_CHOP
---
...
Retrieves the audio from a [NDI In TOP](../TOPs/NDI_In_TOP.md "NDI In TOP")'s NDI stream. The audio signal can then be modified or output via CHOPs. See [NDI](../Interoperability/NDI.md "NDI").

[audiondiCHOP_Class](Audio_NDI_CHOP_Class.md "AudiondiCHOP Class")

## Parameters - "NDI Audio" Page
- Play `play` - When 'On' the audio will playback, when 'Off' the channels will not output an audio signal.
- NDI In TOP `ndiintop` - Specify which [NDI In TOP](../TOPs/NDI_In_TOP.md "NDI In TOP")'s NDI stream to get the audio from.
...
Extra Information for the Audio NDI CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
