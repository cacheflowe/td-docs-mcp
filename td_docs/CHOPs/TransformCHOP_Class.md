...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Transform CHOP](https://docs.derivative.ca/Transform_CHOP "Transform CHOP").
