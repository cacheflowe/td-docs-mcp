...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Merge CHOP](https://docs.derivative.ca/Merge_CHOP "Merge CHOP").
