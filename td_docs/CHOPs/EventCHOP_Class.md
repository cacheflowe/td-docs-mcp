...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Event CHOP](https://docs.derivative.ca/Event_CHOP "Event CHOP").
