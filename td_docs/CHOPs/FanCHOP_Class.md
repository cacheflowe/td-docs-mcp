...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Fan CHOP](https://docs.derivative.ca/Fan_CHOP "Fan CHOP").
