---
url: https://docs.derivative.ca/Merge_CHOP
category: CHOPs
title: Merge_CHOP
---
...
[mergeCHOP_Class](Merge_CHOP_Class.md "MergeCHOP Class")
...
Extra Information for the Merge CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
