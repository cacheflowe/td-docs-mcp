---
url: https://docs.derivative.ca/BulletsolverCHOP_Class
category: CHOPs
title: BulletsolverCHOP_Class
---

# bulletsolverCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Bullet Solver CHOP](Bullet_Solver_CHOP.md "Bullet Solver CHOP").
