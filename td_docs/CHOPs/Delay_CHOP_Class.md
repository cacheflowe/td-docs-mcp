---
url: https://docs.derivative.ca/DelayCHOP_Class
category: CHOPs
title: DelayCHOP_Class
---

# delayCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Delay CHOP](Delay_CHOP.md "Delay CHOP").
