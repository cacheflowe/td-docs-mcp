---
url: https://docs.derivative.ca/InversekinCHOP_Class
category: CHOPs
title: InversekinCHOP_Class
---

# inversekinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Inverse Kin CHOP](Inverse_Kin_CHOP.md "Inverse Kin CHOP").
