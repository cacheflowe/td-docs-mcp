...
It is often used to [Export](../Glossary/Export.md "Export") channels to parameters, which allows you to experiment with the CHOPs that feed into the Null without having to un-export from one CHOP and re-export from another.
...
[nullCHOP_Class](Null_CHOP_Class.md "NullCHOP Class")

## Parameters - Null Page
- Cook Type `cooktype` - ⊞ - This controls how nodes downstream from the Null CHOP are triggered for recooking when the Null CHOP output changes. See also: [Cook](../Glossary/Cook.md "Cook")
...
Extra Information for the Null CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
