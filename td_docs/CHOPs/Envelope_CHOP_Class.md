---
url: https://docs.derivative.ca/EnvelopeCHOP_Class
category: CHOPs
title: EnvelopeCHOP_Class
---

# envelopeCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Envelope CHOP](Envelope_CHOP.md "Envelope CHOP").
