---
url: https://docs.derivative.ca/FreeD_In_CHOP
category: CHOPs
title: FreeD_In_CHOP
---
...
For more information or to diagnose connection problems, an [Info CHOP](Info_CHOP.md "Info CHOP") can be connected to see if any packets have been dropped, skipped, or filtered out.

[freedCHOP_Class](FreedCHOP_Class.md "FreedCHOP Class")
...
Extra Information for the FreeD CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
