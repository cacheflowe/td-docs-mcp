---
url: https://docs.derivative.ca/BeatCHOP_Class
category: CHOPs
title: BeatCHOP_Class
---

# beatCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Beat CHOP](Beat_CHOP.md "Beat CHOP").
