...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [PosiStageNet CHOP](https://docs.derivative.ca/PosiStageNet_CHOP "PosiStageNet CHOP").
