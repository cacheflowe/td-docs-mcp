---
url: https://docs.derivative.ca/AudiodynamicsCHOP_Class
category: CHOPs
title: AudiodynamicsCHOP_Class
---

# audiodynamicsCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Dynamics CHOP](Audio_Dynamics_CHOP.md "Audio Dynamics CHOP").
