...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [SOP to CHOP](https://docs.derivative.ca/SOP_to_CHOP "SOP to CHOP").
