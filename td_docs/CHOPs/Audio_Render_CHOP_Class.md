---
url: https://docs.derivative.ca/AudiorenderCHOP_Class
category: CHOPs
title: AudiorenderCHOP_Class
---

# audiorenderCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Render CHOP](../Interoperability/Audio_Render_CHOP.md "Audio Render CHOP").
