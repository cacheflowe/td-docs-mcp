---
url: https://docs.derivative.ca/HeliosdacCHOP_Class
category: CHOPs
title: HeliosdacCHOP_Class
---

# heliosdacCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Helios DAC CHOP](Helios_DAC_CHOP.md "Helios DAC CHOP").
