...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio File In CHOP](https://docs.derivative.ca/Audio_File_In_CHOP "Audio File In CHOP").


## Members
`timecode` → `tdu.Timecode` **(Read Only)** :
Get a Timecode object for timecode data representation of the current index of the audio file. See [Timecode Class](https://docs.derivative.ca/Timecode_Class "Timecode Class").
