---
url: https://docs.derivative.ca/SortCHOP_Class
category: CHOPs
title: SortCHOP_Class
---

# sortCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Sort CHOP](Sort_CHOP.md "Sort CHOP").
