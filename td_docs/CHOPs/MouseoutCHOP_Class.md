...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Mouse Out CHOP](https://docs.derivative.ca/Mouse_Out_CHOP "Mouse Out CHOP").
