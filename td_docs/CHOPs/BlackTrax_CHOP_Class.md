---
url: https://docs.derivative.ca/BlacktraxCHOP_Class
category: CHOPs
title: BlacktraxCHOP_Class
---

# blacktraxCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [BlackTrax CHOP](BlackTrax_CHOP.md "BlackTrax CHOP").
