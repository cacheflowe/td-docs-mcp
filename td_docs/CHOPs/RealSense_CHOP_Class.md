---
url: https://docs.derivative.ca/RealsenseCHOP_Class
category: CHOPs
title: RealsenseCHOP_Class
---

# realsenseCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [RealSense CHOP](RealSense_CHOP.md "RealSense CHOP").
