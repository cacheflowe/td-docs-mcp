---
url: https://docs.derivative.ca/Noise_CHOP
category: CHOPs
title: Noise_CHOP
---
...
It generates both smooth curves and noise that is random each sample. It uses the same math as the [Noise SOP](../SOPs/Noise_SOP.md "Noise SOP").
...
All noise functions work identically with [Time Slicing](../Glossary/Time_Slicing.md "Time Slicing") on and off, with the exception of Harmonic Summation and Brownian whose methods cannot be limited to 1 in Time Slice mode. When the [Timeline](../Glossary/Timeline.md "Timeline") wraps around to frame 1, the noise functions will continue uninterrupted.

[noiseCHOP_Class](Noise_CHOP_Class.md "NoiseCHOP Class")
...
Extra Information for the Noise CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
