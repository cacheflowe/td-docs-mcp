---
url: https://docs.derivative.ca/WrnchaiCHOP_Class
category: CHOPs
title: WrnchaiCHOP_Class
---

# wrnchaiCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [wrnchAI CHOP](WrnchAI_CHOP.md "WrnchAI CHOP").
