...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Scan CHOP](https://docs.derivative.ca/Scan_CHOP "Scan CHOP").
