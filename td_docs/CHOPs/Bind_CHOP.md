---
url: https://docs.derivative.ca/Bind_CHOP
category: CHOPs
title: Bind_CHOP
---
...
Allows for [binding](../Glossary/Binding.md "Binding") of CHOP channels and parameters.

When a parameter is bound to a channel in the Bind CHOP (via the [parameter modes](../Glossary/Parameter_Mode.md "Parameter Mode") Export or Bind), any change in the channel will update the parameter value, and vice versa any change to the parameter will update the channel value.
...
Extra Information for the Bind CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
