...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [TOP to CHOP](https://docs.derivative.ca/TOP_to_CHOP "TOP to CHOP").
