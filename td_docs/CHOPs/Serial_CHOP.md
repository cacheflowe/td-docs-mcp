---
url: https://docs.derivative.ca/Serial_CHOP
category: CHOPs
title: Serial_CHOP
---
...
When you need to receive more complex data, other than simple ASCII numbers use the [Serial DAT](../Interoperability/Serial_DAT.md "Serial DAT").

See also [Serial DAT](../Interoperability/Serial_DAT.md "Serial DAT"), [serialDAT_Class](../DATs/Serial_DAT_Class.md "SerialDAT Class"), [Arduino](../Interoperability/Arduino.md "Arduino").

[serialCHOP_Class](Serial_CHOP_Class.md "SerialCHOP Class")
...
Extra Information for the Serial CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
