---
url: https://docs.derivative.ca/ClipblenderCHOP_Class
category: CHOPs
title: ClipblenderCHOP_Class
---

# clipblenderCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Clip Blender CHOP](Clip_Blender_CHOP.md "Clip Blender CHOP").
