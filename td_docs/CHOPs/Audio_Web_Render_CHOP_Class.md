---
url: https://docs.derivative.ca/AudiowebrenderCHOP_Class
category: CHOPs
title: AudiowebrenderCHOP_Class
---

# audiowebrenderCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Web Render CHOP](Audio_Web_Render_CHOP.md "Audio Web Render CHOP").
