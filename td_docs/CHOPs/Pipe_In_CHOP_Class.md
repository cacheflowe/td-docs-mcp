---
url: https://docs.derivative.ca/PipeinCHOP_Class
category: CHOPs
title: PipeinCHOP_Class
---

# pipeinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Pipe In CHOP](Pipe_In_CHOP.md "Pipe In CHOP").
...
# me - this DAT
#
# pipeinOp - the OP which is cooking
# message - the received message

def onReceive(pipeinOp, message):
	return
```
