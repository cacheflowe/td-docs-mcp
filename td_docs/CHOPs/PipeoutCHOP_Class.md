...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Pipe Out CHOP](https://docs.derivative.ca/Pipe_Out_CHOP "Pipe Out CHOP").
