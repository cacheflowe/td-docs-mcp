...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [OAK Select CHOP](https://docs.derivative.ca/OAK_Select_CHOP "OAK Select CHOP").
