...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Handle CHOP](https://docs.derivative.ca/Handle_CHOP "Handle CHOP").
