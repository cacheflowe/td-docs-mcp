...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Function CHOP](https://docs.derivative.ca/Function_CHOP "Function CHOP").
