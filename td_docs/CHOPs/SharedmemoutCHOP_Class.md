...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Shared Mem Out CHOP](https://docs.derivative.ca/Shared_Mem_Out_CHOP "Shared Mem Out CHOP").
