...
[analyzeCHOP_Class](Analyze_CHOP_Class.md "AnalyzeCHOP Class")
...
Extra Information for the Analyze CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
