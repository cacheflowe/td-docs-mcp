...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Trim CHOP](https://docs.derivative.ca/Trim_CHOP "Trim CHOP").
