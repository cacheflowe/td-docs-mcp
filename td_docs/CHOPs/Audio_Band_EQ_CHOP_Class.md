---
url: https://docs.derivative.ca/AudiobandeqCHOP_Class
category: CHOPs
title: AudiobandeqCHOP_Class
---

# audiobandeqCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Band EQ CHOP](Audio_Band_EQ_CHOP.md "Audio Band EQ CHOP").
