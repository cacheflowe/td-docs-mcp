---
url: https://docs.derivative.ca/InfoCHOP_Class
category: CHOPs
title: InfoCHOP_Class
---

# infoCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Info CHOP](Info_CHOP.md "Info CHOP").
