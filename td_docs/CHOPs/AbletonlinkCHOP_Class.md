...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Ableton Link CHOP](https://docs.derivative.ca/Ableton_Link_CHOP "Ableton Link CHOP").
