...
[wrnchaiCHOP_Class](WrnchAI_CHOP_Class.md "WrnchaiCHOP Class")
...
Extra Information for the wrnchAI CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
