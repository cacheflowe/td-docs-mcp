...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Lookup CHOP](https://docs.derivative.ca/Lookup_CHOP "Lookup CHOP").
