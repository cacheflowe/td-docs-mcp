---
url: https://docs.derivative.ca/AudiobinauralCHOP_Class
category: CHOPs
title: AudiobinauralCHOP_Class
---

# audiobinauralCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Binaural CHOP](Audio_Binaural_CHOP.md "Audio Binaural CHOP").
