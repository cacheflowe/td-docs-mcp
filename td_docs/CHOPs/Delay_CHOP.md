---
url: https://docs.derivative.ca/Delay_CHOP
category: CHOPs
title: Delay_CHOP
---
...
Echoes can be created by chains of Delay CHOPs with Math CHOPs between, or by using the [Feedback CHOP](Feedback_CHOP.md "Feedback CHOP").

[delayCHOP_Class](Delay_CHOP_Class.md "DelayCHOP Class")
...
Extra Information for the Delay CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
