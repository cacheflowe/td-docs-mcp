---
url: https://docs.derivative.ca/OscinCHOP_Class
category: CHOPs
title: OscinCHOP_Class
---

# oscinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [OSC In CHOP](../Interoperability/OSC_In_CHOP.md "OSC In CHOP").
