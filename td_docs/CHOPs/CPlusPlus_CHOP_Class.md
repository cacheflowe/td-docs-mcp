---
url: https://docs.derivative.ca/CplusplusCHOP_Class
category: CHOPs
title: CplusplusCHOP_Class
---

# cplusplusCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [CPlusPlus CHOP](CPlusPlus_CHOP.md "CPlusPlus CHOP").
