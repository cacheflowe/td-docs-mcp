...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Select CHOP](https://docs.derivative.ca/Select_CHOP "Select CHOP").
