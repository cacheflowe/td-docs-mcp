...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Inverse Curve CHOP](https://docs.derivative.ca/Inverse_Curve_CHOP "Inverse Curve CHOP").
