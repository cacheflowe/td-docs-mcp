...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio Dynamics CHOP](https://docs.derivative.ca/Audio_Dynamics_CHOP "Audio Dynamics CHOP").
