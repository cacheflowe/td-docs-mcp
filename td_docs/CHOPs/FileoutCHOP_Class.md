...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [File Out CHOP](https://docs.derivative.ca/File_Out_CHOP "File Out CHOP").
