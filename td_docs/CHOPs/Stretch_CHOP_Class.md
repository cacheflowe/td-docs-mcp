---
url: https://docs.derivative.ca/StretchCHOP_Class
category: CHOPs
title: StretchCHOP_Class
---

# stretchCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Stretch CHOP](Stretch_CHOP.md "Stretch CHOP").
