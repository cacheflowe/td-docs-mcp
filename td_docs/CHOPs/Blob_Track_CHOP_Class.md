---
url: https://docs.derivative.ca/BlobtrackCHOP_Class
category: CHOPs
title: BlobtrackCHOP_Class
---

# blobtrackCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Blob Track CHOP](Blob_Track_CHOP.md "Blob Track CHOP").
