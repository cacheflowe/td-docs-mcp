---
url: https://docs.derivative.ca/TabletCHOP_Class
category: CHOPs
title: TabletCHOP_Class
---

# tabletCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Tablet CHOP](Tablet_CHOP.md "Tablet CHOP").
