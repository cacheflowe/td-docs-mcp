...
If you wish to blend between inputs use the [Cross CHOP](Cross_CHOP.md "Cross CHOP") or the [Blend CHOP](Blend_CHOP.md "Blend CHOP").

[switchCHOP_Class](Switch_CHOP_Class.md "SwitchCHOP Class")
...
Extra Information for the Switch CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
