...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Rename CHOP](https://docs.derivative.ca/Rename_CHOP "Rename CHOP").
