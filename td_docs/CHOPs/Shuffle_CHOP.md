...
It is useful for transforming data received by the [SOP to CHOP](SOP_to_CHOP.md "SOP to CHOP") and [TOP to CHOPs](TOP_to_CHOP.md "TOP to CHOP") into channels containing only one row or column. Data can be easily manipulated, then transformed back if needed.

[shuffleCHOP_Class](Shuffle_CHOP_Class.md "ShuffleCHOP Class")
...
Extra Information for the Shuffle CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
