...
The Stype CHOP reads camera tracking information sent from a [Stype](../Interoperability/Stype.md "Stype") (**RedSpy**) device using the Stype HF protocol. The CHOP outputs channels that can be used to control a virtual camera and implement lens distortion via the [Stype TOP](../TOPs/Stype_TOP.md "Stype TOP").

The channels exported by the Stype CHOP are:       _connected_ - 1 or 0, indicating whether the CHOP has received valid Stype messages within the last 500ms      _recording_ - 1 or 0, indicating the recording status on the Stype Kit (see Stype protocol for more information)      _focus_distance_ - 1 or 0, indicating how the focus field is used (see Stype protocol for more information)      _hours, minutes, seconds, frames_ - timecode, may be zero if time information is not present      _tx, ty, tz_ - camera position, can be connected to the [Camera COMP](../Glossary/Camera_COMP.md "Camera COMP") Translate parameters      _rx, ry, rz_ - camera rotation, can be connected to the [Camera COMP](../Glossary/Camera_COMP.md "Camera COMP") Rotate parameters      _fov_ - camera field of view, can be connected to the [Camera COMP](../Glossary/Camera_COMP.md "Camera COMP") FOV Angle parameter      _padded_fov_ - field of view expanded by the padding parameter, can be used in [Camera COMP](../Glossary/Camera_COMP.md "Camera COMP") FOV Angle parameter      _aspect_ - aspect ratio of the camera      _focus_ - camera focus from 0 (closest) to 1 (infinite), can be used to simulate depth of field      _zoom_ - camera zoom from 0 (wide) to 1 (tele)      _centerx, centery_ - offset of the camera sensor in mm, used by the [Stype TOP](../TOPs/Stype_TOP.md "Stype TOP") for calculating lens correction      _k1, k2_ - radial lens distortion parameters, used by the [Stype TOP](../TOPs/Stype_TOP.md "Stype TOP") for calculating lens correction      _pawidth, paheight_ - size of the sensor in mm, used by the [Stype TOP](../TOPs/Stype_TOP.md "Stype TOP") for calculating lens correction
...
**NOTE:** This CHOP works with [Stype](https://www.stype.tv) hardware. For more information refer to the [Stype](../Interoperability/Stype.md "Stype") article.

See also [Stype TOP](../TOPs/Stype_TOP.md "Stype TOP").

[stypeCHOP_Class](StypeCHOP_Class.md "StypeCHOP Class")
