...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
