...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Interpolate CHOP](https://docs.derivative.ca/Interpolate_CHOP "Interpolate CHOP").
