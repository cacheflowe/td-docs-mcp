...
If you want to capture the data in memory, use a [Trail CHOP](Trail_CHOP.md "Trail CHOP") or [Record CHOP](Record_CHOP.md "Record CHOP"). If you want to record to a file, use [Audio File Out CHOP](Audio_File_Out_CHOP.md "Audio File Out CHOP") or [Movie File Out TOP](../TOPs/Movie_File_Out_TOP.md "Movie File Out TOP").
...
[audiodeviceinCHOP_Class](Audio_Device_In_CHOP_Class.md "AudiodeviceinCHOP Class")
...
- Driver `driver` - ⊞ - Select between default DirectSound/CoreAudio, ASIO, or native device supported drivers.
  ...
  * Blackmagic `blackmagic` - Native support for capturing the audio from [Blackmagic Design](../Interoperability/Blackmagic_Design.md "Blackmagic Design") devices.
  * AJA `aja` - Native support for capturing the audio from [AJA](../Interoperability/AJA.md "AJA") devices.
