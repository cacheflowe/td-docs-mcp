---
url: https://docs.derivative.ca/ReorderCHOP_Class
category: CHOPs
title: ReorderCHOP_Class
---

# reorderCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Reorder CHOP](Reorder_CHOP.md "Reorder CHOP").
