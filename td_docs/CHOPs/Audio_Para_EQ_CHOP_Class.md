---
url: https://docs.derivative.ca/AudioparaeqCHOP_Class
category: CHOPs
title: AudioparaeqCHOP_Class
---

# audioparaeqCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Para EQ CHOP](Audio_Para_EQ_CHOP.md "Audio Para EQ CHOP").
