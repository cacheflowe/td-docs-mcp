---
url: https://docs.derivative.ca/CountCHOP_Class
category: CHOPs
title: CountCHOP_Class
---

# countCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Count CHOP](Count_CHOP.md "Count CHOP").
