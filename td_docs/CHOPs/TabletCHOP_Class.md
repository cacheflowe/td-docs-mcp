...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Tablet CHOP](https://docs.derivative.ca/Tablet_CHOP "Tablet CHOP").
