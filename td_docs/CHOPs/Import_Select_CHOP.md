---
url: https://docs.derivative.ca/Import_Select_CHOP
category: CHOPs
title: Import_Select_CHOP
---
...
The Import Select CHOP is used to specify CHOP channels from an importing file such as [FBX COMP](../COMPs/FBX_COMP.md "FBX COMP") or [USD COMP](../COMPs/USD_COMP.md "USD COMP"). One of the main purpose of these channels is to represent the changes of transformation of different primitives or the state of some dynamic features of importing file. The Import Select CHOP can have its own animation controls within the Play page or use the settings from its parent COMP.

See Also: [USD COMP](../COMPs/USD_COMP.md "USD COMP"), [FBX COMP](../COMPs/FBX_COMP.md "FBX COMP")

[importselectCHOP_Class](Import_Select_CHOP_Class.md "ImportselectCHOP Class")
