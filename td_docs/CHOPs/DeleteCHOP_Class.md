...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Delete CHOP](https://docs.derivative.ca/Delete_CHOP "Delete CHOP").
