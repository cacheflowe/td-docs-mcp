---
url: https://docs.derivative.ca/SpringCHOP_Class
category: CHOPs
title: SpringCHOP_Class
---

# springCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Spring CHOP](Spring_CHOP.md "Spring CHOP").
