---
url: https://docs.derivative.ca/Mouse_Out_CHOP
category: CHOPs
title: Mouse_Out_CHOP
---
...
[mouseoutCHOP_Class](Mouse_Out_CHOP_Class.md "MouseoutCHOP Class")
...
- Right Button `rbuttonname` - Channel name to look for that will drive the mouse's right button state.
- Middle Button `mbuttonname` - Channel name to look for that will drive the mouse's middle button state.
...
Extra Information for the Mouse Out CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
