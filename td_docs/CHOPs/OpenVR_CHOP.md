---
url: https://docs.derivative.ca/OpenVR_CHOP
category: CHOPs
title: OpenVR_CHOP
---
...
The OpenVR CHOP receives positional data, frame rendering info, and action data from the [OpenVR](../Interoperability/OpenVR.md "OpenVR") SDK. Each CHOP can output in one of 5 modes: Sensors, Projection Matrices, Trackers, Frame Timings, Actions and Skeletons.
...
By default when running a VR system the file will be throttled to the speed of the VR devices refresh rate by the OpenVR SDK. This helps ensure the low latency output required for a good VR experience. If only controllers/Vive trackers are being used for tracking in a non-VR situation, the file can run and sample those devices at a higher sample rate as long as no [OpenVR TOP](../TOPs/OpenVR_TOP.md "OpenVR TOP") in the project. If an [OpenVR TOP](../TOPs/OpenVR_TOP.md "OpenVR TOP") is present anywhere in the project, then playback will be throttled to the VR devices refresh rate.

See also [OpenVR](../Interoperability/OpenVR.md "OpenVR"), [OpenVR TOP](../TOPs/OpenVR_TOP.md "OpenVR TOP"), [OpenVR SOP](../SOPs/OpenVR_SOP.md "OpenVR SOP"), [Audio Render CHOP](../Interoperability/Audio_Render_CHOP.md "Audio Render CHOP")

[openvrCHOP_Class](OpenVR_CHOP_Class.md "OpenvrCHOP Class")
...
Extra Information for the OpenVR CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
