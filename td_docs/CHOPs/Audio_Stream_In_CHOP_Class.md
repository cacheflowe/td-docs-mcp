---
url: https://docs.derivative.ca/AudiostreaminCHOP_Class
category: CHOPs
title: AudiostreaminCHOP_Class
---

# audiostreaminCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Stream In CHOP](Audio_Stream_In_CHOP.md "Audio Stream In CHOP").
