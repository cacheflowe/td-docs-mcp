---
url: https://docs.derivative.ca/AttributeCHOP_Class
category: CHOPs
title: AttributeCHOP_Class
---

# attributeCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Attribute CHOP](Attribute_CHOP.md "Attribute CHOP").
