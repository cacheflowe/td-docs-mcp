...
**Tip** : The [Trail CHOP](Trail_CHOP.md "Trail CHOP") also records the last window of samples, and more powerfully, the gestureCapture component in the Palette gives more control over multi-captures and smoothing channel data.
...
The [Mouse In CHOP](Mouse_In_CHOP.md "Mouse In CHOP") and [Keyboard In CHOP](Keyboard_In_CHOP.md "Keyboard In CHOP") are often attached to the Position and Active inputs respectively of the Record CHOP to perform the recording of channels from mouse movements, enabled by pressing a keyboard key (see the [Keyboard In CHOP](Keyboard_In_CHOP.md "Keyboard In CHOP")).

Record Segment is useful for recording trails, snakes, and other models that use a time-history of motion.

See the [Time Slice CHOP](Time_Slice_CHOP.md "Time Slice CHOP") for input smoothing.

[recordCHOP_Class](Record_CHOP_Class.md "RecordCHOP Class")
...
Extra Information for the Record CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
