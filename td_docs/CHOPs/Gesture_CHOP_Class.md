---
url: https://docs.derivative.ca/GestureCHOP_Class
category: CHOPs
title: GestureCHOP_Class
---

# gestureCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Gesture CHOP](Gesture_CHOP.md "Gesture CHOP").
