---
url: https://docs.derivative.ca/InversecurveCHOP_Class
category: CHOPs
title: InversecurveCHOP_Class
---

# inversecurveCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Inverse Curve CHOP](Inverse_Curve_CHOP.md "Inverse Curve CHOP").
