---
url: https://docs.derivative.ca/SpeedCHOP_Class
category: CHOPs
title: SpeedCHOP_Class
---

# speedCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Speed CHOP](../Glossary/Speed_CHOP.md "Speed CHOP").
