...
See also: [Audio Render CHOP](../Interoperability/Audio_Render_CHOP.md "Audio Render CHOP")

[oculusaudioCHOP_Class](Oculus_Audio_CHOP_Class.md "OculusaudioCHOP Class")
...
Extra Information for the Oculus Audio CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
