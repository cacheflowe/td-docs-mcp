...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Resample CHOP](https://docs.derivative.ca/Resample_CHOP "Resample CHOP").
