...
You can also use this to quickly delete channels (this method can be faster than the [Delete CHOP](Delete_CHOP.md "Delete CHOP")). To do this send all the channels to Input2, then send the channels you want to keep to Input1.

[replaceCHOP_Class](Replace_CHOP_Class.md "ReplaceCHOP Class")
...
Extra Information for the Replace CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
