...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Hog CHOP](https://docs.derivative.ca/Hog_CHOP "Hog CHOP").
