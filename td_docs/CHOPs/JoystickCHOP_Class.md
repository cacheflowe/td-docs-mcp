...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Joystick CHOP](https://docs.derivative.ca/Joystick_CHOP "Joystick CHOP").
