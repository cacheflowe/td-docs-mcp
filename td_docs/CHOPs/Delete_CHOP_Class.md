---
url: https://docs.derivative.ca/DeleteCHOP_Class
category: CHOPs
title: DeleteCHOP_Class
---

# deleteCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Delete CHOP](Delete_CHOP.md "Delete CHOP").
