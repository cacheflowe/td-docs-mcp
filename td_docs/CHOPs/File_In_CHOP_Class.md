---
url: https://docs.derivative.ca/FileinCHOP_Class
category: CHOPs
title: FileinCHOP_Class
---

# fileinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [File In CHOP](File_In_CHOP.md "File In CHOP").
