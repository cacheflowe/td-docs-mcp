---
url: https://docs.derivative.ca/OscoutCHOP_Class
category: CHOPs
title: OscoutCHOP_Class
---

# oscoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [OSC Out CHOP](OSC_Out_CHOP.md "OSC Out CHOP").
