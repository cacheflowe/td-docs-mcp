---
url: https://docs.derivative.ca/JoinCHOP_Class
category: CHOPs
title: JoinCHOP_Class
---

# joinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Join CHOP](Join_CHOP.md "Join CHOP").
