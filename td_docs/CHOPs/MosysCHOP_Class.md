...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [MoSys CHOP](https://docs.derivative.ca/MoSys_CHOP "MoSys CHOP").
