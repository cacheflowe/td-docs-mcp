...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Import Select CHOP](https://docs.derivative.ca/Import_Select_CHOP "Import Select CHOP").
