---
url: https://docs.derivative.ca/AudiooscillatorCHOP_Class
category: CHOPs
title: AudiooscillatorCHOP_Class
---

# audiooscillatorCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Oscillator CHOP](Audio_Oscillator_CHOP.md "Audio Oscillator CHOP").
