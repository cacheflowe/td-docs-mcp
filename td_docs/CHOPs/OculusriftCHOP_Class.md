...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Oculus Rift CHOP](https://docs.derivative.ca/Oculus_Rift_CHOP "Oculus Rift CHOP").
