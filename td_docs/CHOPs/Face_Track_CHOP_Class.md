---
url: https://docs.derivative.ca/FacetrackCHOP_Class
category: CHOPs
title: FacetrackCHOP_Class
---

# facetrackCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Face Track CHOP](../Interoperability/Face_Track_CHOP.md "Face Track CHOP").
