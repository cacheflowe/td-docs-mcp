...
It uses [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching") on the From string, and [Pattern Replacement](../Glossary/Pattern_Replacement.md "Pattern Replacement") on the To string.

The channel values and the channel order are not affected, only their names change.

(Note that the [Constant CHOP](Constant_CHOP.md "Constant CHOP") (containing channel values of 0) added to another CHOP in a [Math CHOP](Math_CHOP.md "Math CHOP") can also be used to rename channels.)

See also [Select CHOP](../Glossary/Select_CHOP.md "Select CHOP")

[renameCHOP_Class](Rename_CHOP_Class.md "RenameCHOP Class")
...
- From `renamefrom` - The channel pattern to rename. See [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching").
- To `renameto` - The replacement pattern for the channel names. See [Pattern Replacement](../Glossary/Pattern_Replacement.md "Pattern Replacement").
...
Extra Information for the Rename CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
