---
url: https://docs.derivative.ca/CopyCHOP_Class
category: CHOPs
title: CopyCHOP_Class
---

# copyCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Copy CHOP](Copy_CHOP.md "Copy CHOP").
