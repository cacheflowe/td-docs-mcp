---
url: https://docs.derivative.ca/MathCHOP_Class
category: CHOPs
title: MathCHOP_Class
---

# mathCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Math CHOP](Math_CHOP.md "Math CHOP").
