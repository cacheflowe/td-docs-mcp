...
To shorten or lengthen the interval (the start or end of the CHOP), use the [Trim CHOP](Trim_CHOP.md "Trim CHOP").

You can see the state of Extend Conditions in the pop-up info of any CHOP (use middle-mouse click on the CHOP).

[extendCHOP_Class](Extend_CHOP_Class.md "ExtendCHOP Class")
...
Extra Information for the Extend CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
