---
url: https://docs.derivative.ca/BlendCHOP_Class
category: CHOPs
title: BlendCHOP_Class
---

# blendCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Blend CHOP](Blend_CHOP.md "Blend CHOP").
