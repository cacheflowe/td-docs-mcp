---
url: https://docs.derivative.ca/TimelineCHOP_Class
category: CHOPs
title: TimelineCHOP_Class
---

# timelineCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Timeline CHOP](Timeline_CHOP.md "Timeline CHOP").

## Members

`timecode` → `tdu.Timecode` **(Read Only)** :

Get a Timecode object for the timecode data representation of the current timeline frame. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class").
