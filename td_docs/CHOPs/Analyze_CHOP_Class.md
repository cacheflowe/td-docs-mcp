---
url: https://docs.derivative.ca/AnalyzeCHOP_Class
category: CHOPs
title: AnalyzeCHOP_Class
---

# analyzeCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Analyze CHOP](Analyze_CHOP.md "Analyze CHOP").
