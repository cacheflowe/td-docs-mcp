---
url: https://docs.derivative.ca/NullCHOP_Class
category: CHOPs
title: NullCHOP_Class
---

# nullCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Null CHOP](Null_CHOP.md "Null CHOP").
