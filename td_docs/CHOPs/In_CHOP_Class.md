---
url: https://docs.derivative.ca/InCHOP_Class
category: CHOPs
title: InCHOP_Class
---
...
This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [In CHOP](In_CHOP.md "In CHOP").
