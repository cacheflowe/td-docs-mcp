...
**DEPRECATED:** use the [Laser Device CHOP](Laser_Device_CHOP.md "Laser Device CHOP") instead.
...
See also: [EtherDream CHOP](EtherDream_CHOP.md "EtherDream CHOP"), [EtherDream DAT](../DATs/EtherDream_DAT.md "EtherDream DAT"), [Laser CHOP](Laser_CHOP.md "Laser CHOP"), and the [Pattern CHOP](Pattern_CHOP.md "Pattern CHOP").

[heliosdacCHOP_Class](Helios_DAC_CHOP_Class.md "HeliosdacCHOP Class")
...
Extra Information for the Helios DAC CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
