...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Keyframe CHOP](https://docs.derivative.ca/Keyframe_CHOP "Keyframe CHOP").
