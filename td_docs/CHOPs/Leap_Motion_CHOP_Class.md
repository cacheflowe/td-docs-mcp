---
url: https://docs.derivative.ca/LeapmotionCHOP_Class
category: CHOPs
title: LeapmotionCHOP_Class
---

# leapmotionCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Leap Motion CHOP](Leap_Motion_CHOP.md "Leap Motion CHOP").
