...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [RealSense CHOP](https://docs.derivative.ca/RealSense_CHOP "RealSense CHOP").
