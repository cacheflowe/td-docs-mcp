---
url: https://docs.derivative.ca/FreedoutCHOP_Class
category: CHOPs
title: FreedoutCHOP_Class
---

# freedoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [FreeD Out CHOP](FreeD_Out_CHOP.md "FreeD Out CHOP").
