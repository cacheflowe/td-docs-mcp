---
url: https://docs.derivative.ca/OculusriftCHOP_Class
category: CHOPs
title: OculusriftCHOP_Class
---

# oculusriftCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Oculus Rift CHOP](Oculus_Rift_CHOP.md "Oculus Rift CHOP").
