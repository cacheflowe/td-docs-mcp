...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Shift CHOP](https://docs.derivative.ca/Shift_CHOP "Shift CHOP").
