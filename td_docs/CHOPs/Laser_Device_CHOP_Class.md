---
url: https://docs.derivative.ca/LaserdeviceCHOP_Class
category: CHOPs
title: LaserdeviceCHOP_Class
---

# laserdeviceCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Laser Device CHOP](Laser_Device_CHOP.md "Laser Device CHOP").
