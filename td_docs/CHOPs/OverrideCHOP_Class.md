...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Override CHOP](https://docs.derivative.ca/Override_CHOP "Override CHOP").
