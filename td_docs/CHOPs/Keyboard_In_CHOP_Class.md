---
url: https://docs.derivative.ca/KeyboardinCHOP_Class
category: CHOPs
title: KeyboardinCHOP_Class
---

# keyboardinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Keyboard In CHOP](Keyboard_In_CHOP.md "Keyboard In CHOP").
