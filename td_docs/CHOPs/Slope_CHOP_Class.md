---
url: https://docs.derivative.ca/SlopeCHOP_Class
category: CHOPs
title: SlopeCHOP_Class
---

# slopeCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Slope CHOP](Slope_CHOP.md "Slope CHOP").
