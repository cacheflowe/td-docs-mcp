---
url: https://docs.derivative.ca/ExtendCHOP_Class
category: CHOPs
title: ExtendCHOP_Class
---

# extendCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Extend CHOP](Extend_CHOP.md "Extend CHOP").
