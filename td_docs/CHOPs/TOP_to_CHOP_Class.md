---
url: https://docs.derivative.ca/ToptoCHOP_Class
category: CHOPs
title: ToptoCHOP_Class
---

# toptoCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [TOP to CHOP](TOP_to_CHOP.md "TOP to CHOP").
