...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Hold CHOP](https://docs.derivative.ca/Hold_CHOP "Hold CHOP").
