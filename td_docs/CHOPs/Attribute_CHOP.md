---
url: https://docs.derivative.ca/Attribute_CHOP
category: CHOPs
title: Attribute_CHOP
---
...
See some of the CHOPs that use the attribute: the [Join CHOP](Join_CHOP.md "Join CHOP"), [Composite CHOP](Composite_CHOP.md "Composite CHOP") and [Interpolate CHOP](Interpolate_CHOP.md "Interpolate CHOP"). Other CHOPs may quietly use the Quaternion attribute, such as the [Object CHOP](Object_CHOP.md "Object CHOP"), [Stretch CHOP](Stretch_CHOP.md "Stretch CHOP") and the [Resample CHOP](Resample_CHOP.md "Resample CHOP").

The Scope is needed to specify the channels that will be grouped.

[attributeCHOP_Class](Attribute_CHOP_Class.md "AttributeCHOP Class")
...
Extra Information for the Attribute CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
