---
url: https://docs.derivative.ca/TouchoutCHOP_Class
category: CHOPs
title: TouchoutCHOP_Class
---

# touchoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Touch Out CHOP](Touch_Out_CHOP.md "Touch Out CHOP").
