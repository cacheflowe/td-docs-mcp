---
url: https://docs.derivative.ca/LogicCHOP_Class
category: CHOPs
title: LogicCHOP_Class
---

# logicCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Logic CHOP](Logic_CHOP.md "Logic CHOP").
