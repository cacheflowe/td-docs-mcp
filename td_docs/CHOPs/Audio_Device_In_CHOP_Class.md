---
url: https://docs.derivative.ca/AudiodeviceinCHOP_Class
category: CHOPs
title: AudiodeviceinCHOP_Class
---

# audiodeviceinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Device In CHOP](Audio_Device_In_CHOP.md "Audio Device In CHOP").
