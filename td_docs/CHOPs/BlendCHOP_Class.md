...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Blend CHOP](https://docs.derivative.ca/Blend_CHOP "Blend CHOP").
