...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Pipe In CHOP](https://docs.derivative.ca/Pipe_In_CHOP "Pipe In CHOP").
