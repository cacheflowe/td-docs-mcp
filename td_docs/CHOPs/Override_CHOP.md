...
[overrideCHOP_Class](Override_CHOP_Class.md "OverrideCHOP Class")
...
Extra Information for the Override CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
