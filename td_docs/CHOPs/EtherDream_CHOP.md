...
The EtherDream CHOP needs the IP address of the EtherDream device, which you can get from the output of an [EtherDream DAT](../DATs/EtherDream_DAT.md "EtherDream DAT").
...
See also: [EtherDream DAT](../DATs/EtherDream_DAT.md "EtherDream DAT"), [Laser CHOP](Laser_CHOP.md "Laser CHOP"), and the [Pattern CHOP](Pattern_CHOP.md "Pattern CHOP"), [Helios DAC CHOP](Helios_DAC_CHOP.md "Helios DAC CHOP").

[etherdreamCHOP_Class](EtherDream_CHOP_Class.md "EtherdreamCHOP Class")
...
Extra Information for the EtherDream CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
