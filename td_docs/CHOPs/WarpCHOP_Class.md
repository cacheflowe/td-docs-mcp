...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Warp CHOP](https://docs.derivative.ca/Warp_CHOP "Warp CHOP").
