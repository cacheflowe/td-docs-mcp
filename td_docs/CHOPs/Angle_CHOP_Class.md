---
url: https://docs.derivative.ca/AngleCHOP_Class
category: CHOPs
title: AngleCHOP_Class
---

# angleCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Angle CHOP](Angle_CHOP.md "Angle CHOP").
