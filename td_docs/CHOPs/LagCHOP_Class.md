...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Lag CHOP](https://docs.derivative.ca/Lag_CHOP "Lag CHOP").
