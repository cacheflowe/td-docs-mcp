...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [BlackTrax CHOP](https://docs.derivative.ca/BlackTrax_CHOP "BlackTrax CHOP").
