---
url: https://docs.derivative.ca/SyncinCHOP_Class
category: CHOPs
title: SyncinCHOP_Class
---

# syncinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Sync In CHOP](Sync_In_CHOP.md "Sync In CHOP").

## Members

`timecode` → `tdu.Timecode` **(Read Only)** :

Get a Timecode object for the timecode data representation of the last received index. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class").
...
# me - this DAT
#
# chop - the CHOP that received the data
# message - the message that was received. May be in any format.

def onReceive(chop, message):
	return
```
...
Get or set the sample rate of the CHOP. This can be modified only when the CHOP is a [scriptCHOP](Script_CHOP_Class.md "ScriptCHOP Class").
