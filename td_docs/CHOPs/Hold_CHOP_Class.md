---
url: https://docs.derivative.ca/HoldCHOP_Class
category: CHOPs
title: HoldCHOP_Class
---

# holdCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Hold CHOP](Hold_CHOP.md "Hold CHOP").
