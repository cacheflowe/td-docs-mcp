...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Envelope CHOP](https://docs.derivative.ca/Envelope_CHOP "Envelope CHOP").
