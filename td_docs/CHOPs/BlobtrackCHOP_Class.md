...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Blob Track CHOP](https://docs.derivative.ca/Blob_Track_CHOP "Blob Track CHOP").
