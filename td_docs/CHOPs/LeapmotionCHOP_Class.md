...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Leap Motion CHOP](https://docs.derivative.ca/Leap_Motion_CHOP "Leap Motion CHOP").
