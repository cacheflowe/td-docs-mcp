...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio Render CHOP](https://docs.derivative.ca/Audio_Render_CHOP "Audio Render CHOP").
