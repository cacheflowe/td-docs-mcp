---
url: https://docs.derivative.ca/SwitchCHOP_Class
category: CHOPs
title: SwitchCHOP_Class
---

# switchCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Switch CHOP](Switch_CHOP.md "Switch CHOP").
