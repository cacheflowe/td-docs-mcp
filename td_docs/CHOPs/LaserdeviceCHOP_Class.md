...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Laser Device CHOP](https://docs.derivative.ca/Laser_Device_CHOP "Laser Device CHOP").
