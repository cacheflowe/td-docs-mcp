---
url: https://docs.derivative.ca/PhaserCHOP_Class
category: CHOPs
title: PhaserCHOP_Class
---

# phaserCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Phaser CHOP](Phaser_CHOP.md "Phaser CHOP").
