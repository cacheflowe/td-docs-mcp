...
The Touch Out CHOP can be used to create high speed connection between two TouchDesigner processes. Data is sent over TCP/IP. The Touch Out CHOP (server) sends it's data to a [Touch In CHOP](Touch_In_CHOP.md "Touch In CHOP") (client). The Touch Out CHOP is similar to a [Pipe Out CHOP](Pipe_Out_CHOP.md "Pipe Out CHOP") but highly optimized for TouchDesigner-to-TouchDesigner communication. For interfacing with other software or devices, see the [Pipe Out CHOP](Pipe_Out_CHOP.md "Pipe Out CHOP").
...
[touchoutCHOP_Class](Touch_Out_CHOP_Class.md "TouchoutCHOP Class")
...
Extra Information for the Touch Out CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
