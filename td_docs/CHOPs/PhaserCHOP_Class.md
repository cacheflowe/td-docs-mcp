...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Phaser CHOP](https://docs.derivative.ca/Phaser_CHOP "Phaser CHOP").
