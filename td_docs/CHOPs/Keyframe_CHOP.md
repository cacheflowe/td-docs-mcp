---
url: https://docs.derivative.ca/Keyframe_CHOP
category: CHOPs
title: Keyframe_CHOP
---
...
The Keyframe CHOP uses channel and keys data in an [Animation COMP](../Glossary/Animation_COMP.md "Animation COMP") and creates channels of samples at a selectable sample rate (frames per second).

See also: [Animation COMP](../Glossary/Animation_COMP.md "Animation COMP") and [Animation Editor](https://docs.derivative.ca/Animation_Editor "Animation Editor")
...
[keyframeCHOP_Class](Keyframe_CHOP_Class.md "KeyframeCHOP Class")
...
Extra Information for the Keyframe CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
