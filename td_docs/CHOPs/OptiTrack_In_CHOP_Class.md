---
url: https://docs.derivative.ca/OptitrackinCHOP_Class
category: CHOPs
title: OptitrackinCHOP_Class
---

# optitrackinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [OptiTrack In CHOP](OptiTrack_In_CHOP.md "OptiTrack In CHOP").
