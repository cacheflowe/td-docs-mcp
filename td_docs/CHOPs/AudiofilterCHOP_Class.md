...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio Filter CHOP](https://docs.derivative.ca/Audio_Filter_CHOP "Audio Filter CHOP").
