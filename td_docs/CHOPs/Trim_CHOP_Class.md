---
url: https://docs.derivative.ca/TrimCHOP_Class
category: CHOPs
title: TrimCHOP_Class
---

# trimCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Trim CHOP](Trim_CHOP.md "Trim CHOP").
