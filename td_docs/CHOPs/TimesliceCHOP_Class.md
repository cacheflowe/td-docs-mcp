...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Time Slice CHOP](https://docs.derivative.ca/Time_Slice_CHOP "Time Slice CHOP").
