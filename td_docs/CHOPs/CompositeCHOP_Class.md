...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Composite CHOP](https://docs.derivative.ca/Composite_CHOP "Composite CHOP").
