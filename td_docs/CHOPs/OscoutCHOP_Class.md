...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [OSC Out CHOP](https://docs.derivative.ca/OSC_Out_CHOP "OSC Out CHOP").
