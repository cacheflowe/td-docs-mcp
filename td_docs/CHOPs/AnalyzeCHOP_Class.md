...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Analyze CHOP](https://docs.derivative.ca/Analyze_CHOP "Analyze CHOP").
