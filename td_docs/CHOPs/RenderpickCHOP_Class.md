...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Render Pick CHOP](https://docs.derivative.ca/Render_Pick_CHOP "Render Pick CHOP").


## Members
`pickedSOP` → `OP` **(Read Only)** :
The [SOP](https://docs.derivative.ca/SOP_Class "SOP Class") that was last picked.
## Methods
