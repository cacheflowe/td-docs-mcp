---
url: https://docs.derivative.ca/CompositeCHOP_Class
category: CHOPs
title: CompositeCHOP_Class
---

# compositeCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Composite CHOP](Composite_CHOP.md "Composite CHOP").
