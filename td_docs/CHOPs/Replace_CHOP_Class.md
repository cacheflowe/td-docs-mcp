---
url: https://docs.derivative.ca/ReplaceCHOP_Class
category: CHOPs
title: ReplaceCHOP_Class
---

# replaceCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Replace CHOP](Replace_CHOP.md "Replace CHOP").
