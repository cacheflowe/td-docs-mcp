...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Logic CHOP](https://docs.derivative.ca/Logic_CHOP "Logic CHOP").
