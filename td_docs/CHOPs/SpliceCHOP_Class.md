...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Splice CHOP](https://docs.derivative.ca/Splice_CHOP "Splice CHOP").
