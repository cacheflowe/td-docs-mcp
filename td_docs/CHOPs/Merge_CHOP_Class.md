---
url: https://docs.derivative.ca/MergeCHOP_Class
category: CHOPs
title: MergeCHOP_Class
---

# mergeCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Merge CHOP](Merge_CHOP.md "Merge CHOP").
