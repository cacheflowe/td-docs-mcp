---
url: https://docs.derivative.ca/Transform_XYZ_CHOP
category: CHOPs
title: Transform_XYZ_CHOP
---
...
See also the [Transform CHOP](Transform_CHOP.md "Transform CHOP").

[transformxyzCHOP_Class](Transform_XYZ_CHOP_Class.md "TransformxyzCHOP Class")
...
## Operator Inputs
  ...
  * Input 1: Transform - An optional additional transform that can be applied. Valid formats are the same as the [Transform CHOP](Transform_CHOP.md "Transform CHOP").

## Info CHOP Channels

Extra Information for the Transform XYZ CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
