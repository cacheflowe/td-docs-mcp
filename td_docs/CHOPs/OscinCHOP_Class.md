...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [OSC In CHOP](https://docs.derivative.ca/OSC_In_CHOP "OSC In CHOP").
