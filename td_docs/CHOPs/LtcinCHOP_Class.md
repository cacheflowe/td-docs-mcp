...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [LTC In CHOP](https://docs.derivative.ca/LTC_In_CHOP "LTC In CHOP").


## Members
`timecode` → `tdu.Timecode` **(Read Only)** :
Get a Timecode object for the timecode data representation of the LTC In CHOP. See [Timecode Class](https://docs.derivative.ca/Timecode_Class "Timecode Class").
## Methods
