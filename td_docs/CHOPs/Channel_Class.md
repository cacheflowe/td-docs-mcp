...
Get or set the full list of Channel values. Modifying Channel values can only be done in Python within a [Script CHOP](Script_CHOP_Class.md "ScriptCHOP Class").
...
Destroy and remove the actual Channel this object refers to. This operation is only valid when the channel belongs to a [ Script CHOP](Script_CHOP_Class.md "ScriptCHOP Class") or [OSC In CHOP](OSC_In_CHOP_Class.md "OscinCHOP Class") . Note: after this call, other existing Channel objects in this CHOP may no longer be valid.
