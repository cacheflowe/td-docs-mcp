...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Ncam CHOP](https://docs.derivative.ca/Ncam_CHOP "Ncam CHOP").
