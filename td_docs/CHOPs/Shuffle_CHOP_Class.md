---
url: https://docs.derivative.ca/ShuffleCHOP_Class
category: CHOPs
title: ShuffleCHOP_Class
---

# shuffleCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Shuffle CHOP](Shuffle_CHOP.md "Shuffle CHOP").
