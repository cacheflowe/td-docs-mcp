...
Retrieve from parameters alternatively using a `node.par.Customname` expression of the [Par Class](../SOPs/Par_Class.md "Par Class"), or the [Parameter Execute DAT](../DATs/Parameter_Execute_DAT.md "Parameter Execute DAT").

See the [Select CHOP](../Glossary/Select_CHOP.md "Select CHOP") for retrieving channels from the output of other CHOPs.

[parameterCHOP_Class](Parameter_CHOP_Class.md "ParameterCHOP Class")
...
- ParGroups `pargroups` - The list of pargroup names (which can include wildcards) you want to get from the OP(s). One or more pargroups, or * for all pargroups. You can also specify a "NOT" selection with an `^`. Or select the pargroup using the menu. See [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching").
...
- Rename to `renameto` - See [Pattern Replacement](../Glossary/Pattern_Replacement.md "Pattern Replacement").
