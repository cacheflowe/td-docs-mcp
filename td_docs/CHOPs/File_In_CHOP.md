...
For a complete listing of all valid formats for CHOPs, see the [File Types](../Interoperability/File_Types.md "File Types") section. The types of files that can be read into CHOPs include:
...
The same files can be output from the [RMB](../Glossary/Mouse_Click.md "Mouse Click") menu on the CHOP by selecting **Save Data Channels**.

###

Other Input Devices

For MIDI files (`.mid` or `.midi`), see the [MIDI In CHOP](MIDI_In_CHOP.md "MIDI In CHOP").

[fileinCHOP_Class](File_In_CHOP_Class.md "FileinCHOP Class")
...
Extra Information for the File In CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
