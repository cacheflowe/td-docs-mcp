...
First bring the audio signal into CHOPs using an [Audio Device In CHOP](Audio_Device_In_CHOP.md "Audio Device In CHOP"). This can then be input into the LTC In CHOP.

See [Timecode](../Interoperability/Timecode.md "Timecode") for the full integration of timecode in TouchDesigner.

See also: [LTC Out CHOP](LTC_Out_CHOP.md "LTC Out CHOP")

[ltcinCHOP_Class](LTC_In_CHOP_Class.md "LtcinCHOP Class")
...
Extra Information for the LTC In CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
