...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [EtherDream CHOP](https://docs.derivative.ca/EtherDream_CHOP "EtherDream CHOP").
