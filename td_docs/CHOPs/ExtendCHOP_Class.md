...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Extend CHOP](https://docs.derivative.ca/Extend_CHOP "Extend CHOP").
