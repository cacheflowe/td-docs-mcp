...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [DMX Out CHOP](https://docs.derivative.ca/DMX_Out_CHOP "DMX Out CHOP").
