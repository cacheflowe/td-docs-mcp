---
url: https://docs.derivative.ca/EtherdreamCHOP_Class
category: CHOPs
title: EtherdreamCHOP_Class
---

# etherdreamCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [EtherDream CHOP](EtherDream_CHOP.md "EtherDream CHOP").
