...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Pan Tilt CHOP](https://docs.derivative.ca/Pan_Tilt_CHOP "Pan Tilt CHOP").
