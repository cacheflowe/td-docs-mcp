...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [RenderStream In CHOP](https://docs.derivative.ca/RenderStream_In_CHOP "RenderStream In CHOP").
