---
url: https://docs.derivative.ca/AbletonlinkCHOP_Class
category: CHOPs
title: AbletonlinkCHOP_Class
---

# abletonlinkCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Ableton Link CHOP](../Interoperability/Ableton_Link_CHOP.md "Ableton Link CHOP").
...
# numPees - number of peers connected to the session
# tempo - the new tempo of the session

def onNumPeersChanged(dat, numPeers):
	return

def onTempoChanged(dat, tempo):
	return
```
