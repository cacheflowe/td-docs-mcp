...
If the parameter is in a [ParGroup](../Python/ParGroup_Class.md "ParGroup Class") with multiple parameters, this will only get/set the enable state of this individual parameter. In previous versions of TouchDesigner, this got/set the enable state for the entire ParGroup.
...
The [Sequence](../Python/Sequence_Class.md "Sequence Class") this parameter belongs to. None if not in a sequence.

`sequenceBlock` → `SequenceBlock | None` **(Read Only)** :
The [SequenceBlock](../Python/SequenceBlock_Class.md "SequenceBlock Class") this parameter belongs to. None if not in a sequence.
...
The [operator](../Python/OP_Class.md "OP Class") exporting to this parameter.

`exportSource` → `Channel` **(Read Only)** :

The object exporting to this parameter. Examples: [Cell](../Python/Cell_Class.md "Cell Class"), [Channel](../Python/Channel_Class.md "Channel Class") or None.
...
To evaluate an arbitrary expression string, that is not inside a parameter, see [OP](../Python/OP_Class.md "OP Class").evalExpression.
