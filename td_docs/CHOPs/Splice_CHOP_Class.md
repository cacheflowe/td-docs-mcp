---
url: https://docs.derivative.ca/SpliceCHOP_Class
category: CHOPs
title: SpliceCHOP_Class
---

# spliceCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Splice CHOP](Splice_CHOP.md "Splice CHOP").
