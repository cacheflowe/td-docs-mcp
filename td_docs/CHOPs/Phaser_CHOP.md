...
The 0-1 values can be used with the [Lookup CHOP](Lookup_CHOP.md "Lookup CHOP") to animate groups of channels.
...
See also the [OP Snippets](../Learn/OP_Snippets.md "OP Snippets").

[phaserCHOP_Class](Phaser_CHOP_Class.md "PhaserCHOP Class")
...
Extra Information for the Phaser CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
