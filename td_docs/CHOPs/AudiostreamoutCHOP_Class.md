...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio Stream Out CHOP](https://docs.derivative.ca/Audio_Stream_Out_CHOP "Audio Stream Out CHOP").
