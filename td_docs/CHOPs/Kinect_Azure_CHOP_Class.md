---
url: https://docs.derivative.ca/KinectazureCHOP_Class
category: CHOPs
title: KinectazureCHOP_Class
---

# kinectazureCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Kinect Azure CHOP](Kinect_Azure_CHOP.md "Kinect Azure CHOP").
