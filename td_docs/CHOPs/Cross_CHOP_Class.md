---
url: https://docs.derivative.ca/CrossCHOP_Class
category: CHOPs
title: CrossCHOP_Class
---

# crossCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Cross CHOP](Cross_CHOP.md "Cross CHOP").
