...
[audioparaeqCHOP_Class](Audio_Para_EQ_CHOP_Class.md "AudioparaeqCHOP Class")
...
Extra Information for the Audio Para EQ CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
