---
url: https://docs.derivative.ca/LookupCHOP_Class
category: CHOPs
title: LookupCHOP_Class
---

# lookupCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Lookup CHOP](Lookup_CHOP.md "Lookup CHOP").
