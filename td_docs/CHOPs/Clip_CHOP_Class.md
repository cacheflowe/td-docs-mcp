---
url: https://docs.derivative.ca/ClipCHOP_Class
category: CHOPs
title: ClipCHOP_Class
---

# clipCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Clip CHOP](Clip_CHOP.md "Clip CHOP").
