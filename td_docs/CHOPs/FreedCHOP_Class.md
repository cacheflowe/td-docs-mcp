---
url: https://docs.derivative.ca/FreedCHOP_Class
category: CHOPs
title: FreedCHOP_Class
---

# freedCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [FreeD CHOP](../Interoperability/FreeD_CHOP.md "FreeD CHOP").
