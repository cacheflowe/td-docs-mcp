...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [FreeD CHOP](https://docs.derivative.ca/FreeD_CHOP "FreeD CHOP").
