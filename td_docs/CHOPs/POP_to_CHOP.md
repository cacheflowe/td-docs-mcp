---
url: https://docs.derivative.ca/POP_to_CHOP
category: CHOPs
title: POP_to_CHOP
---
...
The format of the channel names is limited since you cannot have `()` or `[]` in channel names. The Name Format menu lets you choose between Basic: a simple CHOP-like format with lowercase letters with numbers following, or Precise format, where `()` is represented by _ and `[]` is represented by _ in a form that can be interpreted exactly by [CHOP to POP](../POPs/CHOP_to_POP.md "CHOP to POP") when returning channels back to POPs.
...
See also [CHOP to POP](../POPs/CHOP_to_POP.md "CHOP to POP"), [POP to TOP](../TOPs/POP_to_TOP.md "POP to TOP"), [POP to DAT](../DATs/POP_to_DAT.md "POP to DAT")

[poptoCHOP_Class](POP_to_CHOP_Class.md "PoptoCHOP Class")
...
Extra Information for the POP to CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
