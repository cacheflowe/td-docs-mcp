---
url: https://docs.derivative.ca/FileoutCHOP_Class
category: CHOPs
title: FileoutCHOP_Class
---

# fileoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [File Out CHOP](File_Out_CHOP.md "File Out CHOP").
