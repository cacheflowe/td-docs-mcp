---
url: https://docs.derivative.ca/ResampleCHOP_Class
category: CHOPs
title: ResampleCHOP_Class
---

# resampleCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Resample CHOP](Resample_CHOP.md "Resample CHOP").
