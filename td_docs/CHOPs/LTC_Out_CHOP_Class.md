---
url: https://docs.derivative.ca/LtcoutCHOP_Class
category: CHOPs
title: LtcoutCHOP_Class
---

# ltcoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [LTC Out CHOP](LTC_Out_CHOP.md "LTC Out CHOP").

## Members

`timecode` → `tdu.Timecode` **(Read Only)** :

Get a Timecode object for the timecode data representation of the LTC Out CHOP. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class").
