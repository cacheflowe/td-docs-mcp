---
url: https://docs.derivative.ca/Cross_CHOP
category: CHOPs
title: Cross_CHOP
---
...
The Cross CHOP is a multi input OP that blends between 2 inputs at a time. This is similar to a [Switch CHOP](Switch_CHOP.md "Switch CHOP") however the Cross CHOP allows for interpolation between the inputs.

[crossCHOP_Class](Cross_CHOP_Class.md "CrossCHOP Class")
...
Extra Information for the Cross CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
