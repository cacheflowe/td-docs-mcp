...
For a similar, more-abrupt effect, see the [Lag CHOP](../Glossary/Lag_CHOP.md "Lag CHOP").

The Filter CHOP can filter both motion and sound, but other CHOPs are more appropriate for filtering sound (see the [Audio Filter CHOP](Audio_Filter_CHOP.md "Audio Filter CHOP"), [Band EQ CHOP](https://docs.derivative.ca/Band_EQ_CHOP "Band EQ CHOP"), and [Parametric EQ CHOP](https://docs.derivative.ca/Parametric_EQ_CHOP "Parametric EQ CHOP")).

[filterCHOP_Class](Filter_CHOP_Class.md "FilterCHOP Class")
