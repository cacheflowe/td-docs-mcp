...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Perform CHOP](https://docs.derivative.ca/Perform_CHOP "Perform CHOP").
