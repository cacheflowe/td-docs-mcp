---
url: https://docs.derivative.ca/TimerCHOP_Class
category: CHOPs
title: TimerCHOP_Class
---

# timerCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Timer CHOP](Timer_CHOP.md "Timer CHOP").

Setting the current time in the Timer CHOP: The member `.masterSeconds` is the main clock in the Timer CHOP and can it can be set directly using python (`OP.masterSeconds = _val_`), or alternately you can use the`.goTo()` function which has more options. Both have the same effect, and you can also use `.masterFraction`, `.masterFrames` and `.masterSamples`.
...
Get the cumulative time as a Timecode Object. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class"). See `.cumulativeSeconds`.
...
Get or set the master time expressed as a Timecode Object. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class"). See `.masterSeconds`.
...
Get the playing time as a Timecode Object. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class"). See `.playingSeconds`.
...
Get the running time index as a Timecode Object. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class"). See `.runningSeconds`.
...
Get the running length as a Timecode Object. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class").
...
Get the master timecode. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class").
