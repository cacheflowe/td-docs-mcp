...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [S Curve CHOP](https://docs.derivative.ca/S_Curve_CHOP "S Curve CHOP").
