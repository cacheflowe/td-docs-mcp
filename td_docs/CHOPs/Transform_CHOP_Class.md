---
url: https://docs.derivative.ca/TransformCHOP_Class
category: CHOPs
title: TransformCHOP_Class
---

# transformCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Transform CHOP](Transform_CHOP.md "Transform CHOP").
