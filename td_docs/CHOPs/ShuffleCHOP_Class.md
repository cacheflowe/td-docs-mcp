...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Shuffle CHOP](https://docs.derivative.ca/Shuffle_CHOP "Shuffle CHOP").
