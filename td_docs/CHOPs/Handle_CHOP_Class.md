---
url: https://docs.derivative.ca/HandleCHOP_Class
category: CHOPs
title: HandleCHOP_Class
---

# handleCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Handle CHOP](Handle_CHOP.md "Handle CHOP").
