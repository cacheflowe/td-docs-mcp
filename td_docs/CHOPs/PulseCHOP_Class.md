...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Pulse CHOP](https://docs.derivative.ca/Pulse_CHOP "Pulse CHOP").
