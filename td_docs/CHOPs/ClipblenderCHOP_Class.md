...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Clip Blender CHOP](https://docs.derivative.ca/Clip_Blender_CHOP "Clip Blender CHOP").
