...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [OptiTrack In CHOP](https://docs.derivative.ca/OptiTrack_In_CHOP "OptiTrack In CHOP").
