...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Trigger CHOP](https://docs.derivative.ca/Trigger_CHOP "Trigger CHOP").
