---
url: https://docs.derivative.ca/MouseoutCHOP_Class
category: CHOPs
title: MouseoutCHOP_Class
---

# mouseoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Mouse Out CHOP](Mouse_Out_CHOP.md "Mouse Out CHOP").
