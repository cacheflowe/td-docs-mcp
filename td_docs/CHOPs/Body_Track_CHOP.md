...
[bodytrackCHOP_Class](Body_Track_CHOP_Class.md "BodytrackCHOP Class")
...
Extra Information for the CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
