---
url: https://docs.derivative.ca/PangolinCHOP_Class
category: CHOPs
title: PangolinCHOP_Class
---

# pangolinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Pangolin CHOP](Pangolin_CHOP.md "Pangolin CHOP").
