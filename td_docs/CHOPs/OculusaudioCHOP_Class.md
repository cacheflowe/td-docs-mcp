...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Oculus Audio CHOP](https://docs.derivative.ca/Oculus_Audio_CHOP "Oculus Audio CHOP").
