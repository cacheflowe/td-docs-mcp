...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio Play CHOP](https://docs.derivative.ca/Audio_Play_CHOP "Audio Play CHOP").
...
Trigger the playing of audio samples specified in an [Audio Play CHOP](https://docs.derivative.ca/Audio_Play_CHOP "Audio Play CHOP").
...
`stop(index)`→ `None`:
Stop the playing of audio samples specified in an [Audio Play CHOP](https://docs.derivative.ca/Audio_Play_CHOP "Audio Play CHOP"). Uses fadeSeconds specificed in play().
