---
url: https://docs.derivative.ca/StypeCHOP_Class
category: CHOPs
title: StypeCHOP_Class
---

# stypeCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Stype CHOP](https://docs.derivative.ca/Stype_CHOP "Stype CHOP").

## Members

`timecode` → `tdu.Timecode` **(Read Only)** :

Get a Timecode object for the timecode data representation of the last timestamped Stype packet. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class").
