...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Laser CHOP](https://docs.derivative.ca/Laser_CHOP "Laser CHOP").
