---
url: https://docs.derivative.ca/TouchinCHOP_Class
category: CHOPs
title: TouchinCHOP_Class
---

# touchinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Touch In CHOP](Touch_In_CHOP.md "Touch In CHOP").
