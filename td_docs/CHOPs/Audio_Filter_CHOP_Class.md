---
url: https://docs.derivative.ca/AudiofilterCHOP_Class
category: CHOPs
title: AudiofilterCHOP_Class
---

# audiofilterCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Filter CHOP](Audio_Filter_CHOP.md "Audio Filter CHOP").
