---
url: https://docs.derivative.ca/SelectCHOP_Class
category: CHOPs
title: SelectCHOP_Class
---

# selectCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Select CHOP](../Glossary/Select_CHOP.md "Select CHOP").
