...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [CPlusPlus CHOP](https://docs.derivative.ca/CPlusPlus_CHOP "CPlusPlus CHOP").
