---
url: https://docs.derivative.ca/Script_CHOP
category: CHOPs
title: Script_CHOP
---
...
The Script CHOP enables numPy arrays to be converted into the CHOP's channels. Also any CHOP can get its channels converted into numPy arrays. (May 2021) See `numPyArray()` in [CHOP Class](../Python/CHOP_Class.md "CHOP Class").

See also: [Script DAT](../DATs/Script_DAT.md "Script DAT"), [Script SOP](../SOPs/Script_SOP.md "Script SOP"), [Script TOP](../TOPs/Script_TOP.md "Script TOP")

[scriptCHOP_Class](Script_CHOP_Class.md "ScriptCHOP Class")
...
Extra Information for the Script CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
