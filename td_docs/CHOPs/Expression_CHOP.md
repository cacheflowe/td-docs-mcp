---
url: https://docs.derivative.ca/Expression_CHOP
category: CHOPs
title: Expression_CHOP
---
...
See also [Evaluate DAT](../DATs/Evaluate_DAT.md "Evaluate DAT") for easy evaluation of any expression.

[expressionCHOP_Class](Expression_CHOP_Class.md "ExpressionCHOP Class")
...
- Expression `expr` - The sequence of expressions used
...
Extra Information for the Expression CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
