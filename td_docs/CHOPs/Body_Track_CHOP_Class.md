---
url: https://docs.derivative.ca/BodytrackCHOP_Class
category: CHOPs
title: BodytrackCHOP_Class
---

# bodytrackCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Body Track CHOP](../Interoperability/Body_Track_CHOP.md "Body Track CHOP").
