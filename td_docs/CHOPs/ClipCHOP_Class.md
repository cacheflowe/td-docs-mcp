...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Clip CHOP](https://docs.derivative.ca/Clip_CHOP "Clip CHOP").
