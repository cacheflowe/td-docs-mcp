---
url: https://docs.derivative.ca/AudiodeviceoutCHOP_Class
category: CHOPs
title: AudiodeviceoutCHOP_Class
---

# audiodeviceoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Device Out CHOP](../Interoperability/Audio_Device_Out_CHOP.md "Audio Device Out CHOP").
