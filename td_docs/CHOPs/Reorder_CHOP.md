...
[reorderCHOP_Class](Reorder_CHOP_Class.md "ReorderCHOP Class")
...
Extra Information for the Reorder CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
