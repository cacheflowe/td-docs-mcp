...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Helios DAC CHOP](https://docs.derivative.ca/Helios_DAC_CHOP "Helios DAC CHOP").
