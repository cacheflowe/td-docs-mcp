...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Bind CHOP](https://docs.derivative.ca/Bind_CHOP "Bind CHOP").
