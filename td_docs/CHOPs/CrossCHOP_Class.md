...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Cross CHOP](https://docs.derivative.ca/Cross_CHOP "Cross CHOP").
