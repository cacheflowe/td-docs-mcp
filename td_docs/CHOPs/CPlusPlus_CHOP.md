---
url: https://docs.derivative.ca/CPlusPlus_CHOP
category: CHOPs
title: CPlusPlus_CHOP
---
...
[cplusplusCHOP_Class](https://docs.derivative.ca/CplusplusCHOP_Class "CplusplusCHOP Class")
...
- Unload Plugin `unloadplugin` - When this parameter goes above 1, it will delete the instance of the class created by the plugin and unload the plugin. If multiple CHOPs have loaded the same plugin, they will all need to unload it to release the file.
...
Extra Information for the CPlusPlus CHOP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
