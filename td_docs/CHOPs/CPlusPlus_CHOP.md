...
[cplusplusCHOP_Class](CPlusPlus_CHOP_Class.md "CplusplusCHOP Class")
...
Extra Information for the CPlusPlus CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
