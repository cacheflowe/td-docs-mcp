---
url: https://docs.derivative.ca/FeedbackCHOP_Class
category: CHOPs
title: FeedbackCHOP_Class
---

# feedbackCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Feedback CHOP](Feedback_CHOP.md "Feedback CHOP").
