...
# audiondiCHOP Class
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio NDI CHOP](https://docs.derivative.ca/Audio_NDI_CHOP "Audio NDI CHOP").
