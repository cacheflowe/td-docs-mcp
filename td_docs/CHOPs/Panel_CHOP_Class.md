---
url: https://docs.derivative.ca/PanelCHOP_Class
category: CHOPs
title: PanelCHOP_Class
---

# panelCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Panel CHOP](Panel_CHOP.md "Panel CHOP").
