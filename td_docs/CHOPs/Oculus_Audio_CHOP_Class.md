---
url: https://docs.derivative.ca/OculusaudioCHOP_Class
category: CHOPs
title: OculusaudioCHOP_Class
---

# oculusaudioCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Oculus Audio CHOP](Oculus_Audio_CHOP.md "Oculus Audio CHOP").
