---
url: https://docs.derivative.ca/ClockCHOP_Class
category: CHOPs
title: ClockCHOP_Class
---

# clockCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Clock CHOP](Clock_CHOP.md "Clock CHOP").
