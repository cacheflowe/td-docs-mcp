...
See [Clip Blender CHOP](Clip_Blender_CHOP.md "Clip Blender CHOP").

[clipCHOP_Class](Clip_CHOP_Class.md "ClipCHOP Class")
...
Extra Information for the Clip CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
