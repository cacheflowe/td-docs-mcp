---
url: https://docs.derivative.ca/Clip_CHOP
category: CHOPs
title: Clip_CHOP
---
...
See [Clip Blender CHOP](https://docs.derivative.ca/Clip_Blender_CHOP "Clip Blender CHOP").
[clipCHOP_Class](https://docs.derivative.ca/ClipCHOP_Class "ClipCHOP Class")

## Parameters - Clip Page
- Rule DAT `rdat` -
...
## Info CHOP Channels
Extra Information for the Clip CHOP can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
