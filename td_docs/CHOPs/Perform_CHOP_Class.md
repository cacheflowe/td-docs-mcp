---
url: https://docs.derivative.ca/PerformCHOP_Class
category: CHOPs
title: PerformCHOP_Class
---

# performCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Perform CHOP](Perform_CHOP.md "Perform CHOP").
