---
url: https://docs.derivative.ca/Timecode_CHOP
category: CHOPs
title: Timecode_CHOP
---
...
The Timecode CHOP generates [Timecode](../Interoperability/Timecode.md "Timecode") data (channels, a `.timecode` python object and other python members). Its Mode menu provides a variety of ways to get, set and generate timecode through its parameters, including being driven from a timecode string, a set of channels, or other OPs that have timecode such as video input devices. You can also set timecode with python functions.

The timecode data is output as both channel data in the CHOP, and as a [Timecode object](../TOPs/Timecode_Class.md "Timecode Class") via its [`.timecode` member](Timecode_CHOP_Class.md#timecode "TimecodeCHOP Class") in Python.
...
See also: [Timecode](../Interoperability/Timecode.md "Timecode"), [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class") and the OP Snippets for the Timecode CHOP.

[timecodeCHOP_Class](Timecode_CHOP_Class.md "TimecodeCHOP Class")
...
- Mode `mode` - ⊞ - The source used for generating the timecode
  ...
  * Timecode Object `timecodeobj` - Generates the timecode from a [timecode object](../TOPs/Timecode_Class.md "Timecode Class").
  ...
  * OP Reference `op` - Generates the timecode from an OP with a timecode Python member, eg. [MoviefileinTOP_Class](../TOPs/Movie_File_In_TOP_Class.md "MoviefileinTOP Class").
...
- Timecode Object `timecodeobj` - A [timecode object](../TOPs/Timecode_Class.md "Timecode Class").
- CHOP `chop` - A CHOP reference which contains some or all of the following channels: negative, hour, minute, second, frame.
- OP `op` - An OP reference that contains a timecode Python member: eg. [MoviefileinTOP_Class](../TOPs/Movie_File_In_TOP_Class.md "MoviefileinTOP Class").
- Custom Length `customlength` - ⊞ - If set to "By Value", then the Length parameter is used. If set to "By Timecode", then the Length Timecode Object is used. If set to "Off", then the default length will be 23:59:59:ff-1 for a SMPTE timecode and 99:59:59:ff-1 otherwise.
  ...
  * By Timecode Object `timecodeobj` - When selected, set the custom length from a [timecode object](../TOPs/Timecode_Class.md "Timecode Class") using the Length Timecode Object parameter.
...
- Length Units `lengthunits` - ⊞ - The unit of the custom length.
  ...
  * F `frames` -
  * S `seconds` -
- Length Timecode Object `lengthtimecodeobj` - Specifies the custom length as a [timecode object](../TOPs/Timecode_Class.md "Timecode Class").
