---
url: https://docs.derivative.ca/LaserCHOP_Class
category: CHOPs
title: LaserCHOP_Class
---

# laserCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Laser CHOP](Laser_CHOP.md "Laser CHOP").
