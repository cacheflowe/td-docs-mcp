---
url: https://docs.derivative.ca/ImportselectCHOP_Class
category: CHOPs
title: ImportselectCHOP_Class
---

# importselectCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Import Select CHOP](Import_Select_CHOP.md "Import Select CHOP").
