---
url: https://docs.derivative.ca/SharedmeminCHOP_Class
category: CHOPs
title: SharedmeminCHOP_Class
---

# sharedmeminCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Shared Mem In CHOP](Shared_Mem_In_CHOP.md "Shared Mem In CHOP").
