---
url: https://docs.derivative.ca/DattoCHOP_Class
category: CHOPs
title: DattoCHOP_Class
---

# dattoCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [DAT to CHOP](DAT_to_CHOP.md "DAT to CHOP").
