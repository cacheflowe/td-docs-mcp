---
url: https://docs.derivative.ca/SoptoCHOP_Class
category: CHOPs
title: SoptoCHOP_Class
---

# soptoCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [SOP to CHOP](SOP_to_CHOP.md "SOP to CHOP").
