...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Touch Out CHOP](https://docs.derivative.ca/Touch_Out_CHOP "Touch Out CHOP").
