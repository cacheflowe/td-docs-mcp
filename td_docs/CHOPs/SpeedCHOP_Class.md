...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Speed CHOP](https://docs.derivative.ca/Speed_CHOP "Speed CHOP").
