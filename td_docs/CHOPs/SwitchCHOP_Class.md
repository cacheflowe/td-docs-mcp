...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Switch CHOP](https://docs.derivative.ca/Switch_CHOP "Switch CHOP").
