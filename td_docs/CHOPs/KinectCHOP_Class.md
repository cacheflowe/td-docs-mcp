...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Kinect CHOP](https://docs.derivative.ca/Kinect_CHOP "Kinect CHOP").
