...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Transform XYZ CHOP](https://docs.derivative.ca/Transform_XYZ_CHOP "Transform XYZ CHOP").
