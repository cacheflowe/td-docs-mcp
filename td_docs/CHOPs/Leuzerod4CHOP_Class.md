...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Leuze ROD4 CHOP](https://docs.derivative.ca/Leuze_ROD4_CHOP "Leuze ROD4 CHOP").
