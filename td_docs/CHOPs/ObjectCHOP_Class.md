...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Object CHOP](https://docs.derivative.ca/Object_CHOP "Object CHOP").
