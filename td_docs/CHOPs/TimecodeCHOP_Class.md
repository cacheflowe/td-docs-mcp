...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Timecode CHOP](https://docs.derivative.ca/Timecode_CHOP "Timecode CHOP").


## Members
`timecode` → **(Read Only)** :
Get a Timecode object representing the timecode data of the Timecode CHOP. See [Timecode Class](https://docs.derivative.ca/Timecode_Class "Timecode Class").
## Methods
