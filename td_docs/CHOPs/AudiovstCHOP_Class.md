...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio VST CHOP](https://docs.derivative.ca/Audio_VST_CHOP "Audio VST CHOP").
