---
url: https://docs.derivative.ca/Ableton_Link_CHOP
category: CHOPs
title: Ableton_Link_CHOP
---
...
The full support of the Ableton Live system is [TDAbleton](../Interoperability/TDAbleton.md "TDAbleton"), a group of components that give you access to Ableton Songs, Tracks, Chains, Parameters and MIDI.
...
[abletonlinkCHOP_Class](Ableton_Link_CHOP_Class.md "AbletonlinkCHOP Class")
...
- Tempo `tempo` - Outputs the current tempo (also known as BPM).
- Beats `beats` - Outputs the total number of beats.
...
Extra Information for the Ableton Link CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
