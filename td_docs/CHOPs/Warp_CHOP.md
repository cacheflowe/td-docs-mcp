...
[warpCHOP_Class](Warp_CHOP_Class.md "WarpCHOP Class")
...
Extra Information for the Warp CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
