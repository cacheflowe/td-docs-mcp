---
url: https://docs.derivative.ca/PipeoutCHOP_Class
category: CHOPs
title: PipeoutCHOP_Class
---

# pipeoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Pipe Out CHOP](Pipe_Out_CHOP.md "Pipe Out CHOP").
...
# me - this DAT
#
# pipeoutOp - the OP which is cooking
# message - the received message

def onSend(pipeoutOp, message):
	return
```
