...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Attribute CHOP](https://docs.derivative.ca/Attribute_CHOP "Attribute CHOP").
