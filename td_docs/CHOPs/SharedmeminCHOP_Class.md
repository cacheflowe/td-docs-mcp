...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Shared Mem In CHOP](https://docs.derivative.ca/Shared_Mem_In_CHOP "Shared Mem In CHOP").
