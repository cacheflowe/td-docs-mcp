---
url: https://docs.derivative.ca/ConstantCHOP_Class
category: CHOPs
title: ConstantCHOP_Class
---

# constantCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Constant CHOP](Constant_CHOP.md "Constant CHOP").
