...
For a similar, less-abrupt effect, see the [Filter CHOP](../Glossary/Filter_CHOP.md "Filter CHOP").

[lagCHOP_Class](Lag_CHOP_Class.md "LagCHOP Class")
...
Extra Information for the Lag CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
