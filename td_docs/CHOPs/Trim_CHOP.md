...
See also [Splice CHOP](Splice_CHOP.md "Splice CHOP"), [Delete CHOP](Delete_CHOP.md "Delete CHOP"), [Select CHOP](../Glossary/Select_CHOP.md "Select CHOP")

[trimCHOP_Class](Trim_CHOP_Class.md "TrimCHOP Class")
...
See the [Extend CHOP](Extend_CHOP.md "Extend CHOP") for more details on t
...
Extra Information for the Trim CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
