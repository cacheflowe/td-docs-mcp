---
url: https://docs.derivative.ca/MidiinmapCHOP_Class
category: CHOPs
title: MidiinmapCHOP_Class
---

# midiinmapCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [MIDI In Map CHOP](MIDI_In_Map_CHOP.md "MIDI In Map CHOP").
