---
url: https://docs.derivative.ca/Ncam_CHOP
category: CHOPs
title: Ncam_CHOP
---
...
The Ncam CHOP receives camera tracking data from an external [Ncam Reality system](https://www.ncam-tech.com/) for use in virtual production. The data is received over a network using the TCP protocol and includes information on the camera's position, orientation and optical properties. This data can be used in a [Camera COMP](../Glossary/Camera_COMP.md "Camera COMP") to render content from a virtual environment that is synced to the movement of a physical camera. An [Ncam TOP](../TOPs/Ncam_TOP.md "Ncam TOP") can also be used to receive image data from the camera and to composite it with the rendered content.

For additional tracking solutions, see the [Stype CHOP](https://docs.derivative.ca/Stype_CHOP "Stype CHOP") and [FreeD CHOP](../Interoperability/FreeD_CHOP.md "FreeD CHOP").

[ncamCHOP_Class](Ncam_CHOP_Class.md "NcamCHOP Class")
...
Extra Information for the Ncam CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
