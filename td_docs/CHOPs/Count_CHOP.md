---
url: https://docs.derivative.ca/Count_CHOP
category: CHOPs
title: Count_CHOP
---
...
[countCHOP_Class](Count_CHOP_Class.md "CountCHOP Class")
...
- Reset `reset` - When On resets the channel(s) to the Reset Value. The Count CHOP will only begin counting again when Reset is Off.
...
Extra Information for the Count CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
