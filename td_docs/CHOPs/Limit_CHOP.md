---
url: https://docs.derivative.ca/Limit_CHOP
category: CHOPs
title: Limit_CHOP
---
...
[limitCHOP_Class](Limit_CHOP_Class.md "LimitCHOP Class")
...
- Normalize `norm` - Scale and offset the channel so that it lies between -1 and +1. The Normalize function does not work with [Time Slicing](../Glossary/Time_Slicing.md "Time Slicing") on.
...
Extra Information for the Limit CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
