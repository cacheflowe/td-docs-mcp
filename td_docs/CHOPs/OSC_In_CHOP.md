...
See also [OSC In DAT](../DATs/OSC_In_DAT.md "OSC In DAT"), [OSC Out CHOP](OSC_Out_CHOP.md "OSC Out CHOP"), [iOS and OSC](https://docs.derivative.ca/IOS_and_OSC "IOS and OSC"), [Touch In CHOP](Touch_In_CHOP.md "Touch In CHOP").
...
[oscinCHOP_Class](OSC_In_CHOP_Class.md "OscinCHOP Class")
...
Extra Information for the OSC In CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
