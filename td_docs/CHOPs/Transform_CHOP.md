...
[transformCHOP_Class](Transform_CHOP_Class.md "TransformCHOP Class")
...
Extra Information for the Transform CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
