---
url: https://docs.derivative.ca/CycleCHOP_Class
category: CHOPs
title: CycleCHOP_Class
---

# cycleCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Cycle CHOP](Cycle_CHOP.md "Cycle CHOP").
