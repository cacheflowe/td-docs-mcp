...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [FreeD Out CHOP](https://docs.derivative.ca/FreeD_Out_CHOP "FreeD Out CHOP").
