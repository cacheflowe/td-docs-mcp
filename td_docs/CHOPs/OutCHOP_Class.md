...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Out CHOP](https://docs.derivative.ca/Out_CHOP "Out CHOP").
