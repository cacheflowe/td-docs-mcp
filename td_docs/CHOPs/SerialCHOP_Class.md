...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Serial CHOP](https://docs.derivative.ca/Serial_CHOP "Serial CHOP").
