---
url: https://docs.derivative.ca/LimitCHOP_Class
category: CHOPs
title: LimitCHOP_Class
---

# limitCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Limit CHOP](Limit_CHOP.md "Limit CHOP").
