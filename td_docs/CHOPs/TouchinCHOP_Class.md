...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Touch In CHOP](https://docs.derivative.ca/Touch_In_CHOP "Touch In CHOP").
