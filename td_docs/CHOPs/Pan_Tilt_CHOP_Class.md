---
url: https://docs.derivative.ca/PantiltCHOP_Class
category: CHOPs
title: PantiltCHOP_Class
---

# pantiltCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Pan Tilt CHOP](Pan_Tilt_CHOP.md "Pan Tilt CHOP").
