---
url: https://docs.derivative.ca/StypeoutCHOP_Class
category: CHOPs
title: StypeoutCHOP_Class
---

# stypeoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Stype Out CHOP](Stype_Out_CHOP.md "Stype Out CHOP").
