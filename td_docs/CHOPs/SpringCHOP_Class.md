...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Spring CHOP](https://docs.derivative.ca/Spring_CHOP "Spring CHOP").
