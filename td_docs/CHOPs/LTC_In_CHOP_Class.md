---
url: https://docs.derivative.ca/LtcinCHOP_Class
category: CHOPs
title: LtcinCHOP_Class
---

# ltcinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [LTC In CHOP](../Interoperability/LTC_In_CHOP.md "LTC In CHOP").

## Members

`timecode` → `tdu.Timecode` **(Read Only)** :

Get a Timecode object for the timecode data representation of the LTC In CHOP. See [Timecode Class](../TOPs/Timecode_Class.md "Timecode Class").
