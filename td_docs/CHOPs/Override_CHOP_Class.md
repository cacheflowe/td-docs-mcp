---
url: https://docs.derivative.ca/OverrideCHOP_Class
category: CHOPs
title: OverrideCHOP_Class
---

# overrideCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Override CHOP](Override_CHOP.md "Override CHOP").
