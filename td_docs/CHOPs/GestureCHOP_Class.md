...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Gesture CHOP](https://docs.derivative.ca/Gesture_CHOP "Gesture CHOP").
