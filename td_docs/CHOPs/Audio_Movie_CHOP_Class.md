---
url: https://docs.derivative.ca/AudiomovieCHOP_Class
category: CHOPs
title: AudiomovieCHOP_Class
---

# audiomovieCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Movie CHOP](Audio_Movie_CHOP.md "Audio Movie CHOP").
