...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Beat CHOP](https://docs.derivative.ca/Beat_CHOP "Beat CHOP").
