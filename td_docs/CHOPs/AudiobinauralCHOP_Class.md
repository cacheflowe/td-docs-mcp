...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio Binaural CHOP](https://docs.derivative.ca/Audio_Binaural_CHOP "Audio Binaural CHOP").
