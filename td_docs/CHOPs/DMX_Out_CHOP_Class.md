---
url: https://docs.derivative.ca/DmxoutCHOP_Class
category: CHOPs
title: DmxoutCHOP_Class
---

# dmxoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [DMX Out CHOP](DMX_Out_CHOP.md "DMX Out CHOP").
