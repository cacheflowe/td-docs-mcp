---
url: https://docs.derivative.ca/AudiospectrumCHOP_Class
category: CHOPs
title: AudiospectrumCHOP_Class
---

# audiospectrumCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Spectrum CHOP](Audio_Spectrum_CHOP.md "Audio Spectrum CHOP").
