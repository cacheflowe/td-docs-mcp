---
url: https://docs.derivative.ca/AudiofileoutCHOP_Class
category: CHOPs
title: AudiofileoutCHOP_Class
---

# audiofileoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio File Out CHOP](Audio_File_Out_CHOP.md "Audio File Out CHOP").

## Members

`fileSuffix` → **(Read Only)** :

Returns the generated file suffix. It will be generated based on the values of Unique Suffix, N, and the file extension.
