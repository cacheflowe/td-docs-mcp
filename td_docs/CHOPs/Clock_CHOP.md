---
url: https://docs.derivative.ca/Clock_CHOP
category: CHOPs
title: Clock_CHOP
---
...
[clockCHOP_Class](Clock_CHOP_Class.md "ClockCHOP Class")
...
Extra Information for the Clock CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
