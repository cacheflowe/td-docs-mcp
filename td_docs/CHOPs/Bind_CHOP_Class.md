---
url: https://docs.derivative.ca/BindCHOP_Class
category: CHOPs
title: BindCHOP_Class
---

# bindCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Bind CHOP](Bind_CHOP.md "Bind CHOP").
