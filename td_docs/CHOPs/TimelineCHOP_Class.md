...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Timeline CHOP](https://docs.derivative.ca/Timeline_CHOP "Timeline CHOP").


## Members
`timecode` → `tdu.Timecode` **(Read Only)** :
Get a Timecode object for the timecode data representation of the current timeline frame. See [Timecode Class](https://docs.derivative.ca/Timecode_Class "Timecode Class").
## Methods
