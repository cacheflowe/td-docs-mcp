---
url: https://docs.derivative.ca/RenderstreaminCHOP_Class
category: CHOPs
title: RenderstreaminCHOP_Class
---

# renderstreaminCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [RenderStream In CHOP](RenderStream_In_CHOP.md "RenderStream In CHOP").

## Members

`cameraTransform` → **(Read Only)** :

Gets the camera transform matrix for the stream. This should be referenced in the 'Xform Matrix/CHOP/DAT' parameter of the Camera COMP.

`projection` → **(Read Only)** :

Gets the projection matrix for the stream. This should be referenced in the 'Proj Matrix/CHOP/DAT' parameter of the Camera COMP, with the 'Projection' set to 'Custom Projection Matrix'.
