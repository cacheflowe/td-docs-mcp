---
url: https://docs.derivative.ca/RenderpickCHOP_Class
category: CHOPs
title: RenderpickCHOP_Class
---

# renderpickCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Render Pick CHOP](Render_Pick_CHOP.md "Render Pick CHOP").

## Members

`pickedSOP` → `OP` **(Read Only)** :

The [SOP](../SOPs/SOP_Class.md "SOP Class") that was last picked.
