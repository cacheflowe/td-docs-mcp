...
[fileoutCHOP_Class](File_Out_CHOP_Class.md "FileoutCHOP Class")
...
Extra Information for the File Out CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
