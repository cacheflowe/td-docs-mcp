...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Sequencer CHOP](https://docs.derivative.ca/Sequencer_CHOP "Sequencer CHOP").
