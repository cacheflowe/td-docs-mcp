...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Feedback CHOP](https://docs.derivative.ca/Feedback_CHOP "Feedback CHOP").
