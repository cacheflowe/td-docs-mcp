...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Null CHOP](https://docs.derivative.ca/Null_CHOP "Null CHOP").
