...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [OpenVR CHOP](https://docs.derivative.ca/OpenVR_CHOP "OpenVR CHOP").
