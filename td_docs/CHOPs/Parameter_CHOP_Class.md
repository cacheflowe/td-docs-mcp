---
url: https://docs.derivative.ca/ParameterCHOP_Class
category: CHOPs
title: ParameterCHOP_Class
---

# parameterCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Parameter CHOP](Parameter_CHOP.md "Parameter CHOP").
