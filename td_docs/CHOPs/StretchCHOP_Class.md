...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Stretch CHOP](https://docs.derivative.ca/Stretch_CHOP "Stretch CHOP").
