---
url: https://docs.derivative.ca/AudiondiCHOP_Class
category: CHOPs
title: AudiondiCHOP_Class
---

# audiondiCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio NDI CHOP](Audio_NDI_CHOP.md "Audio NDI CHOP").
