...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Keyboard In CHOP](https://docs.derivative.ca/Keyboard_In_CHOP "Keyboard In CHOP").
