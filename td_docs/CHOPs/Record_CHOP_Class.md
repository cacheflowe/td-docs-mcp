---
url: https://docs.derivative.ca/RecordCHOP_Class
category: CHOPs
title: RecordCHOP_Class
---

# recordCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Record CHOP](Record_CHOP.md "Record CHOP").
