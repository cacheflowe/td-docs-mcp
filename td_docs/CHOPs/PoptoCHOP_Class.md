...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [POP to CHOP](https://docs.derivative.ca/POP_to_CHOP "POP to CHOP").
