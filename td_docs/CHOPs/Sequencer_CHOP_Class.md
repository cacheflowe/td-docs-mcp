---
url: https://docs.derivative.ca/SequencerCHOP_Class
category: CHOPs
title: SequencerCHOP_Class
---

# sequencerCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Sequencer CHOP](Sequencer_CHOP.md "Sequencer CHOP").
