---
url: https://docs.derivative.ca/MouseinCHOP_Class
category: CHOPs
title: MouseinCHOP_Class
---

# mouseinCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Mouse In CHOP](Mouse_In_CHOP.md "Mouse In CHOP").
