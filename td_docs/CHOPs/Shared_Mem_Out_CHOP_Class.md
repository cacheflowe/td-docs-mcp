---
url: https://docs.derivative.ca/SharedmemoutCHOP_Class
category: CHOPs
title: SharedmemoutCHOP_Class
---

# sharedmemoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Shared Mem Out CHOP](Shared_Mem_Out_CHOP.md "Shared Mem Out CHOP").
