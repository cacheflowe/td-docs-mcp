---
url: https://docs.derivative.ca/SerialCHOP_Class
category: CHOPs
title: SerialCHOP_Class
---

# serialCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Serial CHOP](Serial_CHOP.md "Serial CHOP").
