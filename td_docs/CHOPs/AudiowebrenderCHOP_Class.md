...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Audio Web Render CHOP](https://docs.derivative.ca/Audio_Web_Render_CHOP "Audio Web Render CHOP").
