---
url: https://docs.derivative.ca/AudiostreamoutCHOP_Class
category: CHOPs
title: AudiostreamoutCHOP_Class
---

# audiostreamoutCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Audio Stream Out CHOP](Audio_Stream_Out_CHOP.md "Audio Stream Out CHOP").
