---
url: https://docs.derivative.ca/NcamCHOP_Class
category: CHOPs
title: NcamCHOP_Class
---

# ncamCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Ncam CHOP](Ncam_CHOP.md "Ncam CHOP").
