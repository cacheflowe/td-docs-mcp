---
url: https://docs.derivative.ca/PoptoCHOP_Class
category: CHOPs
title: PoptoCHOP_Class
---

# poptoCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [POP to CHOP](POP_to_CHOP.md "POP to CHOP").
