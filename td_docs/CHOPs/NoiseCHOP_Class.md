...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Noise CHOP](https://docs.derivative.ca/Noise_CHOP "Noise CHOP").
