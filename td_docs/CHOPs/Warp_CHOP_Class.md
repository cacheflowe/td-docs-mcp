---
url: https://docs.derivative.ca/WarpCHOP_Class
category: CHOPs
title: WarpCHOP_Class
---

# warpCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Warp CHOP](Warp_CHOP.md "Warp CHOP").
