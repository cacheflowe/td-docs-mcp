...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [MIDI In CHOP](https://docs.derivative.ca/MIDI_In_CHOP "MIDI In CHOP").


## Members
`timecode` → `tdu.Timecode` **(Read Only)** :
Get a Timecode object representation of the last set of quarter frame messages. See [Timecode Class](https://docs.derivative.ca/Timecode_Class "Timecode Class").
## Methods
