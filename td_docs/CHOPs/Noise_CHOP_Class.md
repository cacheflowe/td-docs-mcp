---
url: https://docs.derivative.ca/NoiseCHOP_Class
category: CHOPs
title: NoiseCHOP_Class
---

# noiseCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Noise CHOP](Noise_CHOP.md "Noise CHOP").
