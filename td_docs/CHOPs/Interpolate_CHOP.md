---
url: https://docs.derivative.ca/Interpolate_CHOP
category: CHOPs
title: Interpolate_CHOP
---
...
The Interpolate CHOP treats its multiple-inputs as keyframes and interpolates between them. The inputs are usually single-frame CHOP channels like those produced by a [Constant CHOP](Constant_CHOP.md "Constant CHOP"). The Interpolate CHOP first sorts the input CHOPs in time (without shifting them) and interpolates between them to fill the gaps.
...
[interpolateCHOP_Class](Interpolate_CHOP_Class.md "InterpolateCHOP Class")
...
Extra Information for the Interpolate CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
