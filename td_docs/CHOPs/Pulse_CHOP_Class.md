---
url: https://docs.derivative.ca/PulseCHOP_Class
category: CHOPs
title: PulseCHOP_Class
---

# pulseCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Pulse CHOP](Pulse_CHOP.md "Pulse CHOP").
