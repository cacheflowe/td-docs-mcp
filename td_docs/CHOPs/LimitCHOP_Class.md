...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Limit CHOP](https://docs.derivative.ca/Limit_CHOP "Limit CHOP").
