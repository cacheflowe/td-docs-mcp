...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [DAT to CHOP](https://docs.derivative.ca/DAT_to_CHOP "DAT to CHOP").


## Members
`inputCell` → `Cell` **(Read Only)** :
The current input [cell](https://docs.derivative.ca/Cell_Class "Cell Class") being evaluated. From the [cell](https://docs.derivative.ca/Cell_Class "Cell Class") you can get its row, column and value. e.g. me.inputCell.val or use the specific members listed below.
...
The current input [DAT](https://docs.derivative.ca/DAT_Class "DAT Class") being evaluated.
## Methods
