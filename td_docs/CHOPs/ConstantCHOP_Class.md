...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Constant CHOP](https://docs.derivative.ca/Constant_CHOP "Constant CHOP").
