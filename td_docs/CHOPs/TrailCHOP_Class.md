...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Trail CHOP](https://docs.derivative.ca/Trail_CHOP "Trail CHOP").
