...
CHOPs like the [Lag CHOP](../Glossary/Lag_CHOP.md "Lag CHOP") and [Filter CHOP](../Glossary/Filter_CHOP.md "Filter CHOP") look back in time (iterate) internal to the CHOP, but sometimes the output of a chain of CHOPs is needed as the input of the same chain one frame later.
...
[feedbackCHOP_Class](Feedback_CHOP_Class.md "FeedbackCHOP Class")
...
Extra Information for the Feedback CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
