...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Replace CHOP](https://docs.derivative.ca/Replace_CHOP "Replace CHOP").
