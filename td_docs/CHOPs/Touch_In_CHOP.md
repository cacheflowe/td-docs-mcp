---
url: https://docs.derivative.ca/Touch_In_CHOP
category: CHOPs
title: Touch_In_CHOP
---
...
The data is received as time slices, and can be used to eliminate frame dropping if the sender or receiver is not running at its target frame rate. See [Time Slicing](../Glossary/Time_Slicing.md "Time Slicing") and the [Time Slice CHOP](Time_Slice_CHOP.md "Time Slice CHOP"). Can also be run non-time sliced to receive full channel data.
...
See also: [OSC In CHOP](../Interoperability/OSC_In_CHOP.md "OSC In CHOP")

[touchinCHOP_Class](Touch_In_CHOP_Class.md "TouchinCHOP Class")
