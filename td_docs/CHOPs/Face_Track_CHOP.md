...
[facetrackCHOP_Class](Face_Track_CHOP_Class.md "FacetrackCHOP Class")
...
Extra Information for the Face Track CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
