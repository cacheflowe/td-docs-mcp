...
The Shared Mem Out CHOP sends CHOPs to a shared memory segment that is attached to a [Shared Mem In CHOP](Shared_Mem_In_CHOP.md "Shared Mem In CHOP") in another process or the same process.

See [Using Shared Memory in TouchDesigner](https://docs.derivative.ca/Using_Shared_Memory_in_TouchDesigner "Using Shared Memory in TouchDesigner"), [Write a Shared Memory CHOP](https://docs.derivative.ca/Write_a_Shared_Memory_CHOP "Write a Shared Memory CHOP") and [Pipe Out CHOP](Pipe_Out_CHOP.md "Pipe Out CHOP").

[sharedmemoutCHOP_Class](Shared_Mem_Out_CHOP_Class.md "SharedmemoutCHOP Class")
...
Extra Information for the Shared Mem Out CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
