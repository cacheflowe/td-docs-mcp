...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Hokuyo CHOP](https://docs.derivative.ca/Hokuyo_CHOP "Hokuyo CHOP").
