...
This class inherits from the [ CHOP class](https://docs.derivative.ca/CHOP_Class "CHOP Class"). It references a specific [Delay CHOP](https://docs.derivative.ca/Delay_CHOP "Delay CHOP").
