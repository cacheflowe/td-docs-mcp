---
url: https://docs.derivative.ca/KeyframeCHOP_Class
category: CHOPs
title: KeyframeCHOP_Class
---

# keyframeCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Keyframe CHOP](Keyframe_CHOP.md "Keyframe CHOP").
