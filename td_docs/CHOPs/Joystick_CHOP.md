...
[joystickCHOP_Class](Joystick_CHOP_Class.md "JoystickCHOP Class")
...
Extra Information for the Joystick CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
