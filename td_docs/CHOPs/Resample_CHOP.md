...
Resample does a simple linear interpolation of the Time Slice in [Time Slicing](../Glossary/Time_Slicing.md "Time Slicing") mode. Only the sample rate can be changed.

[resampleCHOP_Class](Resample_CHOP_Class.md "ResampleCHOP Class")

## Parameters - Resample Page
- Method `method` - ⊞ - The resample method to apply to the channels:
  * Same Rate, New Interval `strech` - Stretches or compresses the channels like the [Stretch CHOP](Stretch_CHOP.md "Stretch CHOP").
...
Extra Information for the Resample CHOP can be accessed via an [Info CHOP](Info_CHOP.md "Info CHOP").
