---
url: https://docs.derivative.ca/ShiftCHOP_Class
category: CHOPs
title: ShiftCHOP_Class
---

# shiftCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Shift CHOP](Shift_CHOP.md "Shift CHOP").
