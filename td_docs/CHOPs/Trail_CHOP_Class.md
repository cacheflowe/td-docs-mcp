---
url: https://docs.derivative.ca/TrailCHOP_Class
category: CHOPs
title: TrailCHOP_Class
---

# trailCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [Trail CHOP](Trail_CHOP.md "Trail CHOP").
