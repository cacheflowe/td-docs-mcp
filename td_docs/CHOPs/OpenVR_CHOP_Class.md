---
url: https://docs.derivative.ca/OpenvrCHOP_Class
category: CHOPs
title: OpenvrCHOP_Class
---

# openvrCHOP Class

This class inherits from the [ CHOP class](../Python/CHOP_Class.md "CHOP Class"). It references a specific [OpenVR CHOP](OpenVR_CHOP.md "OpenVR CHOP").
...
`triggerHapticPulse(controllerIndex, analogIndex, durationMilliseconds)`→ `None`:
