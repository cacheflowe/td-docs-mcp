...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Kinect SOP](https://docs.derivative.ca/Kinect_SOP "Kinect SOP").
