---
url: https://docs.derivative.ca/FileinSOP_Class
category: SOPs
title: FileinSOP_Class
---

# fileinSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [File In SOP](File_In_SOP.md "File In SOP").
