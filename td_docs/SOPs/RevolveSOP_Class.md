...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Revolve SOP](https://docs.derivative.ca/Revolve_SOP "Revolve SOP").
