...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Polypatch SOP](https://docs.derivative.ca/Polypatch_SOP "Polypatch SOP").
