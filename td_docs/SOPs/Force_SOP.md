...
The Force SOP adds force attributes to the input metaball field that is used by either [Particle SOP](Particle_SOP.md "Particle SOP") or [Spring SOP](Spring_SOP.md "Spring SOP") as attractor or repulsion force fields. In general, force values greater than 0 cause points to be attracted, less than 0 cause points to be repelled.

[forceSOP_Class](Force_SOP_Class.md "ForceSOP Class")
...
To view the metaball field of influence, turn on the hulls display of the input metaball/s object/s. Both the [Particle SOP](Particle_SOP.md "Particle SOP") and [Spring SOP](Spring_SOP.md "Spring SOP") will display these hulls as guide geometry.
...
Extra Information for the Force SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
