...
Particles have various [Attributes](../Glossary/Attribute.md "Attribute") that regular geometry do not have, such as velocity, life expectancy and age. These attributes must be carried with each point in order to carry out the simulation.
...
[particleSOP_Class](Particle_SOP_Class.md "ParticleSOP Class")
...
**Tip:** You can also instance geometry to particles. Use a [SOP to CHOP](../CHOPs/SOP_to_CHOP.md "SOP to CHOP") to get the particle positions into CHOPs, and on the Instance page of the [Geometry COMP](../Glossary/Geometry_COMP.md "Geometry COMP") to position any geometry at each particle positions. This is by far the most efficient way of animating many copies of geometry with a particle system.
...
Extra Information for the Particle SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
