...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Boolean SOP](https://docs.derivative.ca/Boolean_SOP "Boolean SOP").
