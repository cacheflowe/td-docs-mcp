---
url: https://docs.derivative.ca/RectangleSOP_Class
category: SOPs
title: RectangleSOP_Class
---

# rectangleSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Rectangle SOP](Rectangle_SOP.md "Rectangle SOP").
