...
[fileinSOP_Class](File_In_SOP_Class.md "FileinSOP Class")
...
Extra Information for the File In SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
