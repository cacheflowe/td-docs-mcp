---
url: https://docs.derivative.ca/CurvesectSOP_Class
category: SOPs
title: CurvesectSOP_Class
---

# curvesectSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Curvesect SOP](Curvesect_SOP.md "Curvesect SOP").
