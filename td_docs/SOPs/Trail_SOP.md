...
When using a [Particle SOP](Particle_SOP.md "Particle SOP") or [Spring SOP](Spring_SOP.md "Spring SOP") as input, it is important to keep the trail increment to integer values. Otherwise, the trail will not work well.

[trailSOP_Class](Trail_SOP_Class.md "TrailSOP Class")
...
Extra Information for the Trail SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
