...
[revolveSOP_Class](Revolve_SOP_Class.md "RevolveSOP Class")
...
Extra Information for the Revolve SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
