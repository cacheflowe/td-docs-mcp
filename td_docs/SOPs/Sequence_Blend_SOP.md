...
See also [Blend SOP](Blend_SOP.md "Blend SOP") and [Switch SOP](Switch_SOP.md "Switch SOP").

[sequenceblendSOP_Class](Sequence_Blend_SOP_Class.md "SequenceblendSOP Class")
...
Extra Information for the Sequence Blend SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
