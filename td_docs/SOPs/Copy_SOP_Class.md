---
url: https://docs.derivative.ca/CopySOP_Class
category: SOPs
title: CopySOP_Class
---
...
This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Copy SOP](Copy_SOP.md "Copy SOP").

## Members

`copyIndex` → `int` **(Read Only)** :

The current copy index, beginning at zero.

`copyTotal` → `int` **(Read Only)** :

The total number of copies.

`inputPoint` → `int` **(Read Only)** :

The current [point](Point_Class.md "Point Class") being evaluated, of the template.
