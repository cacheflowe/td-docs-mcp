...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Fractal SOP](https://docs.derivative.ca/Fractal_SOP "Fractal SOP").
