...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Attribute Create SOP](https://docs.derivative.ca/Attribute_Create_SOP "Attribute Create SOP").
