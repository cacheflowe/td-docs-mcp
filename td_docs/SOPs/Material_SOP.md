...
[materialSOP_Class](Material_SOP_Class.md "MaterialSOP Class")
...
Extra Information for the Material SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
