...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Lattice SOP](https://docs.derivative.ca/Lattice_SOP "Lattice SOP").
