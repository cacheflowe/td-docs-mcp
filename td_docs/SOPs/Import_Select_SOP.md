...
[importselectSOP_Class](Import_Select_SOP_Class.md "ImportselectSOP Class")
...
Extra Information for the Import Select SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
