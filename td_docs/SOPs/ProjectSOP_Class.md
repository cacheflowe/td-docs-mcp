...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Project SOP](https://docs.derivative.ca/Project_SOP "Project SOP").
