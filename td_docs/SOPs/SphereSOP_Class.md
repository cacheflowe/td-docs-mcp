...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Sphere SOP](https://docs.derivative.ca/Sphere_SOP "Sphere SOP").
