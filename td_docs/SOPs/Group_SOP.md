...
[groupSOP_Class](Group_SOP_Class.md "GroupSOP Class")
...
See [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching") for details.
...
Extra Information for the Group SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
