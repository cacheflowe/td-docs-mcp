...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Divide SOP](https://docs.derivative.ca/Divide_SOP "Divide SOP").
