...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Subdivide SOP](https://docs.derivative.ca/Subdivide_SOP "Subdivide SOP").
