...
[filletSOP_Class](Fillet_SOP_Class.md "FilletSOP Class")

## Parameters - Page
- Group `group` - Which primitives to fillet. If blank, it fillets the entire input. Accepts patterns, as described in [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching").
...
Extra Information for the Fillet SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
