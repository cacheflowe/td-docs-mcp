...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Align SOP](https://docs.derivative.ca/Align_SOP "Align SOP").
