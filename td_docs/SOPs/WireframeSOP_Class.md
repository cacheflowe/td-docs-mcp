...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Wireframe SOP](https://docs.derivative.ca/Wireframe_SOP "Wireframe SOP").
