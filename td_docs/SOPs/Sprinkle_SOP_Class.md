---
url: https://docs.derivative.ca/SprinkleSOP_Class
category: SOPs
title: SprinkleSOP_Class
---

# sprinkleSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Sprinkle SOP](Sprinkle_SOP.md "Sprinkle SOP").
