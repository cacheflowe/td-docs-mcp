...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Sweep SOP](https://docs.derivative.ca/Sweep_SOP "Sweep SOP").


## Members
`inputVertex` → `Vertex` **(Read Only)** :
The current [vertex](https://docs.derivative.ca/Vertex_Class "Vertex Class") being evaluated, along the backbone input.
## Methods
