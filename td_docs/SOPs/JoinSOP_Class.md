...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Join SOP](https://docs.derivative.ca/Join_SOP "Join SOP").
