...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Copy SOP](https://docs.derivative.ca/Copy_SOP "Copy SOP").
...
The current [point](https://docs.derivative.ca/Point_Class "Point Class") being evaluated, of the template.
## Methods
