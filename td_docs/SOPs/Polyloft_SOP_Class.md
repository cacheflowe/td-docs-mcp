---
url: https://docs.derivative.ca/PolyloftSOP_Class
category: SOPs
title: PolyloftSOP_Class
---

# polyloftSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Polyloft SOP](Polyloft_SOP.md "Polyloft SOP").
