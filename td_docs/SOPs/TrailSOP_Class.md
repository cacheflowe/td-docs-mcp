...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Trail SOP](https://docs.derivative.ca/Trail_SOP "Trail SOP").
