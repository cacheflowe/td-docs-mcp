...
[Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching") - Deletion accepts general pattern matching when determining which attributes to delete. For example:
...
See also: [Attribute Create SOP](Attribute_Create_SOP.md "Attribute Create SOP").
...
[attributeSOP_Class](Attribute_SOP_Class.md "AttributeSOP Class")
...
Extra Information for the Attribute SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
