...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Merge SOP](https://docs.derivative.ca/Merge_SOP "Merge SOP").
