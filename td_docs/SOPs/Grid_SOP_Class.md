---
url: https://docs.derivative.ca/GridSOP_Class
category: SOPs
title: GridSOP_Class
---
...
This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Grid SOP](Grid_SOP.md "Grid SOP").
