...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Polyreduce SOP](https://docs.derivative.ca/Polyreduce_SOP "Polyreduce SOP").
