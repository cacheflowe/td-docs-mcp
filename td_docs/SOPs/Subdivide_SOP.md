...
[subdivideSOP_Class](Subdivide_SOP_Class.md "SubdivideSOP Class")
...
## Parameters - Page
- Group `subdivide` - Subset of input to use as a polygonal mesh to subdivide. Accepts patterns, as described in [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching").
...
Extra Information for the Subdivide SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
