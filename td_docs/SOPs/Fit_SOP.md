...
[fitSOP_Class](Fit_SOP_Class.md "FitSOP Class")
...
Extra Information for the Fit SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
