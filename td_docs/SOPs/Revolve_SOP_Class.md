---
url: https://docs.derivative.ca/RevolveSOP_Class
category: SOPs
title: RevolveSOP_Class
---

# revolveSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Revolve SOP](Revolve_SOP.md "Revolve SOP").
