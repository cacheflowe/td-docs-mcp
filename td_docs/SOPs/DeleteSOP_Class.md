...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Delete SOP](https://docs.derivative.ca/Delete_SOP "Delete SOP").


## Members
`inputPoint` → `int` **(Read Only)** :
The current [point](https://docs.derivative.ca/Point_Class "Point Class") being evaluated. Can only be used in the parameters for this SOP.

`inputPrim` → `int` **(Read Only)** :
The current [primitive](https://docs.derivative.ca/Prim_Class "Prim Class") being evaluated. Can only be used in the parameters for this SOP.
## Methods
