...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Rails SOP](https://docs.derivative.ca/Rails_SOP "Rails SOP").
