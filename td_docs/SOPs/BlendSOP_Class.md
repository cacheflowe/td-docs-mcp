...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Blend SOP](https://docs.derivative.ca/Blend_SOP "Blend SOP").
