...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [POP to SOP](https://docs.derivative.ca/POP_to_SOP "POP to SOP").
