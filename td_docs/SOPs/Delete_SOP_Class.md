---
url: https://docs.derivative.ca/DeleteSOP_Class
category: SOPs
title: DeleteSOP_Class
---

# deleteSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Delete SOP](Delete_SOP.md "Delete SOP").

## Members

`inputPoint` → `int` **(Read Only)** :

The current [point](Point_Class.md "Point Class") being evaluated. Can only be used in the parameters for this SOP.

`inputPrim` → `int` **(Read Only)** :

The current [primitive](../Python/Prim_Class.md "Prim Class") being evaluated. Can only be used in the parameters for this SOP.
