...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Polyspline SOP](https://docs.derivative.ca/Polyspline_SOP "Polyspline SOP").
