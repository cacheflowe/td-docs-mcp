...
[sprinkleSOP_Class](Sprinkle_SOP_Class.md "SprinkleSOP Class")
...
Extra Information for the Sprinkle SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
