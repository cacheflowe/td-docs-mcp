...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Sprite SOP](https://docs.derivative.ca/Sprite_SOP "Sprite SOP").
