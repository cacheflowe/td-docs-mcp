...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Ray SOP](https://docs.derivative.ca/Ray_SOP "Ray SOP").
