---
url: https://docs.derivative.ca/FacetrackSOP_Class
category: SOPs
title: FacetrackSOP_Class
---

# facetrackSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Face Track SOP](Face_Track_SOP.md "Face Track SOP").
