---
url: https://docs.derivative.ca/ParticleSOP_Class
category: SOPs
title: ParticleSOP_Class
---

# particleSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Particle SOP](Particle_SOP.md "Particle SOP").
...
`createParticles(num)`→ `List[Point]`:
