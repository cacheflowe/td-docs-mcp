...
[dattoSOP_Class](DAT_to_SOP_Class.md "DattoSOP Class")
...
The common columns attributes include point position `P(0) P(1) P(2)`, point weight `Pw`, the color and alpha `Cd(0) Cd(1) Cd(2) Cd(3)`, texture coordinates `uv(0) uv(1) uv(2)`, and point normal `N(0) N(1) N(2)`. See [Point Attributes](../Glossary/Attribute.md#Point_Attributes "Attribute") for a list of attributes.
...
Common attributes include the color and alpha `Cd(0) Cd(1) Cd(2) Cd(3)`, texture coordinates `uv(0) uv(1) uv(2)`, and vertex normal `N(0) N(1) N(2)`. See [Vertex Attributes](../Glossary/Attribute.md#Vertex_Attributes "Attribute") for a list of attributes.
...
Common attributes include the color and alpha `Cd(0) Cd(1) Cd(2) Cd(3)`. See [Primitive Attributes](../Glossary/Attribute.md#Primitive_Attributes "Attribute") for a list of attributes.
...
Extra Information for the DAT to SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
