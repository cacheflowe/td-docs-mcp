...
[oculusriftSOP_Class](Oculus_Rift_SOP_Class.md "OculusriftSOP Class")
...
Extra Information for the Oculus Rift SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
