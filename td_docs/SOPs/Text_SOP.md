...
The Text SOP creates text geometry from any [TrueType](http://en.wikipedia.org/wiki/TrueType) or [OpenType](http://en.wikipedia.org/wiki/OpenType) font that is installed on the system, or any TrueType/OpenType font file on disk. [Unicode](../Glossary/Unicode.md "Unicode") is supported.

See also: [Text TOP](../TOPs/Text_TOP.md "Text TOP"), [Unicode](../Glossary/Unicode.md "Unicode").

[textSOP_Class](Text_SOP_Class.md "TextSOP Class")
...
- Output `output` - ⊞ - Specify geometry output of Triangles, Closed Polygons or Open Polygons.
  ...
  * Closed Polygons (Filled Holes) `closedpolys` - The output is a set of separated closed outlines, suitable for [Laser CHOP](../CHOPs/Laser_CHOP.md "Laser CHOP"), [Extrude SOP](Extrude_SOP.md "Extrude SOP"), etc. Append a [Hole SOP](Hole_SOP.md "Hole SOP") to preserve holes properly.
  * Open Polygons `openpolys` - The output is a set of separated open outlines, suitable for the [Laser CHOP](../CHOPs/Laser_CHOP.md "Laser CHOP"), etc. Renders as a wireframe always.
...
Extra Information for the Text SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
