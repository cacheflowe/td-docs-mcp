...
[copySOP_Class](Copy_SOP_Class.md "CopySOP Class")

## Parameters - Copy Page

Specifies a subset of template primitives from which to copy onto. Accepts patterns, as described in [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching").
- Source Group `sourcegrp` - Specifies a subset of input primitives to copy from. Accepts patterns, as described in [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching").
- Template Group `templategrp` - Specifies a subset of template primitives from which to copy onto. Accepts patterns, as described in [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching").
...
- Look At `lookat` - Orients the copied geometry to lookat, or point to, the [object](../Glossary/Object.md "Object") component specified in the parameter.
...
- Param `copy0param` - Token of each stamp variable. Stamped parameters are accessible via the global `fetchStamp()` method in the [td Module](https://docs.derivative.ca/Td_Module "Td Module") in python, or `param()` in tscript. See the example, below.
...
Extra Information for the Copy SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
