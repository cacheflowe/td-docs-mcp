...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Arm SOP](https://docs.derivative.ca/Arm_SOP "Arm SOP").
