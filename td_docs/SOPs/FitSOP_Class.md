...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Fit SOP](https://docs.derivative.ca/Fit_SOP "Fit SOP").
