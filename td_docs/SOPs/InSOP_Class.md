...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [In SOP](https://docs.derivative.ca/In_SOP "In SOP").
