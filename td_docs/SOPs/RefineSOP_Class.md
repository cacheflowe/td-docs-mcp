...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Refine SOP](https://docs.derivative.ca/Refine_SOP "Refine SOP").
