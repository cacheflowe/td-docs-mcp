...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Clip SOP](https://docs.derivative.ca/Clip_SOP "Clip SOP").
