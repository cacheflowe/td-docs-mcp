---
url: https://docs.derivative.ca/SortSOP_Class
category: SOPs
title: SortSOP_Class
---
...
This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Sort SOP](Sort_SOP.md "Sort SOP").
