...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Curvesect SOP](https://docs.derivative.ca/Curvesect_SOP "Curvesect SOP").
