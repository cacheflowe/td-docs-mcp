...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Null SOP](https://docs.derivative.ca/Null_SOP "Null SOP").
