---
url: https://docs.derivative.ca/LsystemSOP_Class
category: SOPs
title: LsystemSOP_Class
---

# lsystemSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [LSystem SOP](LSystem_SOP.md "LSystem SOP").
