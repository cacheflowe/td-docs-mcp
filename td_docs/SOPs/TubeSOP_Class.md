...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Tube SOP](https://docs.derivative.ca/Tube_SOP "Tube SOP").
