---
url: https://docs.derivative.ca/BonegroupSOP_Class
category: SOPs
title: BonegroupSOP_Class
---

# bonegroupSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Bone Group SOP](Bone_Group_SOP.md "Bone Group SOP").
