...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Select SOP](https://docs.derivative.ca/Select_SOP "Select SOP").
