...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Transform SOP](https://docs.derivative.ca/Transform_SOP "Transform SOP").
