...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Superquad SOP](https://docs.derivative.ca/Superquad_SOP "Superquad SOP").
