...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [CHOP to SOP](https://docs.derivative.ca/CHOP_to_SOP "CHOP to SOP").
