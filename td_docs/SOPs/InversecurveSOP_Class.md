...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Inverse Curve SOP](https://docs.derivative.ca/Inverse_Curve_SOP "Inverse Curve SOP").
