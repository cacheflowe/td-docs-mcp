...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Object Merge SOP](https://docs.derivative.ca/Object_Merge_SOP "Object Merge SOP").
