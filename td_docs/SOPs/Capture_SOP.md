...
[captureSOP_Class](Capture_SOP_Class.md "CaptureSOP Class")
...
Extra Information for the Capture SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
