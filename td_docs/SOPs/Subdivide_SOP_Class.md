---
url: https://docs.derivative.ca/SubdivideSOP_Class
category: SOPs
title: SubdivideSOP_Class
---

# subdivideSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Subdivide SOP](Subdivide_SOP.md "Subdivide SOP").
