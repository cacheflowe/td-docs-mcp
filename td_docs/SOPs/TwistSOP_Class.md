...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Twist SOP](https://docs.derivative.ca/Twist_SOP "Twist SOP").
