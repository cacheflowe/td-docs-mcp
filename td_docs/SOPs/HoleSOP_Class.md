...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Hole SOP](https://docs.derivative.ca/Hole_SOP "Hole SOP").
