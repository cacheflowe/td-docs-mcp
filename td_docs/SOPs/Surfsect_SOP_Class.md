---
url: https://docs.derivative.ca/SurfsectSOP_Class
category: SOPs
title: SurfsectSOP_Class
---

# surfsectSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Surfsect SOP](Surfsect_SOP.md "Surfsect SOP").
