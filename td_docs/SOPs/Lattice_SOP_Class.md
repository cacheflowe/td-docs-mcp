---
url: https://docs.derivative.ca/LatticeSOP_Class
category: SOPs
title: LatticeSOP_Class
---

# latticeSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Lattice SOP](Lattice_SOP.md "Lattice SOP").
