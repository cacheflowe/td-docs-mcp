...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Point SOP](https://docs.derivative.ca/Point_SOP "Point SOP").
...
The current [point](https://docs.derivative.ca/Point_Class "Point Class") being evaluated, from the first input.

`inputPoint2` → `Point` **(Read Only)** :
The current [point](https://docs.derivative.ca/Point_Class "Point Class") being evaluated, from the second input.
