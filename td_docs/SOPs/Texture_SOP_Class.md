---
url: https://docs.derivative.ca/TextureSOP_Class
category: SOPs
title: TextureSOP_Class
---

# textureSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Texture SOP](Texture_SOP.md "Texture SOP").
