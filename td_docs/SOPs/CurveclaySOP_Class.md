...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Curveclay SOP](https://docs.derivative.ca/Curveclay_SOP "Curveclay SOP").
