...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Text SOP](https://docs.derivative.ca/Text_SOP "Text SOP").
