...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Limit SOP](https://docs.derivative.ca/Limit_SOP "Limit SOP").
