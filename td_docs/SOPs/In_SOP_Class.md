---
url: https://docs.derivative.ca/InSOP_Class
category: SOPs
title: InSOP_Class
---
...
This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [In SOP](In_SOP.md "In SOP").
