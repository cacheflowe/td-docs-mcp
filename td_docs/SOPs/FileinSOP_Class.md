...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [File In SOP](https://docs.derivative.ca/File_In_SOP "File In SOP").
