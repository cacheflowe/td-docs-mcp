...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Cache SOP](https://docs.derivative.ca/Cache_SOP "Cache SOP").
