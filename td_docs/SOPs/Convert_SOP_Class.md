---
url: https://docs.derivative.ca/ConvertSOP_Class
category: SOPs
title: ConvertSOP_Class
---

# convertSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Convert SOP](Convert_SOP.md "Convert SOP").
