---
url: https://docs.derivative.ca/PolypatchSOP_Class
category: SOPs
title: PolypatchSOP_Class
---

# polypatchSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Polypatch SOP](Polypatch_SOP.md "Polypatch SOP").
