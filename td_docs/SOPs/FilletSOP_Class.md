...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Fillet SOP](https://docs.derivative.ca/Fillet_SOP "Fillet SOP").
