...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Spring SOP](https://docs.derivative.ca/Spring_SOP "Spring SOP").
