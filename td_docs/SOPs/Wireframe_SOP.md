...
[wireframeSOP_Class](Wireframe_SOP_Class.md "WireframeSOP Class")
...
Extra Information for the Wireframe SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
