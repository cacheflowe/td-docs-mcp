---
url: https://docs.derivative.ca/InversecurveSOP_Class
category: SOPs
title: InversecurveSOP_Class
---

# inversecurveSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Inverse Curve SOP](Inverse_Curve_SOP.md "Inverse Curve SOP").
