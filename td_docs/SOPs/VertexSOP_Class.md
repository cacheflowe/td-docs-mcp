...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Vertex SOP](https://docs.derivative.ca/Vertex_SOP "Vertex SOP").
...
The current [vertex](https://docs.derivative.ca/Vertex_Class "Vertex Class") being evaluated, from the first input.

`inputVertex2` → `Vertex` **(Read Only)** :
The current [vertex](https://docs.derivative.ca/Vertex_Class "Vertex Class") being evaluated, from the second input.
## Methods
