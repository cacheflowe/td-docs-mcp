...
[profileSOP_Class](Profile_SOP_Class.md "ProfileSOP Class")
...
Extra Information for the Profile SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
