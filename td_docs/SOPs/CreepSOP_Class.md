...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Creep SOP](https://docs.derivative.ca/Creep_SOP "Creep SOP").
