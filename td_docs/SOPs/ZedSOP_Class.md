...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [ZED SOP](https://docs.derivative.ca/ZED_SOP "ZED SOP").
