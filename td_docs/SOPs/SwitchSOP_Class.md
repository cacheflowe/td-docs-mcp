...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Switch SOP](https://docs.derivative.ca/Switch_SOP "Switch SOP").
