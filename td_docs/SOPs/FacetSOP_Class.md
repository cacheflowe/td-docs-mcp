...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Facet SOP](https://docs.derivative.ca/Facet_SOP "Facet SOP").
