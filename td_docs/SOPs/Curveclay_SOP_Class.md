---
url: https://docs.derivative.ca/CurveclaySOP_Class
category: SOPs
title: CurveclaySOP_Class
---

# curveclaySOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Curveclay SOP](Curveclay_SOP.md "Curveclay SOP").
