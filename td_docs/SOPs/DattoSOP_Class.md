...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [DAT to SOP](https://docs.derivative.ca/DAT_to_SOP "DAT to SOP").
