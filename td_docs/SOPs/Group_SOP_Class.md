---
url: https://docs.derivative.ca/GroupSOP_Class
category: SOPs
title: GroupSOP_Class
---

# groupSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Group SOP](Group_SOP.md "Group SOP").

## Members

`inputPoint` → `Point` **(Read Only)** :

The current [point](Point_Class.md "Point Class") being evaluated.
