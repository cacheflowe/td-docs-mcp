---
url: https://docs.derivative.ca/PoptoSOP_Class
category: SOPs
title: PoptoSOP_Class
---

# poptoSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [POP to SOP](POP_to_SOP.md "POP to SOP").
