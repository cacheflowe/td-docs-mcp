...
You should isolate out each of the primitive bone groups using the [Delete SOP](Delete_SOP.md "Delete SOP"). Next drop down a MAT (like the [Phong MAT](../MATs/Phong_MAT.md "Phong MAT")) that supports deforms. You will need to give the MAT a few pieces of information:
...
[bonegroupSOP_Class](Bone_Group_SOP_Class.md "BonegroupSOP Class")
...
Extra Information for the Bone Group SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
