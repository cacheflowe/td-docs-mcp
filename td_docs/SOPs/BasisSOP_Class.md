...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Basis SOP](https://docs.derivative.ca/Basis_SOP "Basis SOP").
