---
url: https://docs.derivative.ca/ExtrudeSOP_Class
category: SOPs
title: ExtrudeSOP_Class
---

# extrudeSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Extrude SOP](Extrude_SOP.md "Extrude SOP").
