...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Raster SOP](https://docs.derivative.ca/Raster_SOP "Raster SOP").
