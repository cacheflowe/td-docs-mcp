...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Cap SOP](https://docs.derivative.ca/Cap_SOP "Cap SOP").
