...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Add SOP](https://docs.derivative.ca/Add_SOP "Add SOP").
