...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [LOD SOP](https://docs.derivative.ca/LOD_SOP "LOD SOP").
