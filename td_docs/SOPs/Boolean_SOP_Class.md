---
url: https://docs.derivative.ca/BooleanSOP_Class
category: SOPs
title: BooleanSOP_Class
---

# booleanSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Boolean SOP](Boolean_SOP.md "Boolean SOP").
