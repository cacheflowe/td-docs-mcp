...
[superquadSOP_Class](Superquad_SOP_Class.md "SuperquadSOP Class")

## Parameters - Page
- Primitive Type `type` - ⊞ - Select from the following types. For information on the different types, see the [Primitive](../Glossary/Primitive.md "Primitive") article. Depending on the primitive type chosen, some SOP options may not apply.
  * Polygon `poly` -
  * Mesh `mesh` -
...
- Z Exponent `expz` - The Z Exponent determines inflation / contraction in the Z axis. See the [Metaball SOP](Metaball_SOP.md "Metaball SOP") for a description of exponents.
...
Extra Information for the Superquad SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
