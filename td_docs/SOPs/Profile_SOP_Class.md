---
url: https://docs.derivative.ca/ProfileSOP_Class
category: SOPs
title: ProfileSOP_Class
---

# profileSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Profile SOP](Profile_SOP.md "Profile SOP").
