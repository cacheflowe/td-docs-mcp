...
[convertSOP_Class](Convert_SOP_Class.md "ConvertSOP Class")
...
Extra Information for the Convert SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
