...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Bridge SOP](https://docs.derivative.ca/Bridge_SOP "Bridge SOP").
