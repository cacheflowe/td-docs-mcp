...
[resampleSOP_Class](Resample_SOP_Class.md "ResampleSOP Class")

## Parameters - Page
- Group `group` - Allows you to specify which primitives or group of primitives to resample. Accepts patterns, as described in [Pattern Matching](../Glossary/Pattern_Matching.md "Pattern Matching").
...
Extra Information for the Resample SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
