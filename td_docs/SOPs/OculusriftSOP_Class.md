...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Oculus Rift SOP](https://docs.derivative.ca/Oculus_Rift_SOP "Oculus Rift SOP").
