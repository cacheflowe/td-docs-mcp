---
url: https://docs.derivative.ca/OculusriftSOP_Class
category: SOPs
title: OculusriftSOP_Class
---

# oculusriftSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Oculus Rift SOP](Oculus_Rift_SOP.md "Oculus Rift SOP").
