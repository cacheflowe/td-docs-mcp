---
url: https://docs.derivative.ca/CaptureregionSOP_Class
category: SOPs
title: CaptureregionSOP_Class
---

# captureregionSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Capture Region SOP](Capture_Region_SOP.md "Capture Region SOP").
