...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Stitch SOP](https://docs.derivative.ca/Stitch_SOP "Stitch SOP").
