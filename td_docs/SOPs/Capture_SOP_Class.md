---
url: https://docs.derivative.ca/CaptureSOP_Class
category: SOPs
title: CaptureSOP_Class
---

# captureSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Capture SOP](Capture_SOP.md "Capture SOP").
