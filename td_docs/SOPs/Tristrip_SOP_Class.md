---
url: https://docs.derivative.ca/TristripSOP_Class
category: SOPs
title: TristripSOP_Class
---

# tristripSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Tristrip SOP](Tristrip_SOP.md "Tristrip SOP").
