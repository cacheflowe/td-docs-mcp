...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Tristrip SOP](https://docs.derivative.ca/Tristrip_SOP "Tristrip SOP").
