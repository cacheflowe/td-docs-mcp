...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Trace SOP](https://docs.derivative.ca/Trace_SOP "Trace SOP").
