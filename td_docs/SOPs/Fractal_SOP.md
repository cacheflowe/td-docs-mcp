...
[fractalSOP_Class](Fractal_SOP_Class.md "FractalSOP Class")
...
Extra Information for the Fractal SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
