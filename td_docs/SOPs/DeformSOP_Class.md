...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Deform SOP](https://docs.derivative.ca/Deform_SOP "Deform SOP").
