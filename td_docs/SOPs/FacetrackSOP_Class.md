...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Face Track SOP](https://docs.derivative.ca/Face_Track_SOP "Face Track SOP").
