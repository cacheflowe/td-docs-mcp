...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [LSystem SOP](https://docs.derivative.ca/LSystem_SOP "LSystem SOP").
