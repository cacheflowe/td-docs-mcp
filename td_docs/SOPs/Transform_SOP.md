...
[transformSOP_Class](Transform_SOP_Class.md "TransformSOP Class")
...
Extra Information for the Transform SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
