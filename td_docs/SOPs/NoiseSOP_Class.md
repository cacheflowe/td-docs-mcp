...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Noise SOP](https://docs.derivative.ca/Noise_SOP "Noise SOP").
