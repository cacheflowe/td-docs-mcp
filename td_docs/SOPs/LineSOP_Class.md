...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Line SOP](https://docs.derivative.ca/Line_SOP "Line SOP").
