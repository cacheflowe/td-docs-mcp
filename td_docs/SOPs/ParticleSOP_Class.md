...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Particle SOP](https://docs.derivative.ca/Particle_SOP "Particle SOP").
