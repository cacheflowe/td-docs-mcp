...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Surfsect SOP](https://docs.derivative.ca/Surfsect_SOP "Surfsect SOP").
