...
[polyloftSOP_Class](Polyloft_SOP_Class.md "PolyloftSOP Class")
...
Extra Information for the Polyloft SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
