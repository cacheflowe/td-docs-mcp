...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Primitive SOP](https://docs.derivative.ca/Primitive_SOP "Primitive SOP").
...
The current [primitive](https://docs.derivative.ca/Prim_Class "Prim Class") being evaluated.
## Methods
