---
url: https://docs.derivative.ca/AddSOP_Class
category: SOPs
title: AddSOP_Class
---
...
This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Add SOP](Add_SOP.md "Add SOP").
