...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Sprinkle SOP](https://docs.derivative.ca/Sprinkle_SOP "Sprinkle SOP").
