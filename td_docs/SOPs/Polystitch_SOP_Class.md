---
url: https://docs.derivative.ca/PolystitchSOP_Class
category: SOPs
title: PolystitchSOP_Class
---

# polystitchSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Polystitch SOP](Polystitch_SOP.md "Polystitch SOP").
