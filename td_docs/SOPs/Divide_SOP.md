...
[divideSOP_Class](Divide_SOP_Class.md "DivideSOP Class")
...
It can also be used to divide a planar surface into smaller pieces to apply point colors using a [Point SOP](Point_SOP.md "Point SOP"). The size and location of the square divisions created by brickering is determined by the following three options.
...
Extra Information for the Divide SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
