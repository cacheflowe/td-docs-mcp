---
url: https://docs.derivative.ca/WireframeSOP_Class
category: SOPs
title: WireframeSOP_Class
---

# wireframeSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Wireframe SOP](Wireframe_SOP.md "Wireframe SOP").
