...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Group SOP](https://docs.derivative.ca/Group_SOP "Group SOP").


## Members
`inputPoint` → `Point` **(Read Only)** :
The current [point](https://docs.derivative.ca/Point_Class "Point Class") being evaluated.
