---
url: https://docs.derivative.ca/ImportselectSOP_Class
category: SOPs
title: ImportselectSOP_Class
---

# importselectSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Import Select SOP](Import_Select_SOP.md "Import Select SOP").
