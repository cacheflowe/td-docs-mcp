...
The ZED SOP uses the ZED to scan and create geometry by moving it around the room or an object of interest. To know what ZED SDK we are using, refer to the [ZED](../Interoperability/ZED.md "ZED") article.

See [ZED TOP](../TOPs/ZED_TOP.md "ZED TOP"), [ZED CHOP](../CHOPs/ZED_CHOP.md "ZED CHOP"), [ZED POP](../POPs/ZED_POP.md "ZED POP") and [ZED](../Interoperability/ZED.md "ZED").

[zedSOP_Class](ZED_SOP_Class.md "ZedSOP Class")

## Parameters - Page
- ZED TOP `zedtop` - The name of the primary [ZED TOP](../TOPs/ZED_TOP.md "ZED TOP") that is configuring the camera. The primary TOP controls which camera the SOP receives data from.
...
Extra Information for the ZED SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
...
Error fetching URL: SSL: certificate subject name '*.derivative.ca' does not match target host name '18.119.173.8'

There was a problem during the HTTP request: 0 Error

Could not get URL [https://18.119.173.8/api.php?action=query&list=categorymembers&cmtitle=Category:SOPs&format=xml&cmlimit=500](https://18.119.173.8/api.php?action=query&list=categorymembers&cmtitle=Category:SOPs&format=xml&cmlimit=500) after 3 tries.
