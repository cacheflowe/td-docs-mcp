...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [CPlusPlus SOP](https://docs.derivative.ca/CPlusPlus_SOP "CPlusPlus SOP").
