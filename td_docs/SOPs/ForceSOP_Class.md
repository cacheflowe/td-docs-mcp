...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Force SOP](https://docs.derivative.ca/Force_SOP "Force SOP").
