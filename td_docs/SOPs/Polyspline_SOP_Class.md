---
url: https://docs.derivative.ca/PolysplineSOP_Class
category: SOPs
title: PolysplineSOP_Class
---

# polysplineSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Polyspline SOP](Polyspline_SOP.md "Polyspline SOP").
