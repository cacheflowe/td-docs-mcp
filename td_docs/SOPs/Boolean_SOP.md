...
[booleanSOP_Class](Boolean_SOP_Class.md "BooleanSOP Class")
...
Extra Information for the Boolean SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
