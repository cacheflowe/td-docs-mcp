---
url: https://docs.derivative.ca/AttributeSOP_Class
category: SOPs
title: AttributeSOP_Class
---

# attributeSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Attribute SOP](Attribute_SOP.md "Attribute SOP").
