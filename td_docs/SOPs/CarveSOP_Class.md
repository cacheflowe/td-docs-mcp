...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Carve SOP](https://docs.derivative.ca/Carve_SOP "Carve SOP").
