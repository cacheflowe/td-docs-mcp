...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Torus SOP](https://docs.derivative.ca/Torus_SOP "Torus SOP").
