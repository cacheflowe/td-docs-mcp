...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Out SOP](https://docs.derivative.ca/Out_SOP "Out SOP").
