...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Sequence Blend SOP](https://docs.derivative.ca/Sequence_Blend_SOP "Sequence Blend SOP").
