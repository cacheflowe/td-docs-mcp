---
url: https://docs.derivative.ca/LinethickSOP_Class
category: SOPs
title: LinethickSOP_Class
---

# linethickSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Line Thick SOP](Line_Thick_SOP.md "Line Thick SOP").
