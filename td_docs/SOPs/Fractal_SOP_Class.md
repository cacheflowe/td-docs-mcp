---
url: https://docs.derivative.ca/FractalSOP_Class
category: SOPs
title: FractalSOP_Class
---

# fractalSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Fractal SOP](Fractal_SOP.md "Fractal SOP").
