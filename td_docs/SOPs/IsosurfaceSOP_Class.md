...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Iso Surface SOP](https://docs.derivative.ca/Iso_Surface_SOP "Iso Surface SOP").


## Members
`curPos` → **(Read Only)** :
The current [position](https://docs.derivative.ca/Position_Class "Position Class") of the surface.
## Methods
