...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Skin SOP](https://docs.derivative.ca/Skin_SOP "Skin SOP").
