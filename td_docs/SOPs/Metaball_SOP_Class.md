---
url: https://docs.derivative.ca/MetaballSOP_Class
category: SOPs
title: MetaballSOP_Class
---

# metaballSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Metaball SOP](Metaball_SOP.md "Metaball SOP").
