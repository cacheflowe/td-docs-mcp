---
url: https://docs.derivative.ca/ResampleSOP_Class
category: SOPs
title: ResampleSOP_Class
---

# resampleSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Resample SOP](Resample_SOP.md "Resample SOP").
