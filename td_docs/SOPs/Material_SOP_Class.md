---
url: https://docs.derivative.ca/MaterialSOP_Class
category: SOPs
title: MaterialSOP_Class
---

# materialSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Material SOP](Material_SOP.md "Material SOP").
