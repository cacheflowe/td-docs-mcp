...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Metaball SOP](https://docs.derivative.ca/Metaball_SOP "Metaball SOP").
