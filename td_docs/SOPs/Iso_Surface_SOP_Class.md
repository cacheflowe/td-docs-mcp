---
url: https://docs.derivative.ca/IsosurfaceSOP_Class
category: SOPs
title: IsosurfaceSOP_Class
---

# isosurfaceSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Iso Surface SOP](Iso_Surface_SOP.md "Iso Surface SOP").

## Members

`curPos` → **(Read Only)** :

The current [position](../Python/Position_Class.md "Position Class") of the surface.
