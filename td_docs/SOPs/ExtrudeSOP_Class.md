...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Extrude SOP](https://docs.derivative.ca/Extrude_SOP "Extrude SOP").
