---
url: https://docs.derivative.ca/SweepSOP_Class
category: SOPs
title: SweepSOP_Class
---

# sweepSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Sweep SOP](Sweep_SOP.md "Sweep SOP").

## Members

`inputVertex` → `Vertex` **(Read Only)** :

The current [vertex](../Python/Vertex_Class.md "Vertex Class") being evaluated, along the backbone input.
