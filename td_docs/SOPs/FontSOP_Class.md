...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Font SOP](https://docs.derivative.ca/Font_SOP "Font SOP").
