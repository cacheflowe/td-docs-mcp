---
url: https://docs.derivative.ca/DattoSOP_Class
category: SOPs
title: DattoSOP_Class
---

# dattoSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [DAT to SOP](DAT_to_SOP.md "DAT to SOP").
