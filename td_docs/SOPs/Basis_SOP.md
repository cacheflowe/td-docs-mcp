...
For more information about bases and knots see Breakpoints, Knots, and Spline Basis in the [Primitive](../Glossary/Primitive.md "Primitive") and [Spline](https://docs.derivative.ca/Spline "Spline") articles.

[basisSOP_Class](Basis_SOP_Class.md "BasisSOP Class")
...
Extra Information for the Basis SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
