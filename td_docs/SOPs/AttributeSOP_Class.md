...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Attribute SOP](https://docs.derivative.ca/Attribute_SOP "Attribute SOP").
