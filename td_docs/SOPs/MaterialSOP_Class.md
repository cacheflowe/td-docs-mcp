...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Material SOP](https://docs.derivative.ca/Material_SOP "Material SOP").
