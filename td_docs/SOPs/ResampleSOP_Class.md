...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Resample SOP](https://docs.derivative.ca/Resample_SOP "Resample SOP").
