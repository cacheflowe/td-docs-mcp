---
url: https://docs.derivative.ca/PolyreduceSOP_Class
category: SOPs
title: PolyreduceSOP_Class
---

# polyreduceSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Polyreduce SOP](Polyreduce_SOP.md "Polyreduce SOP").
