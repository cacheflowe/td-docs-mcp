...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Polystitch SOP](https://docs.derivative.ca/Polystitch_SOP "Polystitch SOP").
