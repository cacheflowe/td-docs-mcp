...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Polyloft SOP](https://docs.derivative.ca/Polyloft_SOP "Polyloft SOP").
