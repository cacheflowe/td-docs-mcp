...
[primitiveSOP_Class](Primitive_SOP_Class.md "PrimitiveSOP Class")
...
Extra Information for the Primitive SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
