...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Sort SOP](https://docs.derivative.ca/Sort_SOP "Sort SOP").
