---
url: https://docs.derivative.ca/AlembicSOP_Class
category: SOPs
title: AlembicSOP_Class
---

# alembicSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Alembic SOP](Alembic_SOP.md "Alembic SOP").
