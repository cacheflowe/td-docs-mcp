...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Bone Group SOP](https://docs.derivative.ca/Bone_Group_SOP "Bone Group SOP").
