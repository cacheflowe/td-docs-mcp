---
url: https://docs.derivative.ca/CplusplusSOP_Class
category: SOPs
title: CplusplusSOP_Class
---

# cplusplusSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [CPlusPlus SOP](CPlusPlus_SOP.md "CPlusPlus SOP").
