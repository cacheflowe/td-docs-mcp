...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Grid SOP](https://docs.derivative.ca/Grid_SOP "Grid SOP").
