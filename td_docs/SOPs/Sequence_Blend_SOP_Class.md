---
url: https://docs.derivative.ca/SequenceblendSOP_Class
category: SOPs
title: SequenceblendSOP_Class
---

# sequenceblendSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Sequence Blend SOP](Sequence_Blend_SOP.md "Sequence Blend SOP").
