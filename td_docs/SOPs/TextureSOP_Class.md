...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Texture SOP](https://docs.derivative.ca/Texture_SOP "Texture SOP").
