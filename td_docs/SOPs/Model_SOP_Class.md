---
url: https://docs.derivative.ca/ModelSOP_Class
category: SOPs
title: ModelSOP_Class
---

# modelSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Model SOP](Model_SOP.md "Model SOP").
...
Append a [poly](../Python/Poly_Class.md "Poly Class") to this SOP. Returns the appended polygon.
  ...
  * addPoints - (Keyword, Optional) If True, a new [point](Point_Class.md "Point Class") will be attached to each [vertex](../Python/Vertex_Class.md "Vertex Class"), otherwise the [vertex](../Python/Vertex_Class.md "Vertex Class") point references will need to be manually set afterwards. Use this option when creating [polygons](../Python/Poly_Class.md "Poly Class") with shared [vertices](../Python/Vertex_Class.md "Vertex Class").
...
Geometry Attributes can be added to this operator using the `create(name, default)` method of the [Attributes Class](../Python/Attributes_Class.md "Attributes Class")

```
a = n.pointAttribs.create('N')  # Normal attribute, default implied.
a = n.vertexAttribs.create('custom1', (0.0, 0.0) )  # Vertex Attribute default to (0.0, 0.0)
a = n.primAttribs.create('custom2', 1 )  # Primitive Attribute defaulting to 1
```
