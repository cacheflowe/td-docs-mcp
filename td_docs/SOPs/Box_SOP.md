...
[boxSOP_Class](Box_SOP_Class.md "BoxSOP Class")
...
- Center `t` - ⊞ - These X,Y, and Z Values determine where the center of the Box is located.
  ...
  * Y `ty` -
  * Z `tz` -
- Rotate `r` - ⊞ - These three fields rotate the Box along the X, Y, and Z axes.
  * X `rx` -
  * Y `ry` -
  * Z `rz` -
...
Extra Information for the Box SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
