...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Circle SOP](https://docs.derivative.ca/Circle_SOP "Circle SOP").
