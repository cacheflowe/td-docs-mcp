...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Magnet SOP](https://docs.derivative.ca/Magnet_SOP "Magnet SOP").
