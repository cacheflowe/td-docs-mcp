...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Alembic SOP](https://docs.derivative.ca/Alembic_SOP "Alembic SOP").
