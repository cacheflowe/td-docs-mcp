...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Convert SOP](https://docs.derivative.ca/Convert_SOP "Convert SOP").
