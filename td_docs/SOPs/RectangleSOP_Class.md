...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Rectangle SOP](https://docs.derivative.ca/Rectangle_SOP "Rectangle SOP").
