...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Capture SOP](https://docs.derivative.ca/Capture_SOP "Capture SOP").
