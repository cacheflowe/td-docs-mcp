...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Line Thick SOP](https://docs.derivative.ca/Line_Thick_SOP "Line Thick SOP").
