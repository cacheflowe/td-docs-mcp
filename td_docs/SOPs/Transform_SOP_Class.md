---
url: https://docs.derivative.ca/TransformSOP_Class
category: SOPs
title: TransformSOP_Class
---

# transformSOP Class

This class inherits from the [ SOP class](SOP_Class.md "SOP Class"). It references a specific [Transform SOP](Transform_SOP.md "Transform SOP").
