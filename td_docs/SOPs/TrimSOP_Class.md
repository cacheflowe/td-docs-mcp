...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Trim SOP](https://docs.derivative.ca/Trim_SOP "Trim SOP").
