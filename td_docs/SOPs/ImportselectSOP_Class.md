...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Import Select SOP](https://docs.derivative.ca/Import_Select_SOP "Import Select SOP").
