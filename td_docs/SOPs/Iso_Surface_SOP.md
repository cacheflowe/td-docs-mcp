...
[isosurfaceSOP_Class](Iso_Surface_SOP_Class.md "IsosurfaceSOP Class")
...
Extra Information for the Iso Surface SOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
