...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Joint SOP](https://docs.derivative.ca/Joint_SOP "Joint SOP").
