...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Capture Region SOP](https://docs.derivative.ca/Capture_Region_SOP "Capture Region SOP").
