...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Profile SOP](https://docs.derivative.ca/Profile_SOP "Profile SOP").
