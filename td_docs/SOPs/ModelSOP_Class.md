...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [Model SOP](https://docs.derivative.ca/Model_SOP "Model SOP").
...
Append a [poly](https://docs.derivative.ca/Poly_Class "Poly Class") to this SOP. Returns the appended polygon.
...
###  Attributes
Geometry Attributes can be added to this operator using the `create(name, default)` method of the [Attributes Class](https://docs.derivative.ca/Attributes_Class "Attributes Class")
