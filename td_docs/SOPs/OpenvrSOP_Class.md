...
This class inherits from the [ SOP class](https://docs.derivative.ca/SOP_Class "SOP Class"). It references a specific [OpenVR SOP](https://docs.derivative.ca/OpenVR_SOP "OpenVR SOP").
