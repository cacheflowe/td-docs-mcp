...
---|---
month  | May
The Web Client DAT is the successor to the [Web DAT](../DATs/Web_DAT.md "Web DAT").

See also: [Web Server DAT](Web_Server_DAT.md "Web Server DAT"), [SocketIO DAT](SocketIO_DAT.md "SocketIO DAT"), [XML DAT](XML_DAT.md "XML DAT"), [TCP/IP DAT](https://docs.derivative.ca/TCP/IP_DAT "TCP/IP DAT"), [WebSocket DAT](WebSocket_DAT.md "WebSocket DAT"), [Web DAT](../DATs/Web_DAT.md "Web DAT").

[webclientDAT_Class](../DATs/Web_Client_DAT_Class.md "WebclientDAT Class")
