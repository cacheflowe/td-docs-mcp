---
url: https://docs.derivative.ca/SICK
...
The [SICK TOP](https://docs.derivative.ca/SICK_TOP "SICK TOP") sets up the connection and receives a standard TouchDesigner point cloud as an array of pixels where the pixel's R G B values by default contain a point's X Y Z position expressed as 32-bit floating point numbers.
