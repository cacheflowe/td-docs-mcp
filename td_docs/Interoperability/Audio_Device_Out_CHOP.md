...
**Tip** : If you get audio popping or audio dropouts, it may be caused by your actual frame rate of your main `timeline` - some frames may take too long to compute/render. See [Time Slicing](../Glossary/Time_Slicing.md "Time Slicing"). There are four possible remedies:
  ...
  * Optimize your networks so under no condition your frame time exceeds the audio buffer size or the maximum time slice size. You can monitor this precisely with the [Perform CHOP](../CHOPs/Perform_CHOP.md "Perform CHOP").
  * Put audio in a separate TouchDesigner process.

[audiodeviceoutCHOP_Class](../CHOPs/Audio_Device_Out_CHOP_Class.md "AudiodeviceoutCHOP Class")
...
Extra Information for the Audio Device Out CHOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
