---
url: https://docs.derivative.ca/Hokuyo_CHOP
...
It can be used with the [Blob Track CHOP](../CHOPs/Blob_Track_CHOP.md "Blob Track CHOP") to detect objects in its field. See the Snippet for Blob Track.
...
[![Scan info.jpg](https://docs.derivative.ca/images/0/08/Scan_info.jpg)](https://docs.derivative.ca/File:Scan_info.jpg)
...
See also [Serial DAT](Serial_DAT.md "Serial DAT"), [serialDAT_Class](../DATs/Serial_DAT_Class.md "SerialDAT Class"), [Arduino](Arduino.md "Arduino")

[hokuyoCHOP_Class](../CHOPs/Hokuyo_CHOP_Class.md "HokuyoCHOP Class")
...
Extra Information for the Hokuyo CHOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
