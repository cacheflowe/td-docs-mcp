...
(Redirected from [Nvidia Flow TOP](https://docs.derivative.ca/index.php?title=Nvidia_Flow_TOP&redirect=no "Nvidia Flow TOP"))
...
[flowTOP_Class](../TOPs/FlowTOP_Class.md "FlowTOP Class")
...
- Camera `camera` - Specify the [Camera COMP](../Glossary/Camera_COMP.md "Camera COMP") to view the simulation from. Note: Must be camera with Projection = Perspective.
...
## Operator Inputs
  ...
  * Input 1: Depth Map - A [Depth TOP](../TOPs/Depth_TOP.md "Depth TOP") to obscure parts of the Flow Simulation.

## Info CHOP Channels

Extra Information for the Nvidia Flow TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
