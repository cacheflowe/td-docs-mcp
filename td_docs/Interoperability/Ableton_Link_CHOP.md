...
The full support of the Ableton Live system is [TDAbleton](TDAbleton.md "TDAbleton"), a group of components that give you access to Ableton Songs, Tracks, Chains, Parameters and MIDI.
...
[abletonlinkCHOP_Class](../CHOPs/Ableton_Link_CHOP_Class.md "AbletonlinkCHOP Class")
...
Extra Information for the Ableton Link CHOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
