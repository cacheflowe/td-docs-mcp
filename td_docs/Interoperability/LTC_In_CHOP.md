...
First bring the audio signal into CHOPs using an [Audio Device In CHOP](../CHOPs/Audio_Device_In_CHOP.md "Audio Device In CHOP"). This can then be input into the LTC In CHOP.

See [Timecode](Timecode.md "Timecode") for the full integration of timecode in TouchDesigner.

See also: [LTC Out CHOP](../CHOPs/LTC_Out_CHOP.md "LTC Out CHOP")

[ltcinCHOP_Class](../CHOPs/LTC_In_CHOP_Class.md "LtcinCHOP Class")
...
Extra Information for the LTC In CHOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
