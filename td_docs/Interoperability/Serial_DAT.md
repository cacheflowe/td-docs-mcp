...
To send bytes out this connection, see the send methods in the [serialDAT_Class](../DATs/Serial_DAT_Class.md "SerialDAT Class"), or in Tscript the `send` Command.

See also [Arduino](Arduino.md "Arduino") and [Serial CHOP](../CHOPs/Serial_CHOP.md "Serial CHOP").

[serialDAT_Class](../DATs/Serial_DAT_Class.md "SerialDAT Class")
