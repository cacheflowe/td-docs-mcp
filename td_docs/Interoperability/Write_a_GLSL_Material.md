---
url: https://docs.derivative.ca/Write_a_GLSL_Material
...
####  Physically Based (PBR) Lighting[ Lighting")]
...
All of the parameters for the lights are defined in the uTDLights structure, defined [ here](#TouchDesigner_specific_Uniforms).
...
Currently there are two different types deformations that can be applied to geometry: [ skinned deforms](https://docs.derivative.ca/Deforming_Geometry_\(Skinning\) "Deforming Geometry \(Skinning\)") and instanced transforms.
...
If you are experiencing a full application crash when writing GLSL code, you may want to refer to [this article](https://docs.derivative.ca/Debugging_crashes_triggered_by_GLSL_errors "Debugging crashes triggered by GLSL errors") for tips on diagnosing these issues.
