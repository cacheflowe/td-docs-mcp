---
url: https://docs.derivative.ca/Leuze_ROD4_CHOP
category: Interoperability
title: Leuze_ROD4_CHOP
---
...
The Leuze can be used with the [Blob Track CHOP](../CHOPs/Blob_Track_CHOP.md "Blob Track CHOP") to detect objects in its field. See the OP Snippet for Blob Track.

[leuzerod4CHOP_Class](../CHOPs/Leuze_ROD4_CHOP_Class.md "Leuzerod4CHOP Class")
...
Extra Information for the Leuze ROD4 CHOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
