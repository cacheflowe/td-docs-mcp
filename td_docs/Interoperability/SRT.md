---
url: https://docs.derivative.ca/SRT
...
The listener, caller role of the video stream in and out TOPs can be reversed simply by flipping the mode arguements "listener" and "caller" of the URLs.
...
On the app side fill out the settings as follows in the "Play and SRT Stream" section.
...
`StreamID =    (Nothing - leave it blank) `
