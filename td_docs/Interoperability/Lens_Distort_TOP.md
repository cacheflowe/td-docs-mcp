---
url: https://docs.derivative.ca/Lens_Distort_TOP
category: Interoperability
title: Lens_Distort_TOP
---
...
Distortion values for a camera lens can be determined using [OpenCV calibration routines](https://docs.opencv.org/master/dc/dbb/tutorial_py_calibration.html) or through functions for a particular camera (see [kinectazureTOP class](../TOPs/Kinect_Azure_TOP_Class.md "KinectazureTOP Class")).
...
Extra Information for the Lens Distort TOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
