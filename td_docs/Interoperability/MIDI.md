---
url: https://docs.derivative.ca/MIDI
...
Note: To find out what MIDI events are coming into TouchDesigner, open the [MIDI Device Mapper Dialog](https://docs.derivative.ca/MIDI_Device_Mapper_Dialog "MIDI Device Mapper Dialog") and turn on the **In Events** tab. All incoming messages will be reported in the console area of the MIDI Device Mapper.
