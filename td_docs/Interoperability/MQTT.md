...
MQTT is implemented in TouchDesigner as the [MQTT Client DAT](https://docs.derivative.ca/MQTT_Client_DAT "MQTT Client DAT"), and some other computer or software needs to be a MQTT "broker".
...
See also: [MQTT Client DAT](https://docs.derivative.ca/MQTT_Client_DAT "MQTT Client DAT"), [MQTT home page](http://mqtt.org), [MQTT in Wikipedia](https://en.wikipedia.org/wiki/MQTT), [TCP/IP DAT](https://docs.derivative.ca/TCP/IP_DAT "TCP/IP DAT"), [PAHO-MQTT independent Python client library](https://pypi.python.org/pypi/paho-mqtt/1.1).
