---
url: https://docs.derivative.ca/Arduino
...
See also [Palette:Firmata](https://docs.derivative.ca/index.php?title=Palette:Firmata&action=edit&redlink=1 "Palette:Firmata \(page does not exist\)").
##  Sending data from the Arduino
Begin by installing Arduino, and any necessary serial drivers.
Here is an example file: [Media:Arduino sample.tox](https://docs.derivative.ca/images/a/a5/Arduino_sample.tox "Arduino sample.tox")
