---
url: https://docs.derivative.ca/Nvidia_Flex_Solver_COMP
category: Interoperability
title: Nvidia_Flex_Solver_COMP
---

# NVIDIA Flex Solver COMP

(Redirected from [Nvidia Flex Solver COMP](https://docs.derivative.ca/index.php?title=Nvidia_Flex_Solver_COMP&redirect=no "Nvidia Flex Solver COMP"))
...
The Nvidia Flex Solver COMP is a physics solver COMP similar to the [Bullet Solver COMP](../COMPs/Bullet_Solver_COMP.md "Bullet Solver COMP").
...
See also: [Flex](https://docs.derivative.ca/Flex "Flex"), [Nvidia Flex TOP](https://docs.derivative.ca/Nvidia_Flex_TOP "Nvidia Flex TOP"), [Actor COMP](../COMPs/Actor_COMP.md "Actor COMP"), [Force COMP](../COMPs/Force_COMP.md "Force COMP")

[nvidiaflexsolverCOMP_Class](../COMPs/NVIDIA_Flex_Solver_COMP_Class.md "NvidiaflexsolverCOMP Class")
...
- Pre-Roll `preroll` - Enables simulation pre-roll. Pre-roll can used to step forward the simulation to a desired start state. Pre-roll will happen during the initialization phase. To get info on the state of pre-roll, see the channels on the Solver's [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
...
- Enable Diffuse Particles `diffuse` - When enabled, diffuse particles will be created in the simulation. Diffuse particle position/velocity can be fetched using the [Nvidia Flex TOP](https://docs.derivative.ca/Nvidia_Flex_TOP "Nvidia Flex TOP").
...
- Diffuse Threshold `diffthresh` - Particles with _kinetic energy + divergence_ above this threshold will spawn new diffuse particles
...
Extra Information for the Nvidia Flex Solver COMP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
