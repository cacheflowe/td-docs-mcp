---
url: https://docs.derivative.ca/Joystick_CHOP
...
[joystickCHOP_Class](../CHOPs/Joystick_CHOP_Class.md "JoystickCHOP Class")
...
Extra Information for the Joystick CHOP can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
