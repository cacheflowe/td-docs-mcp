---
url: https://docs.derivative.ca/Bitwig
...
[![Bitwig Studio Logo RGB.png](https://docs.derivative.ca/images/thumb/1/1a/Bitwig_Studio_Logo_RGB.png/300px-Bitwig_Studio_Logo_RGB.png)](https://docs.derivative.ca/File:Bitwig_Studio_Logo_RGB.png)

## Bitwig Integration with TouchDesigner

[TDBitwig](https://docs.derivative.ca/TDBitwig "TDBitwig") is a set of TouchDesigner components that allow for communication between Bitwig Studio and TouchDesigner. The TDBitwig functionality enables users to create custom audio-visual performances by integrating real-time visuals with live audio output.

See these useful resources:
  * [TDBitwig Announcement Article](https://derivative.ca/community-post/68285)
  * [TDBitwig User Guide](https://docs.derivative.ca/TDBitwig_User_Guide "TDBitwig User Guide") - concepts and getting started
...
## Key Bitwig Features
  ...
  * Modulation System: The modulation system allows you to modulate any device, VST plug-in, parameter, in turn supporting bidirectional modulation of TouchDesigner parameters through [TDBitwig](https://docs.derivative.ca/TDBitwig "TDBitwig").
  * Hardware Controller Integration: Bitwig supports a wide range of music creation and performance controllers, making it an ideal solution for controlling TouchDesigner through [TDBitwig](https://docs.derivative.ca/TDBitwig "TDBitwig").
...
With [TDBitwig](https://docs.derivative.ca/TDBitwig "TDBitwig"), TouchDesigner can control Bitwig Studio parameters, such as tempo, track properties, clip launching, and device parameters. Conversely, Bitwig Studio can also control TouchDesigner parameters for creating tightly integrated audio and visuals.
...
TouchDesigner is a visual programming tool for building interactive experiences, visualizations, generative 2D/3D art, user interfaces, and is used for education, VJing, basement prototyping and experimentation. TouchDesigner includes powerful tools for massaging data and controlling signals, interoperating and communicating with a wide range of physical devices, protocols and software tools, and driving video/audio/data to pro video cards, DMX, LEDs, projectors, screens, lasers, robotics, internet, web streaming, AR/XR/VR and more. Read about TouchDesigner [Interoperability](../General/Interoperability.md "Interoperability").
