...
See also: [Ableton](https://docs.derivative.ca/Ableton "Ableton"), [TDAbleton System Components](https://docs.derivative.ca/TDAbleton_System_Components "TDAbleton System Components"), [Creating Custom TDAbleton Components](https://docs.derivative.ca/Creating_Custom_TDAbleton_Components "Creating Custom TDAbleton Components"), and [TDAbletonCompBaseExt Extension](https://docs.derivative.ca/TDAbletonCompBaseExt_Extension "TDAbletonCompBaseExt Extension")

###  Common Ableton Tasks

The following is a list of commonly used data from Ableton Live and where to find it in TDAbleton.
  * **Scene** : `abletonSong[](https://docs.derivative.ca/TDAbleton_System_Components#abletonSong "TDAbleton System Components")` Component, channels `song/info/triggered_scene` and `song/info/last_started_scene`. Also available via callbacks.
  * **Time and Tempo Data** : `abletonSong[](https://docs.derivative.ca/TDAbleton_System_Components#abletonSong "TDAbleton System Components")` Component, channels `song/info/bars`, `song/info/beats`, `song/info/sixteenths`, `song/info/time`. **Note** : Include Time Data parameter must be `On`.
  * **Cue Points (a.k.a Timeline Locators)**: `abletonSong[](https://docs.derivative.ca/TDAbleton_System_Components#abletonSong "TDAbleton System Components")` Component property `LastLocatorPassed`. Also available via callbacks.
  * **Output Levels** : `abletonTrack[](https://docs.derivative.ca/TDAbleton_System_Components#abletonTrack "TDAbleton System Components")` Component, channels `.../output_meter_left`, `.../output_meter_right`, `.../output_meter_level`. **Note** : Due to a bug in Ableton Live Object Model, these are only updated when the meters are visible in the Ableton interface! Also, Include Audio Data parameter must be `on`.
  * **Track Slots** : `abletonTrack[](https://docs.derivative.ca/TDAbleton_System_Components#abletonTrack "TDAbleton System Components")` Component, channels `.../playing_slot_index`, `.../fired_slot_index`.
  * **Clips** : `abletonTrack[](https://docs.derivative.ca/TDAbleton_System_Components#abletonTrack "TDAbleton System Components")` Component, out_clips DAT output. When the **Include Playing Clip Data** parameter is on, `abletonTrack`'s CHOP output will also show clip time and loop information. To select specific clip slots, use `abletonClipSlot[](https://docs.derivative.ca/TDAbleton_System_Components#abletonClipSlot "TDAbleton System Components")`.
  * **Device Parameter Values** : `abletonParameter[](https://docs.derivative.ca/TDAbleton_System_Components#abletonParameter "TDAbleton System Components")` or `abletonChainParameter` Components.
  * **Control Ableton Parameters (without creating undo steps)** : `abletonParameter[](https://docs.derivative.ca/TDAbleton_System_Components#abletonMapper "TDAbleton System Components")` Component. Also [abletonRack](https://docs.derivative.ca/TDAbleton_System_Components#abletonRack "TDAbleton System Components") Component.
  * **MIDI Data** : `abletonMIDI[](https://docs.derivative.ca/TDAbleton_System_Components#abletonMIDI "TDAbleton System Components")` Component.
  * **MIDI Notes in a Clip** : `abletonClipSlot[](https://docs.derivative.ca/TDAbleton_System_Components#abletonClipSlot "TDAbleton System Components")` Component.
  * **Audio Levels and Audio Spectrum Analysis** : `abletonLevel[](https://docs.derivative.ca/TDAbleton_System_Components#abletonLevel "TDAbleton System Components")` Component. This includes level data on a per-track basis, and can be combined with filters to provide spectrum analysis.
  * **Sending/Receiving Rack Macro data**: `abletonRack[](https://docs.derivative.ca/TDAbleton_System_Components#abletonRack "TDAbleton System Components")` Component. This is also the smoothest way to receive parameter data.
  ...
  * **Access obscure Live Object Model features** : [abletonValueListener](https://docs.derivative.ca/TDAbleton_System_Components#abletonValueListener "TDAbleton System Components") Component.
  * **Get string data from Live** : [abletonValueListener](https://docs.derivative.ca/TDAbleton_System_Components#abletonValueListener "TDAbleton System Components") Component.
  * **Selected Tracks, Devices etc. in Live** : [abletonValueListener](https://docs.derivative.ca/TDAbleton_System_Components#abletonValueListener "TDAbleton System Components") Component.

####  TDAbleton 2.0 and up

  * **Arrangement Clip Info** : `abletonTrack[](https://docs.derivative.ca/TDAbleton_System_Components#abletonTrack "TDAbleton System Components")` Component has channels and DAT outputs with info about clips in the arrangement.
  * **Rack Variations** : `abletonRack[](https://docs.derivative.ca/TDAbleton_System_Components#abletonRack "TDAbleton System Components")` Component.

##  Getting Started

Note: **[(Link to TDAbleton Installation instructions for Versions prior to 1.23, or manual installation for separate computers or unusual configurations.)](https://docs.derivative.ca/TDAbleton_Manual_Installation_\(legacy\) "TDAbleton Manual Installation \(legacy\)")**
...
If this is your first time using TDAbleton, the best way to learn the basics is the [TDAbleton Feature Tour](#TDAbleton_Feature_Tour)
...
[![ReplaceTDADevices.png](https://docs.derivative.ca/images/6/6c/ReplaceTDADevices.png)](https://docs.derivative.ca/File:ReplaceTDADevices.png)
...
[![TDAMaster.PNG](https://docs.derivative.ca/images/a/ab/TDAMaster.PNG)](https://docs.derivative.ca/File:TDAMaster.PNG)
...
[![AbletonSong.PNG](https://docs.derivative.ca/images/5/5e/AbletonSong.PNG)](https://docs.derivative.ca/File:AbletonSong.PNG)
...
[![AbletonParameter.PNG](https://docs.derivative.ca/images/5/53/AbletonParameter.PNG)](https://docs.derivative.ca/File:AbletonParameter.PNG)
...
[![AbletonPitchDevice.PNG](https://docs.derivative.ca/images/4/45/AbletonPitchDevice.PNG)](https://docs.derivative.ca/File:AbletonPitchDevice.PNG)
...
[![AbletonMIDI.PNG](https://docs.derivative.ca/images/9/9d/AbletonMIDI.PNG)](https://docs.derivative.ca/File:AbletonMIDI.PNG)
...
[![TDAMIDI.PNG](https://docs.derivative.ca/images/6/6b/TDAMIDI.PNG)](https://docs.derivative.ca/File:TDAMIDI.PNG)
...
For more details about using TDAbleton MIDI features, see [abletonMIDI](https://docs.derivative.ca/TDAbleton_System_Components#abletonMIDI "TDAbleton System Components").
...
[![AbletonRack.PNG](https://docs.derivative.ca/images/9/94/AbletonRack.PNG)](https://docs.derivative.ca/File:AbletonRack.PNG)
...
The general strategy for using these racks is to put the Live device whose parameters you want to control and/or watch into the rack. Then map the appropriate rack macros to the parameters you want to interact with. This will create a fast connection between those parameters and the corresponding abletonRack device. For more information, see [abletonRack](https://docs.derivative.ca/TDAbleton_System_Components#abletonRack "TDAbleton System Components").

##  Using TDAbleton Package

[![TdAbletonPackage.PNG](https://docs.derivative.ca/images/a/ad/TdAbletonPackage.PNG)](https://docs.derivative.ca/File:TdAbletonPackage.PNG)
...
The other **TDAbleton Components** provide the actual real-time data to and from Ableton. To use these Components, copy them into your project from `tdAbletonPackage` or drag them in from the TDAbleton>Live <version> folder in the Palette. In general, they use CHOP channels to transmit data _from_ Ableton Live and custom parameters for Component set up and also for transmission of data _to_ Live. For specific information about the Components see [TDAbleton System Components](https://docs.derivative.ca/TDAbleton_System_Components "TDAbleton System Components").

The TDAbleton system also provides a number of features for creating your own custom Components. See **[Creating Custom TDAbleton Components](https://docs.derivative.ca/Creating_Custom_TDAbleton_Components "Creating Custom TDAbleton Components")** for more information.
