...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Wireframe MAT](https://docs.derivative.ca/Wireframe_MAT "Wireframe MAT").
