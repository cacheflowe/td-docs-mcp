...
[switchMAT_Class](https://docs.derivative.ca/SwitchMAT_Class "SwitchMAT Class")
...
## Info CHOP Channels
Extra Information for the Switch MAT can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
