...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Null MAT](https://docs.derivative.ca/Null_MAT "Null MAT").
