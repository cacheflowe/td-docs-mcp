---
url: https://docs.derivative.ca/WireframeMAT_Class
category: MATs
title: WireframeMAT_Class
---

# wireframeMAT Class

This class inherits from the [ MAT class](../Python/MAT_Class.md "MAT Class"). It references a specific [Wireframe MAT](Wireframe_MAT.md "Wireframe MAT").
