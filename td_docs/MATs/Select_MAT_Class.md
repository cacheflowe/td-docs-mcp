---
url: https://docs.derivative.ca/SelectMAT_Class
category: MATs
title: SelectMAT_Class
---

# selectMAT Class

This class inherits from the [ MAT class](../Python/MAT_Class.md "MAT Class"). It references a specific [Select MAT](Select_MAT.md "Select MAT").
