...
The Out MAT is used to create a MAT output in a Component. Component outputs are positioned alphanumerically on the right side of the Component.
[outMAT_Class](https://docs.derivative.ca/OutMAT_Class "OutMAT Class")
...
## Info CHOP Channels
Extra Information for the Out MAT can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
