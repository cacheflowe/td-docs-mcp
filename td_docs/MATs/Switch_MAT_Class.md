---
url: https://docs.derivative.ca/SwitchMAT_Class
category: MATs
title: SwitchMAT_Class
---

# switchMAT Class

This class inherits from the [ MAT class](../Python/MAT_Class.md "MAT Class"). It references a specific [Switch MAT](Switch_MAT.md "Switch MAT").
