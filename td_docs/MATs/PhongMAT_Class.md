...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Phong MAT](https://docs.derivative.ca/Phong_MAT "Phong MAT").
