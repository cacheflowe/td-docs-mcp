...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Out MAT](https://docs.derivative.ca/Out_MAT "Out MAT").
