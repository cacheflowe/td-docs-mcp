---
url: https://docs.derivative.ca/InMAT_Class
category: MATs
title: InMAT_Class
---
...
This class inherits from the [ MAT class](../Python/MAT_Class.md "MAT Class"). It references a specific [In MAT](In_MAT.md "In MAT").
