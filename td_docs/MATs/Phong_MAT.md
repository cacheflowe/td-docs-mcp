...
[phongMAT_Class](Phong_MAT_Class.md "PhongMAT Class")
...
Extra Information for the Phong MAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
