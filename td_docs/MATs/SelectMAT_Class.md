...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Select MAT](https://docs.derivative.ca/Select_MAT "Select MAT").
