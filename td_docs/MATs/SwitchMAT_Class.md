...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Switch MAT](https://docs.derivative.ca/Switch_MAT "Switch MAT").
