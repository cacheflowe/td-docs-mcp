...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [GLSL MAT](https://docs.derivative.ca/GLSL_MAT "GLSL MAT").
