...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Constant MAT](https://docs.derivative.ca/Constant_MAT "Constant MAT").
