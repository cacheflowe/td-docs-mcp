...
[wireframeMAT_Class](Wireframe_MAT_Class.md "WireframeMAT Class")
...
Extra Information for the Wireframe MAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
