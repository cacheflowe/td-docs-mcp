...
[wireframeMAT_Class](https://docs.derivative.ca/WireframeMAT_Class "WireframeMAT Class")
...
- Wireframe Mode `wireframemode` - ⊞ - Controls what wireframes are rendered.
  * OpenGL Tessellated Wire Frame `tesselatedwireframe` - This wireframe follows what the actual rendered geometry on the GPU ends up being. This is usually just wired-triangles for any surface, regardless of the original primitive type.
  * Topology Wire Frame `topologywireframe` - This wireframe follows the original SOP primitive types.
...
## Info CHOP Channels
Extra Information for the Wireframe MAT can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
