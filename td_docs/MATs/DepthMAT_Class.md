...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Depth MAT](https://docs.derivative.ca/Depth_MAT "Depth MAT").
