---
url: https://docs.derivative.ca/PointspriteMAT_Class
category: MATs
title: PointspriteMAT_Class
---

# pointspriteMAT Class

This class inherits from the [ MAT class](../Python/MAT_Class.md "MAT Class"). It references a specific [Point Sprite MAT](Point_Sprite_MAT.md "Point Sprite MAT").
