...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [PBR MAT](https://docs.derivative.ca/PBR_MAT "PBR MAT").
