---
url: https://docs.derivative.ca/ConstantMAT_Class
category: MATs
title: ConstantMAT_Class
---

# constantMAT Class

This class inherits from the [ MAT class](../Python/MAT_Class.md "MAT Class"). It references a specific [Constant MAT](Constant_MAT.md "Constant MAT").
