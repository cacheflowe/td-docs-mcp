...
# lineMAT Class
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [Line MAT](https://docs.derivative.ca/Line_MAT "Line MAT").
