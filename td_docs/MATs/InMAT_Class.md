...
This class inherits from the [ MAT class](https://docs.derivative.ca/MAT_Class "MAT Class"). It references a specific [In MAT](https://docs.derivative.ca/In_MAT "In MAT").
