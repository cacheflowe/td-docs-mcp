---
url: https://docs.derivative.ca/PhongMAT_Class
category: MATs
title: PhongMAT_Class
---

# phongMAT Class

This class inherits from the [ MAT class](../Python/MAT_Class.md "MAT Class"). It references a specific [Phong MAT](Phong_MAT.md "Phong MAT").
...
`outputShader(includeGeoShader=False, instanceTexturing=False)`→ `glslMAT`:

Will cause a new GLSL MAT to be created based on the current settings for this MAT.
  * includeGeoShader - (Keyword, Optional) Set to True if you want a stub geometry shader to be included.
  * instanceTexturing - (Keyword, Optional) Set to True if you want code that consumes instance textures to be included.
...
True if the operator is a [Material](MAT.md "MAT").
