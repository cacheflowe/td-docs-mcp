...
[constantMAT_Class](https://docs.derivative.ca/ConstantMAT_Class "ConstantMAT Class")

## Parameters - Constant Page
- Apply Projection Maps `applyprojmaps` - The projection map texture color from a [Light COMP](https://docs.derivative.ca/Light_COMP "Light COMP") will be applied to the object as well. This allows for applying a projection map without affecting the projection map's color with any lighting.
...
## Info CHOP Channels
Extra Information for the Constant MAT can be accessed via an [Info CHOP](https://docs.derivative.ca/Info_CHOP "Info CHOP").
###
