---
url: https://docs.derivative.ca/ActorCOMP_Class
category: Python
title: ActorCOMP_Class
---

# actorCOMP Class

This class inherits from the [ COMP class](COMP_Class.md "COMP Class"). It references a specific [Actor COMP](../COMPs/Actor_COMP.md "Actor COMP").

## Members

`bodies` → `list` **(Read Only)** :

Returns a list of all the bodies in the [Actor COMP](../COMPs/Actor_COMP.md "Actor COMP"). Each entry in the list will be a [Body Class](Body_Class.md "Body Class") object.
