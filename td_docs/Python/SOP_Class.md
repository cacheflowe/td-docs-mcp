---
url: https://docs.derivative.ca/SOP_Class
category: Python
title: SOP_Class
---
...
A [SOP](../SOPs/SOP.md "SOP") describes a reference to a SOP operator, containing [points](Points_Class.md "Points Class") and [primitives](../SOPs/Prims_Class.md "Prims Class").
...
The set of [points](Points_Class.md "Points Class") contained in this SOP.

`prims` → `td.Prims` **(Read Only)** :

The set of [primitives](../SOPs/Prims_Class.md "Prims Class") contained in this SOP.

`numPoints` → `int` **(Read Only)** :

The number of [points](Points_Class.md "Points Class") contained in this SOP. This value updates independently of time dependent geometry.

`numVertices` → `int` **(Read Only)** :

The number of [vertices](Vertex_Class.md "Vertex Class") contained in all primitives within this SOP. This value updates independently of time dependent geometry.

`numPrims` → `int` **(Read Only)** :

The number of [primitivies](../SOPs/Prims_Class.md "Prims Class") contained in this SOP. This value updates independently of time dependent geometry.

`pointAttribs` → `td.Attributes` **(Read Only)** :

The set of point [attributes](Attributes_Class.md "Attributes Class") defined in this SOP.

`primAttribs` → `td.Attributes` **(Read Only)** :

The set of primitive [attributes](Attributes_Class.md "Attributes Class") defined in this SOP.

`vertexAttribs` → `td.Attributes` **(Read Only)** :

The set of vertex [attributes](Attributes_Class.md "Attributes Class") defined in this SOP.

`pointGroups` → `dict` **(Read Only)** :

Returns a dictionary of point [groups](Group_Class.md "Group Class") defined for this SOP.

`primGroups` → `dict` **(Read Only)** :

Returns a dictionary of primitive [groups](Group_Class.md "Group Class") defined for this SOP.

`center` → `tdu.Position` :

Get or set the barycentric coordinate of this operator's geometry. It is expressed as a [Position](Position_Class.md "Position Class").

`min` → `tdu.Position` **(Read Only)** :

The minimum coordinates of this operator's geometry along each dimension, expressed as a [Position](Position_Class.md "Position Class").

`max` → `tdu.Position` **(Read Only)** :

The maximum coordinates of this operator's geometry along each dimension, expressed as [Position](Position_Class.md "Position Class").

`size` → `tdu.Position` **(Read Only)** :

The size of this operator's geometry along each dimension, expressed as a [Position](Position_Class.md "Position Class").
...
Returns an object with the bounds, center and size of the SOP's geometry. _Note:_ This method replaces the deprecated computeBounds method. The method works the same, but the keywords now default to false.
  * display - (Keyword, Optional) If set to True, only SOP operators whose[ display flag](../Glossary/Display_Flag.md "Display Flag") are turned on are included in the calculation. When False, the states of the display flag is ignored.
  * render - (Keyword, Optional) If set to True, only SOP operators whose[ render flag](../Glossary/Render_Flag.md "Render Flag") are turned on are included in the calculation. When False, the state of the render flag is ignored.
