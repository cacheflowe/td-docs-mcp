---
url: https://docs.derivative.ca/FlexsolverCOMP_Class
category: Python
title: FlexsolverCOMP_Class
---

# nvidiaflexsolverCOMP Class

(Redirected from [FlexsolverCOMP Class](https://docs.derivative.ca/index.php?title=FlexsolverCOMP_Class&redirect=no "FlexsolverCOMP Class"))

This class inherits from the [ COMP class](COMP_Class.md "COMP Class"). It references a specific [Nvidia Flex Solver COMP](../Interoperability/Nvidia_Flex_Solver_COMP.md "Nvidia Flex Solver COMP").

## Members

`actors` → `list` **(Read Only)** :

Returns a list of all the Actor COMPs in the Flex Solver simulation.
