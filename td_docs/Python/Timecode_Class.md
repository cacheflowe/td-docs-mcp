...
The Timecode class holds a timecode value. See also [Timecode](../Interoperability/Timecode.md "Timecode") and [Timecode CHOP](../CHOPs/Timecode_CHOP.md "Timecode CHOP").
