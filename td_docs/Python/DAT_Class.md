...
# DAT Class
A [DAT](https://docs.derivative.ca/DAT "DAT") describes a reference to a DAT operator. This class inherits from the [ OP class](https://docs.derivative.ca/OP_Class "OP Class").
