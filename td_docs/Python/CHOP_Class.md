...
# CHOP Class
A [CHOP](https://docs.derivative.ca/CHOP "CHOP") describes a reference to a CHOP operator, containing a set of [channels](https://docs.derivative.ca/Channel "Channel") accessed with the [Channel Class](https://docs.derivative.ca/Channel_Class "Channel Class").
