...
The OP class defines a reference to a single [operator](../General/Operator.md "Operator").
...
A list of operators contained within this operator. Only [component](COMP_Class.md "COMP Class") operators have children, otherwise an empty list is returned.
