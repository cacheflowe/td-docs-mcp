---
url: https://docs.derivative.ca/BulletsolverCOMP_Class
category: Python
title: BulletsolverCOMP_Class
---

# bulletsolverCOMP Class

This class inherits from the [ COMP class](COMP_Class.md "COMP Class"). It references a specific [Bullet Solver COMP](../COMPs/Bullet_Solver_COMP.md "Bullet Solver COMP").

## Members

`actors` → `list` **(Read Only)** :

Returns a list of all the [Actor COMPs](../COMPs/Actor_COMP.md "Actor COMP") in the Bullet Solver simulation.
