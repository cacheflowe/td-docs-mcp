...
This class inherits from the [ COMP class](https://docs.derivative.ca/COMP_Class "COMP Class"). It references a specific [Bullet Solver COMP](https://docs.derivative.ca/Bullet_Solver_COMP "Bullet Solver COMP").

## Members
`actors` → `list` **(Read Only)** :
Returns a list of all the [Actor COMPs](https://docs.derivative.ca/Actor_COMP "Actor COMP") in the Bullet Solver simulation.
## Methods
