---
url: https://docs.derivative.ca/COMP_Class
category: Python
title: COMP_Class
---
...
A COMP describes a reference to a [Component](../Glossary/Component.md "Component") operator.
...
Returns an instance of the [ProgressiveUnloader Class](https://docs.derivative.ca/ProgressiveUnloader_Class "ProgressiveUnloader Class") to control and get details of the latest progressive unload task. This works together with the `progressiveUnload()` [method](#progressiveUnload) of the component.
...
A list of [operators](OP_Class.md "OP Class") contained within this operator. Only component operators have children, otherwise an empty list is returned.
...
See also the `OP.parent` methods. To connect components together see [COMP_Class#Connection](#Connection) section.
...
**NOTE** : `create()`, `copy()` and `copyOPs()` is done by the parent operator (a component). For more information see [COMP.create, COMP.copy and COMP.copyOPs methods](#Methods).
