---
url: https://docs.derivative.ca/TouchDesigner_Video_Server_Specification_Guide
category: Learn
title: TouchDesigner_Video_Server_Specification_Guide
---
...
##  Processor
  * For more detail go here: [Intel Processors and TouchDesigner](https://docs.derivative.ca/Intel_Processors_and_TouchDesigner "Intel Processors and TouchDesigner")
...
##  Graphics Card
  * For more detail go here: [Nvidia Geforce vs Quadro](https://docs.derivative.ca/Nvidia_Geforce_vs_Quadro "Nvidia Geforce vs Quadro")
...
##  Hard Drive
  * For more detail go here: [Storage Technology and TouchDesigner](https://docs.derivative.ca/Storage_Technology_and_TouchDesigner "Storage Technology and TouchDesigner")
