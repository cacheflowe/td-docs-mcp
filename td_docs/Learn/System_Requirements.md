...
System requirements for [TouchDesigner](https://docs.derivative.ca/TouchDesigner_Products "TouchDesigner Products") and [TouchPlayer](../Glossary/TouchPlayer.md "TouchPlayer").
...
**Hardware**
  ...
  * TouchDesigner requires macOS 13 or higher, but we recommend running the latest macOS version your Mac supports.
  * We highly recommend a Mac with Apple Silicon for TouchDesigner. For Intel-based Macs TouchDesigner requires a model with a discrete AMD GPU.
...
##  Feature Specific Requirements
  ...
  * [Movie File In TOP](../TOPs/Movie_File_In_TOP.md "Movie File In TOP") - H.264 and H.265 hardware accelerated decoding
    * On Windows Nvidia GPU only, or macOS for codecs the hardware supports.
  * [Movie File Out TOP](../TOPs/Movie_File_Out_TOP.md "Movie File Out TOP") - H.264 and H.265 encoding
    * On Windows OS requires Nvidia GPU, also works on macOS.
  * [Video Stream Out TOP](../TOPs/Video_Stream_Out_TOP.md "Video Stream Out TOP") - Uses H.264 encoding
    * Windows OS & Nvidia GPU only
  * [Syphon Spout In TOP](../TOPs/Syphon_Spout_In_TOP.md "Syphon Spout In TOP") / [Syphon Spout Out TOP](../TOPs/Syphon_Spout_Out_TOP.md "Syphon Spout Out TOP")
    * For Spout on Windows, Nvidia or AMD GPUs are required, Intel does not work.
  * [Face Track CHOP](../Interoperability/Face_Track_CHOP.md "Face Track CHOP") and [Face Track SOP](../SOPs/Face_Track_SOP.md "Face Track SOP")
  ...
  * [Nvidia Flex](https://docs.derivative.ca/Flex "Flex")
    * Windows OS & Nvidia GPU only
  * [Nvidia Flow TOP](../Interoperability/Nvidia_Flow_TOP.md "Nvidia Flow TOP")
    * Windows OS & Nvidia GPU only
  * [Notch TOP](../TOPs/Notch_TOP.md "Notch TOP") - Playback Notch blocks
    * Windows OS
  * [Optical Flow TOP](../TOPs/Optical_Flow_TOP.md "Optical Flow TOP") - detects patterns of motion in its input.
    * Windows OS & Nvidia 3000 GPU or higher
  * [Scalable Display TOP](../TOPs/Scalable_Display_TOP.md "Scalable Display TOP")
    * Windows OS
  * CUDA in [C++ TOP](../TOPs/CPlusPlus_TOP.md "CPlusPlus TOP")
    * Windows OS & Nvidia GPU only
  * [DirectX In TOP](../TOPs/DirectX_In_TOP.md "DirectX In TOP") and [DirectX Out TOP](../TOPs/DirectX_Out_TOP.md "DirectX Out TOP")
    * Windows OS & DirectX 9.0 and higher
  * [Photoshop In TOP](../TOPs/Photoshop_In_TOP.md "Photoshop In TOP")
    * Adobe Photoshop CS6 and up
  * [SVG TOP](../TOPs/SVG_TOP.md "SVG TOP")
    * Windows OS & Nvidia GPU only
  * [Geometry COMP](../Glossary/Geometry_COMP.md "Geometry COMP") Texture Instancing
    * Windows OS & Nvidia GPU only
  * [Window COMP](../Glossary/Window_COMP.md "Window COMP") Hardware Frame Lock
    * Windows OS & Nvidia Quadro Sync or AMD S400 only
  * [Pangolin CHOP](../CHOPs/Pangolin_CHOP.md "Pangolin CHOP") - Drive Pangolin lasers through their Beyond software.
    * Windows OS
  * [RealSense CHOP](../CHOPs/RealSense_CHOP.md "RealSense CHOP") - Skeleton and face tracking with old legacy RealSense devices.
    * Windows OS
  * [Kinect](https://docs.derivative.ca/Kinect "Kinect") 2 Support
    * Windows OS - 8 or 10
    * dedicated USB 3.0 Controller
  * [Kinect Azure TOP](../TOPs/Kinect_Azure_TOP.md "Kinect Azure TOP") / [Kinect Azure CHOP](../CHOPs/Kinect_Azure_CHOP.md "Kinect Azure CHOP") - Body tracking and Player Index support
    * Windows OS
  ...
  * [NatNet In CHOP](../Interoperability/NatNet_In_CHOP.md "NatNet In CHOP") - Receives tracking data from OptiTrack systems.
    * Windows OS
  * [Oculus Rift](https://docs.derivative.ca/Oculus_Rift "Oculus Rift")
    * Windows OS
    * Oculus Rift DK2 or CV1
  * [OpenVR](../Interoperability/OpenVR.md "OpenVR") - HTC Vive or other OpenVR supported HMDs.
    * Windows OS
  * [ZED](../Interoperability/ZED.md "ZED") - TOP, CHOP, POP and SOP that access ZED devices.
    * Windows OS
