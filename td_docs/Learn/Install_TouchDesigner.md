---
url: https://docs.derivative.ca/Install_TouchDesigner
category: Learn
title: Install_TouchDesigner
---
...
###  Keying
When opening TouchDesigner for the first time, the [Key Manager Dialog](https://docs.derivative.ca/Key_Manager_Dialog "Key Manager Dialog") will guide through the process of installing a license.
...
[![InstallOptions.png](https://docs.derivative.ca/images/thumb/a/a1/InstallOptions.png/400px-InstallOptions.png)](https://docs.derivative.ca/File:InstallOptions.png)
...
Using this checkbox will give you more options after clilcking 'Next' such as
  ...
  * TouchPlayer options
    ...
    * Make TouchPlayer the default application for .toe files (TouchDesigner files)
...
[![InstallerComponents.png](https://docs.derivative.ca/images/thumb/6/6b/InstallerComponents.png/400px-InstallerComponents.png)](https://docs.derivative.ca/File:InstallerComponents.png)
...
[![InstallerModify.png](https://docs.derivative.ca/images/thumb/0/07/InstallerModify.png/400px-InstallerModify.png)](https://docs.derivative.ca/File:InstallerModify.png)
...
[![InstallParallelBuild.png](https://docs.derivative.ca/images/thumb/0/0e/InstallParallelBuild.png/400px-InstallParallelBuild.png)](https://docs.derivative.ca/File:InstallParallelBuild.png)
...
[![ReplaceInstalledBuildSingle.png](https://docs.derivative.ca/images/thumb/7/7b/ReplaceInstalledBuildSingle.png/400px-ReplaceInstalledBuildSingle.png)](https://docs.derivative.ca/File:ReplaceInstalledBuildSingle.png) [![ReplaceInstalledBuildMultiple.png](https://docs.derivative.ca/images/thumb/3/34/ReplaceInstalledBuildMultiple.png/400px-ReplaceInstalledBuildMultiple.png)](https://docs.derivative.ca/File:ReplaceInstalledBuildMultiple.png)
###  macOS
...
[![License Retrieval Error](https://docs.derivative.ca/images/thumb/7/73/LicenseRetrievalWMI.png/300px-LicenseRetrievalWMI.png)](https://docs.derivative.ca/File:LicenseRetrievalWMI.png "License Retrieval Error") [![License Retrieval Error](https://docs.derivative.ca/images/thumb/3/33/LicenseRetrievalWMI2.png/205px-LicenseRetrievalWMI2.png)](https://docs.derivative.ca/File:LicenseRetrievalWMI2.png "License Retrieval Error")
...
If you continue to have problems, join the [support thread here](https://forum.derivative.ca/t/resolved-touchdesigner-wont-run-error-when-reinstalling-key-retrieval-error/269765).
...
[![L1KeyError.png](https://docs.derivative.ca/images/5/52/L1KeyError.png)](https://docs.derivative.ca/File:L1KeyError.png)
...
##  See Also
[Automatic Key Installation](https://docs.derivative.ca/Automatic_Key_Installation "Automatic Key Installation")
