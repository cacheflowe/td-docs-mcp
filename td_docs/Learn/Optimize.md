---
url: https://docs.derivative.ca/Optimize
category: Learn
title: Optimize
---
...
See also [Probe](https://docs.derivative.ca/Palette:probe "Palette:probe"), [Phong MAT Shader Resource Usage](https://docs.derivative.ca/Phong_MAT_Shader_Resource_Usage "Phong MAT Shader Resource Usage")
##  Optimizing CPU Usage
###  Performance Monitor
Use the [Performance Monitor Dialog](https://docs.derivative.ca/Performance_Monitor_Dialog "Performance Monitor Dialog") to find expensive cook or nodes that are unnecessarily cooking. With the Performance Monitor you can see the order-of-cook of one frame, and the cook times of all the stages. Also you can trigger a dump on frames that exceed a certain threshold. Use [Probe](https://docs.derivative.ca/Palette:probe "Palette:probe") to watch CPU usage dynamically change.
...
Refer to the article on [Early Depth-Test](https://docs.derivative.ca/Early_Depth-Test "Early Depth-Test").
Another feature that can help reduce overdraw is [Back-Face Culling](https://docs.derivative.ca/Back-Face_Culling "Back-Face Culling").
...
Use [Probe](https://docs.derivative.ca/Palette:probe "Palette:probe") to see where CPU and GPU memory is being consumed.
###  Audio Play CHOP
...
###  See Also
[Stuttered Playback](https://docs.derivative.ca/Stuttered_Playback "Stuttered Playback") [Optimized_Python_Expressions](https://docs.derivative.ca/Optimized_Python_Expressions "Optimized Python Expressions")
