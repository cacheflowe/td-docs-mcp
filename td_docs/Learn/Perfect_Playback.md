---
url: https://docs.derivative.ca/Perfect_Playback
category: Learn
title: Perfect_Playback
---
...
For monitor outputs, the OS must be actually presenting the images to the screen and not silently dropping them. This is achieved through 'Exclusive' access to the desktop. More information is [here](#Running_in_Exclusive_Access_Mode).
...
Refer to [Perfect_Playback#Movie_Content_FPS](#Movie_Content_FPS).
