---
url: https://docs.derivative.ca/First_Things_to_Know_about_TouchDesigner
category: Learn
title: First_Things_to_Know_about_TouchDesigner
---
...
Put a Null component above the geo1 component. The 3D components like Geometrys, Cameras and Lights have connectors on their bottoms and tops (connect them) which connects them as parent-child in a [3D](https://docs.derivative.ca/3D "3D") hierarchy, but no data flows along them.
...
On the Parameter Dialog, on the Period parameter's name or value, middle-click and hold down the button. The [Value Ladder](https://docs.derivative.ca/Value_Ladder "Value Ladder") will pop up with a number of increments labelled .001 .01 .1 1 10. With the middle-mouse still down, move vertically to one of the increments, say .01, then move off to the right/left to increase/decrease the parameter value. Try the same thing with another increment.
...
Frequently save the state of your work. Under the File menu, choose [Create Project Folder](https://docs.derivative.ca/New_Project_Dialog "New Project Dialog"). Make sure your Path is your Desktop. Change the Project Folder to `Learning`, then press Create.
...
Now you know the basics. Take a break. Later you can go to **[More Things to Know about TouchDesigner](https://docs.derivative.ca/More_Things_to_Know_about_TouchDesigner "More Things to Know about TouchDesigner")**
