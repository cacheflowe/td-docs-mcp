---
url: https://docs.derivative.ca/IndicesDAT_Class
category: DATs
title: IndicesDAT_Class
---

# indicesDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Indices DAT](Indices_DAT.md "Indices DAT").
