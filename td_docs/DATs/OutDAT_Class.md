...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Out DAT](https://docs.derivative.ca/Out_DAT "Out DAT").
