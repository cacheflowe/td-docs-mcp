...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Script DAT](https://docs.derivative.ca/Script_DAT "Script DAT").
