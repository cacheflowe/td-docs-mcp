...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Convert DAT](https://docs.derivative.ca/Convert_DAT "Convert DAT").
