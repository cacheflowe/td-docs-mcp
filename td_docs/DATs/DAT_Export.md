...
DAT exporting sends numbers, strings or expressions in a table format to a [parameter](../Glossary/Parameter.md "Parameter") of any [operator](../General/Operator.md "Operator").
...
The DAT's green [Export Flag](https://docs.derivative.ca/Export_Flag "Export Flag") must be On to enable the export. Once the export is established, a dotted data [link](../Glossary/Link.md "Link") will connect the DAT and the operator to indicate a connection.
