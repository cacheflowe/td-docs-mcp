---
url: https://docs.derivative.ca/File_In_DAT
category: DATs
title: File_In_DAT
---
...
See also [Table DAT](../Glossary/Table_DAT.md "Table DAT"), [Text DAT](../Glossary/Text_DAT.md "Text DAT").

[fileinDAT_Class](File_In_DAT_Class.md "FileinDAT Class")
...
Extra Information for the File In DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
