---
url: https://docs.derivative.ca/TouchoutDAT_Class
category: DATs
title: TouchoutDAT_Class
---

# touchoutDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Touch Out DAT](Touch_Out_DAT.md "Touch Out DAT").
