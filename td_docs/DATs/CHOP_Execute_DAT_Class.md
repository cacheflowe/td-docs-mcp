---
url: https://docs.derivative.ca/ChopexecuteDAT_Class
category: DATs
title: ChopexecuteDAT_Class
---

# chopexecuteDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [CHOP Execute DAT](CHOP_Execute_DAT.md "CHOP Execute DAT").
