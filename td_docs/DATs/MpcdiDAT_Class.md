...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [MPCDI DAT](https://docs.derivative.ca/MPCDI_DAT "MPCDI DAT").
