---
url: https://docs.derivative.ca/TransposeDAT_Class
category: DATs
title: TransposeDAT_Class
---

# transposeDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Transpose DAT](Transpose_DAT.md "Transpose DAT").
