---
url: https://docs.derivative.ca/InDAT_Class
category: DATs
title: InDAT_Class
---
...
This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [In DAT](In_DAT.md "In DAT").
