---
url: https://docs.derivative.ca/WebsocketDAT_Class
category: DATs
title: WebsocketDAT_Class
---

# websocketDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [WebSocket DAT](../Interoperability/WebSocket_DAT.md "WebSocket DAT").
