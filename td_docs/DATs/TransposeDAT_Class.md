...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Transpose DAT](https://docs.derivative.ca/Transpose_DAT "Transpose DAT").
