---
url: https://docs.derivative.ca/MqttclientDAT_Class
category: DATs
title: MqttclientDAT_Class
---

# mqttclientDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [MQTT Client DAT](MQTT_Client_DAT.md "MQTT Client DAT").

For information see [MQTT](../Interoperability/MQTT.md "MQTT").
...
`publish(topic, payload, qos=0, retain=False)`→ `None`:
