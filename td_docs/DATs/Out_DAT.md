---
url: https://docs.derivative.ca/Out_DAT
category: DATs
title: Out_DAT
---
...
[outDAT_Class](Out_DAT_Class.md "OutDAT Class")
...
Extra Information for the Out DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
