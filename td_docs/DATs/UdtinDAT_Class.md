...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [UDT In DAT](https://docs.derivative.ca/UDT_In_DAT "UDT In DAT").
