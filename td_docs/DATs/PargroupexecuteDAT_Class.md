...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [ParGroup Execute DAT](https://docs.derivative.ca/ParGroup_Execute_DAT "ParGroup Execute DAT").
