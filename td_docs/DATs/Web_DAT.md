...
**Note** : Web DAT deprecated build 2019.15230, use [Web Client DAT](../Interoperability/Web_Client_DAT.md "Web Client DAT").
```
...
See also [XML DAT](../Interoperability/XML_DAT.md "XML DAT"), [TCP/IP DAT](https://docs.derivative.ca/TCP/IP_DAT "TCP/IP DAT"), [WebSocket DAT](../Interoperability/WebSocket_DAT.md "WebSocket DAT").

[webDAT_Class](Web_DAT_Class.md "WebDAT Class")
