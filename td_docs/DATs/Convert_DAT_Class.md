---
url: https://docs.derivative.ca/ConvertDAT_Class
category: DATs
title: ConvertDAT_Class
---

# convertDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Convert DAT](Convert_DAT.md "Convert DAT").
