...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Web Server DAT](https://docs.derivative.ca/Web_Server_DAT "Web Server DAT").
