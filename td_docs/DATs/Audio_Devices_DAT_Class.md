---
url: https://docs.derivative.ca/AudiodevicesDAT_Class
category: DATs
title: AudiodevicesDAT_Class
---

# audiodevicesDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Audio Devices DAT](Audio_Devices_DAT.md "Audio Devices DAT").
