...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Sort DAT](https://docs.derivative.ca/Sort_DAT "Sort DAT").
