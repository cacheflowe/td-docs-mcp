---
url: https://docs.derivative.ca/UdpinDAT_Class
category: DATs
title: UdpinDAT_Class
---

# udpinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [UDP In DAT](../Interoperability/UDP_In_DAT.md "UDP In DAT").
