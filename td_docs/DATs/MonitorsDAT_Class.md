...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Monitors DAT](https://docs.derivative.ca/Monitors_DAT "Monitors DAT").
