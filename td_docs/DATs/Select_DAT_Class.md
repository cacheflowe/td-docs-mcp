---
url: https://docs.derivative.ca/SelectDAT_Class
category: DATs
title: SelectDAT_Class
---

# selectDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Select DAT](Select_DAT.md "Select DAT").
