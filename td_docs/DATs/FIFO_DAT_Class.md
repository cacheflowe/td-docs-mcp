---
url: https://docs.derivative.ca/FifoDAT_Class
category: DATs
title: FifoDAT_Class
---
...
This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [FIFO DAT](FIFO_DAT.md "FIFO DAT").
...
# me - this DAT.
#
# dat - the DAT that received a row
