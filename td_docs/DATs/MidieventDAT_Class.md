...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [MIDI Event DAT](https://docs.derivative.ca/MIDI_Event_DAT "MIDI Event DAT").
