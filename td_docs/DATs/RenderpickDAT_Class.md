...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Render Pick DAT](https://docs.derivative.ca/Render_Pick_DAT "Render Pick DAT").
...
Perform a pick at the given (u, v)
  ...
  * camera - (Keyword, Optional) If provided, the pick will be done from the point of view of the given camera. This can be any [COMP](https://docs.derivative.ca/Component "Component") that behaves as a camera such as [Camera COMP](https://docs.derivative.ca/Camera_COMP "Camera COMP"), [Light COMP](https://docs.derivative.ca/Light_COMP "Light COMP") etc.
