...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Video Devices DAT](https://docs.derivative.ca/Video_Devices_DAT "Video Devices DAT").
