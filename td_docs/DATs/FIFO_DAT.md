---
url: https://docs.derivative.ca/FIFO_DAT
category: DATs
title: FIFO_DAT
---
...
[fifoDAT_Class](FIFO_DAT_Class.md "FifoDAT Class")
...
Extra Information for the FIFO DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
