...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Reorder DAT](https://docs.derivative.ca/Reorder_DAT "Reorder DAT").
