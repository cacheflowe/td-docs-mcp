...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [WebRTC DAT](https://docs.derivative.ca/WebRTC_DAT "WebRTC DAT").
