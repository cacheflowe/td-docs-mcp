...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [OP Execute DAT](https://docs.derivative.ca/OP_Execute_DAT "OP Execute DAT").
