---
url: https://docs.derivative.ca/SoptoDAT_Class
category: DATs
title: SoptoDAT_Class
---

# soptoDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [SOP to DAT](../Glossary/SOP_to_DAT.md "SOP to DAT").
