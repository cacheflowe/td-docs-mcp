---
url: https://docs.derivative.ca/TextDAT_Class
category: DATs
title: TextDAT_Class
---
...
This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Text DAT](../Glossary/Text_DAT.md "Text DAT").

## Members

`textFormat` → `bool` :

Get or set text format flag. This will convert between table and text formats. Note: Adding a row or column after will convert the DAT back into a table.
