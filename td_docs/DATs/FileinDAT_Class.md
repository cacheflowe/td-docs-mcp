...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [File In DAT](https://docs.derivative.ca/File_In_DAT "File In DAT").
