---
url: https://docs.derivative.ca/LookupDAT_Class
category: DATs
title: LookupDAT_Class
---

# lookupDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Lookup DAT](Lookup_DAT.md "Lookup DAT").
