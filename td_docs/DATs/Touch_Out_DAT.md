---
url: https://docs.derivative.ca/Touch_Out_DAT
category: DATs
title: Touch_Out_DAT
---
...
The Touch Out DAT sends full DAT tables across the network to the [Touch In DAT](Touch_In_DAT.md "Touch In DAT") in another TouchDesigner process, as opposed to messages with the other network based DATs. It is an extremely powerful mechanism to sync data between TouchDesigner processes.

See also [UDP Out DAT](UDP_Out_DAT.md "UDP Out DAT").

[touchoutDAT_Class](Touch_Out_DAT_Class.md "TouchoutDAT Class")
...
Extra Information for the Touch Out DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
