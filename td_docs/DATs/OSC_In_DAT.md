---
url: https://docs.derivative.ca/OSC_In_DAT
category: DATs
title: OSC_In_DAT
---
...
- Callbacks DAT `callbacks` - The Callbacks DAT will execute once for each message received. See [oscinDAT_Class](OSC_In_DAT_Class.md "OscinDAT Class") for usage.
...
Extra Information for the OSC In DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
