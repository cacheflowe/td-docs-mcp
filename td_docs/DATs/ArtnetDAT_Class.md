---
url: https://docs.derivative.ca/ArtnetDAT_Class
category: DATs
title: ArtnetDAT_Class
---

# artnetDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Art-Net DAT](https://docs.derivative.ca/Art-Net_DAT "Art-Net DAT").
...
# me - this DAT
#
# dat - the DAT that received the artnet reply event
# device - a named tuple with the following fields:
#	ip			- IP Address		(type: Byte Object, size 4)
#	port		- Port				(type: int)
#	version		- Firmware version	(type: int)
#	netswitch	- See below			(type: int)
#	subswitch	- See below			(type: int)
#	oem			- Device OEM		(type: int)
#	ubea		- UBEA firmware version (type: int)
#	status1		- See below			(type: int)
#	estacode	- ESTA manufacturer code (type: int)
#	shortname	- Short name of device (type: int)
#	longname	- Long name of device (type: int)
#	report		- Report of device's operating status (type: int)
#	numports	- Number of input/output ports (type: int)
#	porttypes	- See below			(type: Byte Object, size 4)
#	goodinputs	- See below			(type: Byte Object, size 4)
#	goodoutputs	- See below			(type: Byte Object, size 4)
#	swin		- See below			(type: Byte Object, size 4)
#	swout		- See below			(type: Byte Object, size 4)
#	swvideo		- See below			(type: int)
#	swmacro		- See below			(type: int)
#	swremote	- See below			(type: int)
#	style		- See below			(type: int)
#	mac			- Device MAC address (type: Byte Object, size 6)
#	bindip		- See below			(type: Byte Object, size 4)
#	bindindex	- See below			(type: int)
#	status2		- See below			(type: int)
#
# Note: All values in device are described fully in the
#		Art-Net specification, under the ArtPollReply table:
#		http://www.artisticlicence.com/WebSiteMaster/User%20Guides/art-net.pdf#page=10

def onPollReply(dat, device):
	return

# devices is a list of all the devices that replied to the poll

def onPollComplete(dat, devices):
	return
```
