...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Art-Net DAT](https://docs.derivative.ca/Art-Net_DAT "Art-Net DAT").
