...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [OSC Out DAT](https://docs.derivative.ca/OSC_Out_DAT "OSC Out DAT").
