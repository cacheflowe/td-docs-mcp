---
url: https://docs.derivative.ca/TUIO_In_DAT
category: DATs
title: TUIO_In_DAT
---
...
The TUIO In DAT receives and parses [TUIO](https://www.tuio.org) messages (received over network) into columns in the table. TUIO packets OSC bundles, so TUIO data can also be viewed in its more raw form in an [OSC In DAT](OSC_In_DAT.md "OSC In DAT"). It currently supports the [TUIO 1.1](https://www.tuio.org/?tuio11), and the [TUIO 2.0](https://www.tuio.org/?tuio20) protocol.

See also [TUIO](../Interoperability/TUIO.md "TUIO").

[tuioinDAT_Class](TUIO_In_DAT_Class.md "TuioinDAT Class")
...
- Callbacks DAT `callbacks` - The Callbacks DAT will get callbacks for TUIO events. See [tuioinDAT_Class](TUIO_In_DAT_Class.md "TuioinDAT Class") for usage.
...
Extra Information for the TUIO In DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
