...
# cplusplusDAT Class
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [CPlusPlus DAT](https://docs.derivative.ca/CPlusPlus_DAT "CPlusPlus DAT").
