...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Audio Devices DAT](https://docs.derivative.ca/Audio_Devices_DAT "Audio Devices DAT").
