---
url: https://docs.derivative.ca/CplusplusDAT_Class
category: DATs
title: CplusplusDAT_Class
---

# cplusplusDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [CPlusPlus DAT](CPlusPlus_DAT.md "CPlusPlus DAT").
