---
url: https://docs.derivative.ca/ScriptDAT_Class
category: DATs
title: ScriptDAT_Class
---

# scriptDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Script DAT](Script_DAT.md "Script DAT").

## Members

`textFormat` → `bool` :

Get or set text format flag. This will convert between table and text formats. Note: textFormat = True should be the last call in the scriptOp, adding a row or column after will convert the DAT back into a table.
