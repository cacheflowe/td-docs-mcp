---
url: https://docs.derivative.ca/PargroupexecuteDAT_Class
category: DATs
title: PargroupexecuteDAT_Class
---

# pargroupexecuteDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [ParGroup Execute DAT](ParGroup_Execute_DAT.md "ParGroup Execute DAT").
