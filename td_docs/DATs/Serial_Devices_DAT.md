...
[serialdevicesDAT_Class](Serial_Devices_DAT_Class.md "SerialdevicesDAT Class")

## Parameters - Serial Devices Page
- Callbacks DAT `callbacks` - Runs this script once for each change to the table. See [serialdevicesDAT_Class](Serial_Devices_DAT_Class.md "SerialdevicesDAT Class") for usage.
