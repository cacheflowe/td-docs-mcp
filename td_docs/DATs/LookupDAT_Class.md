...
# lookupDAT Class
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Lookup DAT](https://docs.derivative.ca/Lookup_DAT "Lookup DAT").
