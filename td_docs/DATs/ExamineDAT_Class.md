...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Examine DAT](https://docs.derivative.ca/Examine_DAT "Examine DAT").
