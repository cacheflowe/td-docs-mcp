---
url: https://docs.derivative.ca/SubstituteDAT_Class
category: DATs
title: SubstituteDAT_Class
---

# substituteDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Substitute DAT](Substitute_DAT.md "Substitute DAT").

## Members

`inputCell` → `Cell` **(Read Only)** :

The current input [cell](../Python/Cell_Class.md "Cell Class") being evaluated. From the [cell](../Python/Cell_Class.md "Cell Class") you can get its row, column and value. e.g. me.inputCell.val or use the specific members listed below.
...
`inputTable` → `OP` **(Read Only)** :

The current input [DAT](../Python/DAT_Class.md "DAT Class") being evaluated.
