---
url: https://docs.derivative.ca/SwitchDAT_Class
category: DATs
title: SwitchDAT_Class
---

# switchDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Switch DAT](Switch_DAT.md "Switch DAT").
