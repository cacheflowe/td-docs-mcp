---
url: https://docs.derivative.ca/InsertDAT_Class
category: DATs
title: InsertDAT_Class
---

# insertDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Insert DAT](Insert_DAT.md "Insert DAT").
