---
url: https://docs.derivative.ca/Info_DAT
category: DATs
title: Info_DAT
---
...
[infoDAT_Class](Info_DAT_Class.md "InfoDAT Class")

## Parameters - Info Page
- Operator `op` - The [path](../Glossary/Network_Path.md "Network Path") to the operator that the Info DAT is getting information from. You can drag & drop any node onto this path, or type the path directly into the field.
...
Extra Information for the Info DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
