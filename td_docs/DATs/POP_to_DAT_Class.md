---
url: https://docs.derivative.ca/PoptoDAT_Class
category: DATs
title: PoptoDAT_Class
---

# poptoDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [POP to DAT](POP_to_DAT.md "POP to DAT").
