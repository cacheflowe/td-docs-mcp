---
url: https://docs.derivative.ca/SerialDAT_Class
category: DATs
title: SerialDAT_Class
---

# serialDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Serial DAT](../Interoperability/Serial_DAT.md "Serial DAT").
...
Send a sequence of strings through this connection.
  * messages - One or more strings to write into the file.
  * terminator - (Keyword, Optional) Specifies how the message is to be terminated. If no append terminator is specified, a null character will automatically be appended to the message. To send no terminator, use terminator=_._
