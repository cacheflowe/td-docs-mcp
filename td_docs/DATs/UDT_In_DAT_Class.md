---
url: https://docs.derivative.ca/UdtinDAT_Class
category: DATs
title: UdtinDAT_Class
---

# udtinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [UDT In DAT](UDT_In_DAT.md "UDT In DAT").
...
# bytes - a byte array of the data receieved
