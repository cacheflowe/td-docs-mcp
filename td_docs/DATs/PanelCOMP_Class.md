...
An intermediate [sequence collection](../Python/SequenceCollection_Class.md "SequenceCollection Class") object, from which a specific [sequence](https://docs.derivative.ca/index.php?title=Sequence&action=edit&redlink=1 "Sequence \(page does not exist\)") can be found.
