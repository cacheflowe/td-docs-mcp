...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Select DAT](https://docs.derivative.ca/Select_DAT "Select DAT").
