---
url: https://docs.derivative.ca/In_DAT
category: DATs
title: In_DAT
---
...
[inDAT_Class](In_DAT_Class.md "InDAT Class")
...
Extra Information for the In DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
