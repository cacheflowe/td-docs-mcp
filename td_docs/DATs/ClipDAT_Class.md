...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Clip DAT](https://docs.derivative.ca/Clip_DAT "Clip DAT").
