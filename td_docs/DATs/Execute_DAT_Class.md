---
url: https://docs.derivative.ca/ExecuteDAT_Class
category: DATs
title: ExecuteDAT_Class
---

# executeDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Execute DAT](Execute_DAT.md "Execute DAT").
