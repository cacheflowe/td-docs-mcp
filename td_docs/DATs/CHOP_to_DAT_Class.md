---
url: https://docs.derivative.ca/ChoptoDAT_Class
category: DATs
title: ChoptoDAT_Class
---

# choptoDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [CHOP to DAT](CHOP_to_DAT.md "CHOP to DAT").
