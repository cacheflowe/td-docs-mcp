...
This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Serial Devices DAT](Serial_Devices_DAT.md "Serial Devices DAT").
