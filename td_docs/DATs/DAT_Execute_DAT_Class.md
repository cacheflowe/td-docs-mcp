---
url: https://docs.derivative.ca/DatexecuteDAT_Class
category: DATs
title: DatexecuteDAT_Class
---

# datexecuteDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [DAT Execute DAT](DAT_Execute_DAT.md "DAT Execute DAT").
