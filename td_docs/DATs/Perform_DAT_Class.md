---
url: https://docs.derivative.ca/PerformDAT_Class
category: DATs
title: PerformDAT_Class
---

# performDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Perform DAT](Perform_DAT.md "Perform DAT").
