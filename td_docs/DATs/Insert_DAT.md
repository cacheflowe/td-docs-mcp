---
url: https://docs.derivative.ca/Insert_DAT
category: DATs
title: Insert_DAT
---
...
[insertDAT_Class](Insert_DAT_Class.md "InsertDAT Class")
...
Extra Information for the Insert DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
