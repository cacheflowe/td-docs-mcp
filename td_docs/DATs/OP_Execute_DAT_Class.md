---
url: https://docs.derivative.ca/OpexecuteDAT_Class
category: DATs
title: OpexecuteDAT_Class
---

# opexecuteDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [OP Execute DAT](OP_Execute_DAT.md "OP Execute DAT").
