---
url: https://docs.derivative.ca/CHOP_to_DAT
category: DATs
title: CHOP_to_DAT
---
...
[choptoDAT_Class](CHOP_to_DAT_Class.md "ChoptoDAT Class")
...
- Output `output` - ⊞ - Create a row per channel or column per channel.
...
Extra Information for the CHOP to DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
