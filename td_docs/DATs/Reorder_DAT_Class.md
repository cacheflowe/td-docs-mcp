---
url: https://docs.derivative.ca/ReorderDAT_Class
category: DATs
title: ReorderDAT_Class
---

# reorderDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Reorder DAT](Reorder_DAT.md "Reorder DAT").
