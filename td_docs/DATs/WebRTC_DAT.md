...
A WebRTC DAT represents a peer on one end of any number of [WebRTC](../Interoperability/WebRTC.md "WebRTC") peer-to-peer connections.

Each connection is represented in TouchDesigner by a generated UUID. The UUID must be passed to [WebrtcDAT Class](WebRTC_DAT_Class.md "WebrtcDAT Class") connection-level python methods.
...
WebRTC video and audio input/output is done via the [Video Stream In TOP](../TOPs/Video_Stream_In_TOP.md "Video Stream In TOP"), [Video Stream Out TOP](../TOPs/Video_Stream_Out_TOP.md "Video Stream Out TOP"), [Audio Stream In CHOP](../CHOPs/Audio_Stream_In_CHOP.md "Audio Stream In CHOP"), and [Audio Stream Out CHOP](../CHOPs/Audio_Stream_Out_CHOP.md "Audio Stream Out CHOP").

See also [WebRTC](../Interoperability/WebRTC.md "WebRTC").

[webrtcDAT_Class](WebRTC_DAT_Class.md "WebrtcDAT Class")
...
## Parameters - ICE Page
- STUN Server URL `stun` - URL of the STUN server. See [WebRTC#ICE](../Interoperability/WebRTC.md#ICE "WebRTC") for more details regarding STUN.
...
- TURN Server URL 0 `turn0server` - URL of the TURN server. See [WebRTC#ICE](../Interoperability/WebRTC.md#ICE "WebRTC") for more details regarding TURN.
