---
url: https://docs.derivative.ca/ExamineDAT_Class
category: DATs
title: ExamineDAT_Class
---

# examineDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Examine DAT](Examine_DAT.md "Examine DAT").
