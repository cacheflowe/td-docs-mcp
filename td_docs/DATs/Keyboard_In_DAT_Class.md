---
url: https://docs.derivative.ca/KeyboardinDAT_Class
category: DATs
title: KeyboardinDAT_Class
---

# keyboardinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Keyboard In DAT](Keyboard_In_DAT.md "Keyboard In DAT").
