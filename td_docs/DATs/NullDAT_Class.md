...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Null DAT](https://docs.derivative.ca/Null_DAT "Null DAT").
