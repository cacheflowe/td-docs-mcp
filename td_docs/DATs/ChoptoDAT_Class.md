...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [CHOP to DAT](https://docs.derivative.ca/CHOP_to_DAT "CHOP to DAT").
