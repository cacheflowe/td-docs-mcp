---
url: https://docs.derivative.ca/MultitouchinDAT_Class
category: DATs
title: MultitouchinDAT_Class
---

# multitouchinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Multi Touch In DAT](../Interoperability/Multi_Touch_In_DAT.md "Multi Touch In DAT").
