...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Perform DAT](https://docs.derivative.ca/Perform_DAT "Perform DAT").
