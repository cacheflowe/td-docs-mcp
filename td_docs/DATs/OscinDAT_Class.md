...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [OSC In DAT](https://docs.derivative.ca/OSC_In_DAT "OSC In DAT").
