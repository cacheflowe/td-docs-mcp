...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Web Client DAT](https://docs.derivative.ca/Web_Client_DAT "Web Client DAT").
