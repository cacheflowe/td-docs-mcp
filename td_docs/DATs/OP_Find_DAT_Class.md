---
url: https://docs.derivative.ca/OpfindDAT_Class
category: DATs
title: OpfindDAT_Class
---

# opfindDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [OP Find DAT](OP_Find_DAT.md "OP Find DAT").
...
# Uncomment the following to control which OPs are included
