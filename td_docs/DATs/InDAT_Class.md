...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [In DAT](https://docs.derivative.ca/In_DAT "In DAT").
