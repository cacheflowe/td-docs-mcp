---
url: https://docs.derivative.ca/FileinDAT_Class
category: DATs
title: FileinDAT_Class
---

# fileinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [File In DAT](File_In_DAT.md "File In DAT").
