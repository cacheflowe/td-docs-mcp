---
url: https://docs.derivative.ca/MidieventDAT_Class
category: DATs
title: MidieventDAT_Class
---

# midieventDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [MIDI Event DAT](MIDI_Event_DAT.md "MIDI Event DAT").
