...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Serial DAT](https://docs.derivative.ca/Serial_DAT "Serial DAT").
