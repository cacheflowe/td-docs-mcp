---
url: https://docs.derivative.ca/FileoutDAT_Class
category: DATs
title: FileoutDAT_Class
---

# fileoutDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [File Out DAT](File_Out_DAT.md "File Out DAT").

## Members

`writeCount` → `int` **(Read Only)** :
