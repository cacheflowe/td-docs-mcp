---
url: https://docs.derivative.ca/VideodevicesDAT_Class
category: DATs
title: VideodevicesDAT_Class
---

# videodevicesDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Video Devices DAT](Video_Devices_DAT.md "Video Devices DAT").
