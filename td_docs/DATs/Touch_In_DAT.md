...
The Touch In DAT receives full tables across the network from the [Touch Out DAT](Touch_Out_DAT.md "Touch Out DAT"), as opposed to messages with the other network based DATs.

See also [UDP Out DAT](UDP_Out_DAT.md "UDP Out DAT").

[touchinDAT_Class](Touch_In_DAT_Class.md "TouchinDAT Class")
...
Extra Information for the Touch In DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
