...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [UDT Out DAT](https://docs.derivative.ca/UDT_Out_DAT "UDT Out DAT").
