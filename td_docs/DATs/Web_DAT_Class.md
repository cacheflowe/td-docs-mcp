---
url: https://docs.derivative.ca/WebDAT_Class
category: DATs
title: WebDAT_Class
---
...
This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Web DAT](Web_DAT.md "Web DAT").
