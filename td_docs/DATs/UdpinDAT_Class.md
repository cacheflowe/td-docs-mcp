...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [UDP In DAT](https://docs.derivative.ca/UDP_In_DAT "UDP In DAT").
