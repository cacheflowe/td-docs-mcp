...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Execute DAT](https://docs.derivative.ca/Execute_DAT "Execute DAT").
