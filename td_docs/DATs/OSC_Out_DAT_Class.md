---
url: https://docs.derivative.ca/OscoutDAT_Class
category: DATs
title: OscoutDAT_Class
---

# oscoutDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [OSC Out DAT](OSC_Out_DAT.md "OSC Out DAT").
