---
url: https://docs.derivative.ca/TuioinDAT_Class
category: DATs
title: TuioinDAT_Class
---

# tuioinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [TUIO In DAT](TUIO_In_DAT.md "TUIO In DAT").
...
def onTouches(dat, events):
	...
	for event in events:
		...
		for touch in event.touchesStart:
			#print('start', touch.id, touch.u, touch.v)
			pass
		for touch in event.touchesMove:
			#print('move', touch.id, touch.u, touch.v)
			pass
		for touch in event.touchesEnd:
			#print('end', touch.id, touch.u, touch.v)
			pass
		for touch in event.touchesNoChange:
			#print('noChange', touch.id, touch.u, touch.v)
			pass
	return
```
