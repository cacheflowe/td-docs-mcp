...
A list of operators contained within this operator. Only [component](../Python/COMP_Class.md "COMP Class") operators have children, otherwise an empty list is returned.
