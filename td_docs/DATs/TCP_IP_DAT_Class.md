---
url: https://docs.derivative.ca/TcpipDAT_Class
category: DATs
title: TcpipDAT_Class
---

# tcpipDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [TCP/IP DAT](https://docs.derivative.ca/TCP/IP_DAT "TCP/IP DAT").
...
Send one or more sequence of bytes. No terminators are appended.
  * messages - Messages can any combination of strings, byte arrays, or individual single-byte numeric values. To serialize non-byte values (example floats or integers) there are several python modules such as pickle or struct.
...
Send a sequence of strings through this connection.
  ...
  * terminator - (Keyword, Optional) Specifies how the message is to be terminated. IIf no append terminator is specified, a null character will automatically be appended to the message. To send no terminator, use terminator=_._
...
See also: [Peer Class](../Python/Peer_Class.md "Peer Class")
