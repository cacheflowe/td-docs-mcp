...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Merge DAT](https://docs.derivative.ca/Merge_DAT "Merge DAT").
