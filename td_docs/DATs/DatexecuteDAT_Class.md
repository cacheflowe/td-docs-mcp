...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [DAT Execute DAT](https://docs.derivative.ca/DAT_Execute_DAT "DAT Execute DAT").
