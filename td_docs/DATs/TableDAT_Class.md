...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Table DAT](https://docs.derivative.ca/Table_DAT "Table DAT").
