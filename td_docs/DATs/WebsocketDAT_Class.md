...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [WebSocket DAT](https://docs.derivative.ca/WebSocket_DAT "WebSocket DAT").
