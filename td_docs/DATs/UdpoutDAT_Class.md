...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [UDP Out DAT](https://docs.derivative.ca/UDP_Out_DAT "UDP Out DAT").
