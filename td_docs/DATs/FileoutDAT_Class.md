...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [File Out DAT](https://docs.derivative.ca/File_Out_DAT "File Out DAT").
