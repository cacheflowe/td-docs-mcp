...
# ndiDAT Class
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [NDI DAT](https://docs.derivative.ca/NDI_DAT "NDI DAT").
