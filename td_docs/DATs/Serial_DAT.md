---
url: https://docs.derivative.ca/Serial_DAT
category: DATs
title: Serial_DAT
---
...
To send bytes out this connection, see the send methods in the [serialDAT_Class](Serial_DAT_Class.md "SerialDAT Class"), or in Tscript the `send` Command.

See also [Arduino](../Interoperability/Arduino.md "Arduino") and [Serial CHOP](../CHOPs/Serial_CHOP.md "Serial CHOP").

[serialDAT_Class](Serial_DAT_Class.md "SerialDAT Class")
...
Extra Information for the Serial DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
