...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [EtherDream DAT](https://docs.derivative.ca/EtherDream_DAT "EtherDream DAT").
