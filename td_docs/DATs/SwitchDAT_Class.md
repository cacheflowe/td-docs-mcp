...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Switch DAT](https://docs.derivative.ca/Switch_DAT "Switch DAT").
