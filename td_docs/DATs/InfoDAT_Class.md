...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Info DAT](https://docs.derivative.ca/Info_DAT "Info DAT").
