...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [POP to DAT](https://docs.derivative.ca/POP_to_DAT "POP to DAT").
