---
url: https://docs.derivative.ca/ParameterDAT_Class
category: DATs
title: ParameterDAT_Class
---

# parameterDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Parameter DAT](Parameter_DAT.md "Parameter DAT").
