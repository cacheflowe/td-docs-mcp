---
url: https://docs.derivative.ca/MidiinDAT_Class
category: DATs
title: MidiinDAT_Class
---

# midiinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [MIDI In DAT](MIDI_In_DAT.md "MIDI In DAT").
