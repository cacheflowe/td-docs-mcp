...
For SocketIO support see the [SocketIO DAT](../Interoperability/SocketIO_DAT.md "SocketIO DAT").
...
[websocketDAT_Class](WebSocket_DAT_Class.md "WebsocketDAT Class")
...
Extra Information for the WebSocket DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
