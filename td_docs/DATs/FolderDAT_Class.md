...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Folder DAT](https://docs.derivative.ca/Folder_DAT "Folder DAT").
