...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Media File Info DAT](https://docs.derivative.ca/Media_File_Info_DAT "Media File Info DAT").
...
## Methods
`fetchInfo(filename)`→ `MediaFileInfo`:
