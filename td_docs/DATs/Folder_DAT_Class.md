---
url: https://docs.derivative.ca/FolderDAT_Class
category: DATs
title: FolderDAT_Class
---

# folderDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Folder DAT](Folder_DAT.md "Folder DAT").
