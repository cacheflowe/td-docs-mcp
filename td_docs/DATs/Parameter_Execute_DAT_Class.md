---
url: https://docs.derivative.ca/ParameterexecuteDAT_Class
category: DATs
title: ParameterexecuteDAT_Class
---

# parameterexecuteDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Parameter Execute DAT](Parameter_Execute_DAT.md "Parameter Execute DAT").
