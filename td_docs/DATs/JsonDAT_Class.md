...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [JSON DAT](https://docs.derivative.ca/JSON_DAT "JSON DAT").
