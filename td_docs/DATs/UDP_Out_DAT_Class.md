---
url: https://docs.derivative.ca/UdpoutDAT_Class
category: DATs
title: UdpoutDAT_Class
---

# udpoutDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [UDP Out DAT](UDP_Out_DAT.md "UDP Out DAT").
