---
url: https://docs.derivative.ca/OscinDAT_Class
category: DATs
title: OscinDAT_Class
---

# oscinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [OSC In DAT](OSC_In_DAT.md "OSC In DAT").
