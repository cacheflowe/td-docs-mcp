...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [SocketIO DAT](https://docs.derivative.ca/SocketIO_DAT "SocketIO DAT").
