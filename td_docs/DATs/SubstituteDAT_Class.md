...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Substitute DAT](https://docs.derivative.ca/Substitute_DAT "Substitute DAT").
