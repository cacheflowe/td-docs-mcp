...
# COMP Class
A COMP describes a reference to a [Component](https://docs.derivative.ca/Component "Component") operator.
...
A list of [operators](https://docs.derivative.ca/OP_Class "OP Class") contained within this operator. Only component operators have children, otherwise an empty list is returned.
