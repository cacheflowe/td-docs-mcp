...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Panel Execute DAT](https://docs.derivative.ca/Panel_Execute_DAT "Panel Execute DAT").
