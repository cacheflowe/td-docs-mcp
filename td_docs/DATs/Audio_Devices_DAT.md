---
url: https://docs.derivative.ca/Audio_Devices_DAT
category: DATs
title: Audio_Devices_DAT
---
...
The Audio Devices DAT provides information about all detected audio devices including driver, direction (input or output), label, and name that can be referenced in the [Audio Device In CHOP](../CHOPs/Audio_Device_In_CHOP.md "Audio Device In CHOP") and [Audio Device Out CHOP](../Interoperability/Audio_Device_Out_CHOP.md "Audio Device Out CHOP").
...
[audiodevicesDAT_Class](Audio_Devices_DAT_Class.md "AudiodevicesDAT Class")
...
Extra Information for the Audio Devices DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
