...
# parameterDAT Class
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Parameter DAT](https://docs.derivative.ca/Parameter_DAT "Parameter DAT").
