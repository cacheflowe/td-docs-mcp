---
url: https://docs.derivative.ca/PanelexecuteDAT_Class
category: DATs
title: PanelexecuteDAT_Class
---

# panelexecuteDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Panel Execute DAT](../Glossary/Panel_Execute_DAT.md "Panel Execute DAT").
