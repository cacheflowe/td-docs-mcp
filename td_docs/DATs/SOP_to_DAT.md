...
Data is output in columns, with the first column being index. The index refers to the Point or Primitive number. [Attributes](../Glossary/Attribute.md "Attribute") are output with column name `_attrib_`if it is a single value attribute, or with multiple columns named` _attrib_(0)`,`_attrib_(1)`,`_attrib_(2)`etc. if it is a multiple value attribute.

See also: [Geometry Detail](../Glossary/Geometry_Detail.md "Geometry Detail"), [Point](../Glossary/Point.md "Point"), [Point List](../Glossary/Point_List.md "Point List"), [Point Class](../SOPs/Point_Class.md "Point Class"), [Primitive](../Glossary/Primitive.md "Primitive"), [Prims Class](../SOPs/Prims_Class.md "Prims Class"), [Polygon](../Glossary/Polygon.md "Polygon"), [Vertex](../Glossary/Vertex.md "Vertex"), [SOP](../SOPs/SOP.md "SOP"), [SOP Class](../SOPs/SOP_Class.md "SOP Class"), [Script SOP](../SOPs/Script_SOP.md "Script SOP"), [Point Groups](https://docs.derivative.ca/Point_Group "Point Group"), [Primitive Groups](https://docs.derivative.ca/Primitive_Group "Primitive Group"), [Attributes](https://docs.derivative.ca/index.php?title=Attributes&action=edit&redlink=1 "Attributes \(page does not exist\)").

**Example File :** [File:SOPtoDATtoSOP.tox](https://docs.derivative.ca/File:SOPtoDATtoSOP.tox "File:SOPtoDATtoSOP.tox")

[soptoDAT_Class](SOP_to_DAT_Class.md "SoptoDAT Class")
...
Extra Information for the SOP to DAT can be accessed via an [Info CHOP](../CHOPs/Info_CHOP.md "Info CHOP").
