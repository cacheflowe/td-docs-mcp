...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Touch Out DAT](https://docs.derivative.ca/Touch_Out_DAT "Touch Out DAT").
