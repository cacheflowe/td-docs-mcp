...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Text DAT](https://docs.derivative.ca/Text_DAT "Text DAT").
