...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Evaluate DAT](https://docs.derivative.ca/Evaluate_DAT "Evaluate DAT").


## Members
`exprCell` → **(Read Only)** :
The current expression [cell](https://docs.derivative.ca/Cell_Class "Cell Class") being evaluated. From the [cell](https://docs.derivative.ca/Cell_Class "Cell Class") you can get its row, column and value. e.g. me.exprCell.val or use the specific members listed below. Too see how a [Cell Class](https://docs.derivative.ca/Cell_Class "Cell Class") such as me.exprCell is automatically converted to a string or number in an expression see [Casting to a Value](https://docs.derivative.ca/Cell_Class#Casting_to_a_Value "Cell Class").
...
The input [DAT](https://docs.derivative.ca/DAT_Class "DAT Class") containing the expressions.

`inputCell` → `Cell` **(Read Only)** :
The current input [cell](https://docs.derivative.ca/Cell_Class "Cell Class") being evaluated. From the [cell](https://docs.derivative.ca/Cell_Class "Cell Class") you can get its row, column and value. e.g. me.inputCell.val or use the specific members listed below. To see how a [Cell Class](https://docs.derivative.ca/Cell_Class "Cell Class") such as me.inputCell is automatically converted to a string or number in an expression see [Casting to a Value](https://docs.derivative.ca/Cell_Class#Casting_to_a_Value "Cell Class").
...
The input [DAT](https://docs.derivative.ca/DAT_Class "DAT Class") containing the source values.
## Methods
