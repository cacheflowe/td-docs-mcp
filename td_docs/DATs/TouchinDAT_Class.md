...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Touch In DAT](https://docs.derivative.ca/Touch_In_DAT "Touch In DAT").
