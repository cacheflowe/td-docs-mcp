...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [OP Find DAT](https://docs.derivative.ca/OP_Find_DAT "OP Find DAT").
