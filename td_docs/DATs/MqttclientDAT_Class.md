...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [MQTT Client DAT](https://docs.derivative.ca/MQTT_Client_DAT "MQTT Client DAT").
For information see [MQTT](https://docs.derivative.ca/MQTT "MQTT").
