...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Indices DAT](https://docs.derivative.ca/Indices_DAT "Indices DAT").
