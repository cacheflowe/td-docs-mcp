...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [FIFO DAT](https://docs.derivative.ca/FIFO_DAT "FIFO DAT").
