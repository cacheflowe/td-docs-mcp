...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [TUIO In DAT](https://docs.derivative.ca/TUIO_In_DAT "TUIO In DAT").
