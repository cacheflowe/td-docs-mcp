...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Insert DAT](https://docs.derivative.ca/Insert_DAT "Insert DAT").
