...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Error DAT](https://docs.derivative.ca/Error_DAT "Error DAT").
