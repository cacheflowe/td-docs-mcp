---
url: https://docs.derivative.ca/UdtoutDAT_Class
category: DATs
title: UdtoutDAT_Class
---

# udtoutDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [UDT Out DAT](UDT_Out_DAT.md "UDT Out DAT").
