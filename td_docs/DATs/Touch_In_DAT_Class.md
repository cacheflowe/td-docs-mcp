---
url: https://docs.derivative.ca/TouchinDAT_Class
category: DATs
title: TouchinDAT_Class
---

# touchinDAT Class

This class inherits from the [ DAT class](../Python/DAT_Class.md "DAT Class"). It references a specific [Touch In DAT](Touch_In_DAT.md "Touch In DAT").
