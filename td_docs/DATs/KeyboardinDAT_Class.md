...
This class inherits from the [ DAT class](https://docs.derivative.ca/DAT_Class "DAT Class"). It references a specific [Keyboard In DAT](https://docs.derivative.ca/Keyboard_In_DAT "Keyboard In DAT").
